...
If you used AI assistance for a contribution, you may optionally note this in your commit message using an
`Assisted-by` trailer, for example:

```txt
Assisted-by: AGENT_NAME:MODEL_VERSION [TOOL1] [TOOL2]
```

This is not required, but helps the project understand how AI tools are being used in practice.
