...
To register a Kubernetes clusters with the kcp server,
...
!!! note
    This step sets current context to the new kind cluster. Make sure to use a KCP kubeconfig for the next steps 
