...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case apisv1alpha1.SchemeGroupVersion.WithResource("apiresourceschemas"):
		...
		// Group=exports.kcp.dev, Version=v1alpha1
	case exportsv1alpha1.SchemeGroupVersion.WithResource("exports"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Exports().V1alpha1().Exports().Informer()}, nil
