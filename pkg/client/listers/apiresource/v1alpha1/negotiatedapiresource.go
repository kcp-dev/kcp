...
// NegotiatedAPIResourceClusterLister can list everything or scope by workspace
...
// NegotiatedAPIResourceLister can list everything inside a cluster or scope by namespace
