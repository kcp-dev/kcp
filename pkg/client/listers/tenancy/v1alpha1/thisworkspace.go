...
type ThisWorkspaceClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) ThisWorkspaceLister
...
func (s *thisWorkspaceClusterLister) Cluster(clusterName logicalcluster.Name) ThisWorkspaceLister {
	return &thisWorkspaceLister{indexer: s.indexer, clusterName: clusterName}
}
