...
// ClusterWorkspaceTypeLister helps list ClusterWorkspaceTypes.
...
func NewClusterWorkspaceTypeLister(indexer cache.Indexer) ClusterWorkspaceTypeLister {
	return &clusterWorkspaceTypeLister{indexer: indexer}
}
...
func (s *clusterWorkspaceTypeLister) Get(name string) (*v1alpha1.ClusterWorkspaceType, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("clusterworkspacetype"), name)
	}
	return obj.(*v1alpha1.ClusterWorkspaceType), nil
}
