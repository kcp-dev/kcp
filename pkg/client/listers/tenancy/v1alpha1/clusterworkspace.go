...
type ClusterWorkspaceClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) ClusterWorkspaceLister
...
func (s *clusterWorkspaceClusterLister) Cluster(clusterName logicalcluster.Name) ClusterWorkspaceLister {
	return &clusterWorkspaceLister{indexer: s.indexer, clusterName: clusterName}
}
