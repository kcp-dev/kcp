...
// APIResourceSchemaClusterLister can list everything or scope by workspace
...
// APIResourceSchemaLister can list everything inside a cluster or scope by namespace
