...
type ServiceBindingLister interface {
	...
	// ListWithContext lists all ServiceBindings in the indexer.
	// Objects returned here must be treated as read-only.
	ListWithContext(ctx context.Context, selector labels.Selector) (ret []*v1alpha1.ServiceBinding, err error)
	// Get retrieves the ServiceBinding from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1alpha1.ServiceBinding, error)
	// GetWithContext retrieves the ServiceBinding from the index for a given name.
	// Objects returned here must be treated as read-only.
	GetWithContext(ctx context.Context, name string) (*v1alpha1.ServiceBinding, error)
...
// ListWithContext lists all ServiceBindings in the indexer.
func (s *serviceBindingLister) ListWithContext(ctx context.Context, selector labels.Selector) (ret []*v1alpha1.ServiceBinding, err error) {
...
// GetWithContext retrieves the ServiceBinding from the index for a given name.
func (s *serviceBindingLister) GetWithContext(ctx context.Context, name string) (*v1alpha1.ServiceBinding, error) {
