...
type TenancyV1beta1Interface interface {
...
// NewForConfig creates a new TenancyV1beta1Client for the given config.
...
// NewForConfigAndClient creates a new TenancyV1beta1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*TenancyV1beta1Client, error) {
	...
	return &TenancyV1beta1Client{restClient: client}, nil
}

// NewForConfigOrDie creates a new TenancyV1beta1Client for the given config and
...
func New(c rest.Interface) *TenancyV1beta1Client {
	return &TenancyV1beta1Client{restClient: c}
}

// NewWithCluster creates a new TenancyV1beta1Client for the given RESTClient and cluster.
func NewWithCluster(c rest.Interface, cluster logicalcluster.Name) *TenancyV1beta1Client {
	return &TenancyV1beta1Client{restClient: c, cluster: cluster}
}
