...
func (c *ApisV1alpha1Client) ResourceSchemas() ResourceSchemaInterface {
	return newResourceSchemas(c)
}

func (c *ApisV1alpha1Client) ServiceBindings() ServiceBindingInterface {
	return newServiceBindings(c)
}

func (c *ApisV1alpha1Client) ServiceExports() ServiceExportInterface {
	return newServiceExports(c)
}
