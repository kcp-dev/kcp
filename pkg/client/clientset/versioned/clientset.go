...
import (
	...
	exportsv1alpha1 "github.com/kcp-dev/kcp/pkg/client/clientset/versioned/typed/exports/v1alpha1"
...
type Interface interface {
	...
	ExportsV1alpha1() exportsv1alpha1.ExportsV1alpha1Interface
...
type scopedClientset struct {
	*discovery.DiscoveryClient
	...
	exportsV1alpha1     *exportsv1alpha1.ExportsV1alpha1Client
...
// ExportsV1alpha1 retrieves the ExportsV1alpha1Client
func (c *Clientset) ExportsV1alpha1() exportsv1alpha1.ExportsV1alpha1Interface {
	return exportsv1alpha1.NewWithCluster(c.exportsV1alpha1.RESTClient(), c.cluster)
}
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	cs.exportsV1alpha1, err = exportsv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	...
	cs.exportsV1alpha1 = exportsv1alpha1.New(c)
