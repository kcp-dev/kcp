...
// SyncTargetLister helps list workloadv1alpha1.SyncTarget.
...
type SyncTargetClusterLister interface {
	...
	// Cluster returns an object that can list and get workloadv1alpha1.SyncTarget from the given logical cluster.
