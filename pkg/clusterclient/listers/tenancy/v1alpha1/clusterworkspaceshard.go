...
// ClusterWorkspaceShardLister helps list tenancyv1alpha1.ClusterWorkspaceShard.
...
type ClusterWorkspaceShardClusterLister interface {
	...
	// Cluster returns an object that can list and get tenancyv1alpha1.ClusterWorkspaceShard from the given logical cluster.
	Cluster(cluster logicalcluster.Name) ClusterWorkspaceShardLister
}

// clusterWorkspaceShardClusterLister implements the ClusterWorkspaceShardClusterLister interface.
