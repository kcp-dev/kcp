...
type APIBindingInformer interface {
	...
	Lister() v1alpha1.APIBindingClusterLister
}
...
func (f *aPIBindingInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredAPIBindingInformer(
		client,
		resyncPeriod,
		cache.Indexers{
...
func (f *aPIBindingInformer) Lister() v1alpha1.APIBindingClusterLister {
	return v1alpha1.NewAPIBindingClusterLister(f.Informer().GetIndexer())
}
