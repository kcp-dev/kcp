...
type NegotiatedAPIResourceInformer interface {
	...
	Lister() v1alpha1.NegotiatedAPIResourceClusterLister
}
...
func (f *negotiatedAPIResourceInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredNegotiatedAPIResourceInformer(
		client,
		resyncPeriod,
		cache.Indexers{
...
func (f *negotiatedAPIResourceInformer) Lister() v1alpha1.NegotiatedAPIResourceClusterLister {
	return v1alpha1.NewNegotiatedAPIResourceClusterLister(f.Informer().GetIndexer())
}
