...
type ClusterWorkspaceInformer interface {
	...
	Lister() v1alpha1.ClusterWorkspaceClusterLister
}
...
func (f *clusterWorkspaceInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredClusterWorkspaceInformer(
		client,
		resyncPeriod,
		cache.Indexers{
...
func (f *clusterWorkspaceInformer) Lister() v1alpha1.ClusterWorkspaceClusterLister {
	return v1alpha1.NewClusterWorkspaceClusterLister(f.Informer().GetIndexer())
}
