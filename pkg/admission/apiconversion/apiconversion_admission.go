	...
	if err != nil {
		...
		if crdErr == nil {
			klog.FromContext(ctx).
				Info("Bypassing strict CEL validation for APIConversion because APIResourceSchema was not found but a Local CRD exists. Deferring syntax validation to runtime.",
					"apiConversion", u.GetName(), "cluster", cluster.Name)
			return nil
		}
