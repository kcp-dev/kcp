...
func NewWorkspaceContentAuthorizer(versionedInformers kcpkubernetesinformers.SharedInformerFactory, thisWorkspaceLister tenancyv1alpha1listers.ThisWorkspaceLister, delegate authorizer.Authorizer) authorizer.Authorizer {
...
func (a *workspaceContentAuthorizer) Authorize(ctx context.Context, attr authorizer.Attributes) (authorizer.Decision, string, error) {
	...
	this, err := a.thisWorkspaceLister.Get(client.ToClusterAwareKey(cluster.Name, tenancyv1alpha1.ThisWorkspaceName))
	if err != nil {
