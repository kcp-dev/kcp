...
type Controller struct {
	...
	getWorkspace func(key string) (*tenancyv1beta1.Workspace, error)
}

// NewController creates a new Controller.
func NewController(
	workspacesInformer tenancyv1beta1informers.WorkspaceInformer,
	kubeClusterClient kcpkubernetesclientset.ClusterInterface,
	...
	c := &Controller{
		...
		getWorkspace: func(key string) (*tenancyv1beta1.Workspace, error) {
			return workspacesInformer.Lister().Get(key)
		},
	}
