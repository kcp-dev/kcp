...
func (r *workspaceAPIExportReferenceReconciler) unbind(apiBinding *apisv1alpha1.APIBinding) {
	apiBinding.Status.BoundAPIExport = nil
	apiBinding.Status.BoundResources = nil
	// TODO(ncdc): what do we do about CRs that were created from APIBindings? Do we disallow unbinding until they're
	// all deleted? Do we delete them?
}
