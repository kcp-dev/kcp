...
func NewController(
	...
	c.closures = append(c.closures, func() {
...
func (c *Controller) enqueueCacheObject(obj interface{}) {
	...
	cr, ok := obj.(*cachev1alpha1.PublishedObject)
	if !ok {
		utilruntime.HandleError(fmt.Errorf("expected *cachev1alpha1.PublishedObject, got %T", obj))
		return
	}
...
type Controller struct {
	...
	callback func()
	// closures are cleanup functions that are called when the controller is stopped.
	closures []func()
