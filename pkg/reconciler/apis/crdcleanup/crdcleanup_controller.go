...
func NewController(
	...
	c := &controller{
		...
		deleteCRD: func(ctx context.Context, name string) error {
			return crdClusterClient.ApiextensionsV1().CustomResourceDefinitions().Delete(logicalcluster.WithCluster(ctx, apibinding.ShadowWorkspaceName), name, metav1.DeleteOptions{})
		},
	}
