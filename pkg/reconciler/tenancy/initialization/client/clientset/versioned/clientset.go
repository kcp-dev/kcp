...
import (
	...
	initializationv1alpha1 "github.com/kcp-dev/kcp/pkg/reconciler/tenancy/initialization/client/clientset/versioned/typed/initialization/v1alpha1"
)
...
type Interface interface {
	...
	InitializationV1alpha1() initializationv1alpha1.InitializationV1alpha1Interface
}
...
type scopedClientset struct {
	*discovery.DiscoveryClient
	initializationV1alpha1 *initializationv1alpha1.InitializationV1alpha1Client
}

// InitializationV1alpha1 retrieves the InitializationV1alpha1Client
func (c *Clientset) InitializationV1alpha1() initializationv1alpha1.InitializationV1alpha1Interface {
	return initializationv1alpha1.NewWithCluster(c.initializationV1alpha1.RESTClient(), c.cluster)
}
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	var err error
	cs.initializationV1alpha1, err = initializationv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	var cs scopedClientset
	cs.initializationV1alpha1 = initializationv1alpha1.New(c)
