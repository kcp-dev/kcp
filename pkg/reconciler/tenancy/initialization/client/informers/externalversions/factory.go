...
import (
	...
	initialization "github.com/kcp-dev/kcp/pkg/reconciler/tenancy/initialization/client/informers/externalversions/initialization"
...
type SharedInformerFactory interface {
	...
	Initialization() initialization.Interface
}

func (f *sharedInformerFactory) Initialization() initialization.Interface {
	return initialization.New(f, f.namespace, f.tweakListOptions)
}
