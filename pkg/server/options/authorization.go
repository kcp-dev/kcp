...
func (s *Authorization) ApplyTo(config *genericapiserver.Config, informer *kcpclientgoinformers.SharedInformerFactory, kcpinformer *kcpinformers.SharedInformerFactory) error {
