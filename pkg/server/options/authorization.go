...
func (s *Authorization) ApplyTo(config *genericapiserver.Config, informer coreinformers.SharedInformerFactory, kcpinformer kcpinformers.SharedInformerFactory) error {
