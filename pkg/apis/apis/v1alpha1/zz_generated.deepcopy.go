...
func (in *APIBindingSpec) DeepCopyInto(out *APIBindingSpec) {
	*out = *in
	...
	if in.AcceptedPermissionClaims != nil {
		in, out := &in.AcceptedPermissionClaims, &out.AcceptedPermissionClaims
...
func (in *APIBindingStatus) DeepCopyInto(out *APIBindingStatus) {
	*out = *in
	...
	if in.ObservedAcceptedPermissionClaims != nil {
		in, out := &in.ObservedAcceptedPermissionClaims, &out.ObservedAcceptedPermissionClaims
		*out = make([]PermissionClaim, len(*in))
		copy(*out, *in)
	}
	return
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PermissionClaimLabel) DeepCopyInto(out *PermissionClaimLabel) {
	*out = *in
	out.GroupResource = in.GroupResource
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PermissionClaimLabel.
func (in *PermissionClaimLabel) DeepCopy() *PermissionClaimLabel {
	if in == nil {
		return nil
	}
	out := new(PermissionClaimLabel)
	in.DeepCopyInto(out)
	return out
}
