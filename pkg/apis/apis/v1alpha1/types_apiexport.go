...
// +kubebuilder:validation:XValidation:rule="!has(self.group) || self.group != \"core.kcp.dev\" || self.resource != \"logicalclusters\" || (has(self.identityHash) && self.identityHash != \"\")",message="logicalclusters cannot be claimed"
