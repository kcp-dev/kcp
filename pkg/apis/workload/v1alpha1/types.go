...
const (
	...
	// ComputeAPIExportAnnotation is an annotation set on an APIExport when it will be used for compute,
	...
	ComputeAPIExportAnnotation = "extra.apis.kcp.dev/compute.workload.kcp.dev"
)
