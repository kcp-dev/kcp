...
func TestBoundAPIAuthorizer(t *testing.T) {
	for _, tc := range []struct {
		...
		{
			name: "list request to the API bound via permission claims but not allowing list",
			attr: &authorizer.AttributesRecord{
				User:     &user.DefaultInfo{},
				APIGroup: "foo",
				Resource: "bar",
		...
		{
			name: "list request to the API bound via permission claims but not allowing list (2)",
			attr: &authorizer.AttributesRecord{
				User:     &user.DefaultInfo{},
				APIGroup: "foo",
				Resource: "bar",
		...
		{
			name: "list request to the API bound via permission claims but not allowing list (3)",
			attr: &authorizer.AttributesRecord{
				User:     &user.DefaultInfo{},
				APIGroup: "foo",
				Resource: "bar",
