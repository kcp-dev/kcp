...
type CreateAPIDefinitionFunc func(apiResourceSchema *apisv1alpha1.APIResourceSchema, version string, export *apisv1alpha1.APIExport) (apidefinition.APIDefinition, error)
