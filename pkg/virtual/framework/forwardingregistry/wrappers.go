...
// ObjectFilterFunc is a function that decides whether an object should remain / be kept.
type ObjectFilterFunc func(ctx context.Context, obj runtime.Object) bool
