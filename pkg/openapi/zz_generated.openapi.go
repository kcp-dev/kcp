...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/kcp-dev/kcp/sdk/apis/cache/v1alpha1.PublishedObject":                            schema_sdk_apis_cache_v1alpha1_PublishedObject(ref),
		"github.com/kcp-dev/kcp/sdk/apis/cache/v1alpha1.PublishedObjectList":                        schema_sdk_apis_cache_v1alpha1_PublishedObjectList(ref),
		"github.com/kcp-dev/kcp/sdk/apis/cache/v1alpha1.PublishedObjectSpec":                        schema_sdk_apis_cache_v1alpha1_PublishedObjectSpec(ref),
		...
		"github.com/kcp-dev/kcp/sdk/apis/cache/v1alpha1.PublishedResourceStatus":                    schema_sdk_apis_cache_v1alpha1_PublishedResourceStatus(ref),
...
func schema_sdk_apis_cache_v1alpha1_Identity(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Identity defines the identity of an PublishedResource, i.e. determines the cached resource access of the resources, that are published by this PublishedResource.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"secretRef": {
						SchemaProps: spec.SchemaProps{
...
func schema_sdk_apis_cache_v1alpha1_PublishedObject(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PublishedObject defines a resource that is cached in the cache.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kcp-dev/kcp/sdk/apis/cache/v1alpha1.PublishedObjectSpec"),
						},
					},
				},
				Required: []string{"spec"},
		...
		Dependencies: []string{
			"github.com/kcp-dev/kcp/sdk/apis/cache/v1alpha1.PublishedObjectSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_sdk_apis_cache_v1alpha1_PublishedObjectList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PublishedObjectList contains a list of PublishedObject",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kcp-dev/kcp/sdk/apis/cache/v1alpha1.PublishedObject"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kcp-dev/kcp/sdk/apis/cache/v1alpha1.PublishedObject", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_sdk_apis_cache_v1alpha1_PublishedObjectSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PublishedObjectSpec defines the desired state of PublishedObject",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"raw": {
						SchemaProps: spec.SchemaProps{
...
func schema_sdk_apis_cache_v1alpha1_PublishedResource(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PublishedResource defines a resource that should be published to other workspaces",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kcp-dev/kcp/sdk/apis/cache/v1alpha1.PublishedResourceSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kcp-dev/kcp/sdk/apis/cache/v1alpha1.PublishedResourceStatus"),
						},
					},
				},
				Required: []string{"spec"},
		...
		Dependencies: []string{
			"github.com/kcp-dev/kcp/sdk/apis/cache/v1alpha1.PublishedResourceSpec", "github.com/kcp-dev/kcp/sdk/apis/cache/v1alpha1.PublishedResourceStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_sdk_apis_cache_v1alpha1_PublishedResourceList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PublishedResourceList contains a list of PublishedResource",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kcp-dev/kcp/sdk/apis/cache/v1alpha1.PublishedResource"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kcp-dev/kcp/sdk/apis/cache/v1alpha1.PublishedResource", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_sdk_apis_cache_v1alpha1_PublishedResourceSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PublishedResourceSpec defines the desired state of PublishedResource",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"group": {
						SchemaProps: spec.SchemaProps{
					...
					"identity": {
						SchemaProps: spec.SchemaProps{
							Description: "identity points to a secret that contains the API identity in the 'key' file. The API identity allows access to PublishedResource's resources via the APIExport.\n\nDifferent  PublishedResource in a workspace can share a common identity, or have different ones. The identity (the secret) can also be transferred to another workspace when the  ublishedResource is moved.\n\nThe identity is defaulted. A secret with the name of the PublishedResource is automatically created.",
...
func schema_sdk_apis_cache_v1alpha1_PublishedResourceStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PublishedResourceStatus defines the observed state of PublishedResource",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"identityHash": {
						SchemaProps: spec.SchemaProps{
