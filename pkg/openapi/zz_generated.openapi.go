...
func schema_pkg_apis_scheduling_v1alpha1_InstancesReference(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/kcp-dev/kcp/pkg/apis/scheduling/v1alpha1.WorkspaceExportReference"},
	}
}
...
func schema_pkg_apis_scheduling_v1alpha1_LocationDomainSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/kcp-dev/kcp/pkg/apis/scheduling/v1alpha1.InstancesReference", "github.com/kcp-dev/kcp/pkg/apis/scheduling/v1alpha1.WorkspaceSelector"},
	}
}
