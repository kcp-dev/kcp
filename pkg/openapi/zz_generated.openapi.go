			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"labels": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "labels is a set of labels that all instances in this location have in common.",
							Type:        []string{"object"},
