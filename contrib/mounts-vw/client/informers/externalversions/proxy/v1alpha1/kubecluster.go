...
type KubeClusterClusterInformer interface {
	...
	Lister() proxyv1alpha1listers.KubeClusterClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ProxyV1alpha1().KubeClusters().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProxyV1alpha1().KubeClusters().Watch(context.TODO(), options)
			},
		},
		&proxyv1alpha1.KubeCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *kubeClusterClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return f.factory.InformerFor(&proxyv1alpha1.KubeCluster{}, f.defaultInformer)
}

func (f *kubeClusterClusterInformer) Lister() proxyv1alpha1listers.KubeClusterClusterLister {
	return proxyv1alpha1listers.NewKubeClusterClusterLister(f.Informer().GetIndexer())
}
...
type KubeClusterInformer interface {
	...
	Lister() proxyv1alpha1listers.KubeClusterLister
}
...
func (f *kubeClusterInformer) Lister() proxyv1alpha1listers.KubeClusterLister {
	return f.lister
}
...
func (f *kubeClusterScopedInformer) Lister() proxyv1alpha1listers.KubeClusterLister {
	return proxyv1alpha1listers.NewKubeClusterLister(f.Informer().GetIndexer())
}
