...
import (
	...
	proxyv1alpha1listers "github.com/kcp-dev/kcp/contrib/mounts-vw/client/listers/proxy/v1alpha1"
)
...
type TargetKubeClusterClusterInformer interface {
	...
	Lister() proxyv1alpha1listers.TargetKubeClusterClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ProxyV1alpha1().TargetKubeClusters().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProxyV1alpha1().TargetKubeClusters().Watch(context.TODO(), options)
			},
		},
		&proxyv1alpha1.TargetKubeCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *targetKubeClusterClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return f.factory.InformerFor(&proxyv1alpha1.TargetKubeCluster{}, f.defaultInformer)
}

func (f *targetKubeClusterClusterInformer) Lister() proxyv1alpha1listers.TargetKubeClusterClusterLister {
	return proxyv1alpha1listers.NewTargetKubeClusterClusterLister(f.Informer().GetIndexer())
}
...
type TargetKubeClusterInformer interface {
	...
	Lister() proxyv1alpha1listers.TargetKubeClusterLister
}
...
func (f *targetKubeClusterInformer) Lister() proxyv1alpha1listers.TargetKubeClusterLister {
	return f.lister
}
...
func (f *targetKubeClusterScopedInformer) Lister() proxyv1alpha1listers.TargetKubeClusterLister {
	return proxyv1alpha1listers.NewTargetKubeClusterLister(f.Informer().GetIndexer())
}
