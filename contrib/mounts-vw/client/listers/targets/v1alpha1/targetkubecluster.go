...
type TargetKubeClusterClusterLister interface {
	...
	List(selector labels.Selector) (ret []*targetsv1alpha1.TargetKubeCluster, err error)
...
func (s *targetKubeClusterClusterLister) List(selector labels.Selector) (ret []*targetsv1alpha1.TargetKubeCluster, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*targetsv1alpha1.TargetKubeCluster))
	})
	return ret, err
}
...
type TargetKubeClusterLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*targetsv1alpha1.TargetKubeCluster, error)
...
func (s *targetKubeClusterLister) List(selector labels.Selector) (ret []*targetsv1alpha1.TargetKubeCluster, err error) {
	err = kcpcache.ListAllByCluster(s.indexer, s.clusterName, selector, func(i interface{}) {
		ret = append(ret, i.(*targetsv1alpha1.TargetKubeCluster))
	})
	return ret, err
}

// Get retrieves the TargetKubeCluster from the indexer for a given workspace and name.
func (s *targetKubeClusterLister) Get(name string) (*targetsv1alpha1.TargetKubeCluster, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(targetsv1alpha1.Resource("targetkubeclusters"), name)
	}
	return obj.(*targetsv1alpha1.TargetKubeCluster), nil
}
...
// List lists all TargetKubeClusters in the indexer for a workspace.
func (s *targetKubeClusterScopedLister) List(selector labels.Selector) (ret []*targetsv1alpha1.TargetKubeCluster, err error) {
...
// Get retrieves the TargetKubeCluster from the indexer for a given workspace and name.
func (s *targetKubeClusterScopedLister) Get(name string) (*targetsv1alpha1.TargetKubeCluster, error) {
	key := name
	obj, exists, err := s.indexer.GetByKey(key)
	if err != nil {
		return nil, err
