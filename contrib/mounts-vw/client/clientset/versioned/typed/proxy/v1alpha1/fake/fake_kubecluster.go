...
func (c *FakeKubeClusters) Apply(ctx context.Context, kubeCluster *proxyv1alpha1.KubeClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.KubeCluster, err error) {
	if kubeCluster == nil {
...
func (c *FakeKubeClusters) ApplyStatus(ctx context.Context, kubeCluster *proxyv1alpha1.KubeClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.KubeCluster, err error) {
	if kubeCluster == nil {
		return nil, fmt.Errorf("kubeCluster provided to Apply must not be nil")
	}
	data, err := json.Marshal(kubeCluster)
