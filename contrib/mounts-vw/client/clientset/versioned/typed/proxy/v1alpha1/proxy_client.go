...
// ProxyV1alpha1Client is used to interact with features provided by the proxy.contrib.kcp.io group.
type ProxyV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ProxyV1alpha1Client) KubeClusters() KubeClusterInterface {
	return newKubeClusters(c)
}

func (c *ProxyV1alpha1Client) TargetKubeClusters() TargetKubeClusterInterface {
