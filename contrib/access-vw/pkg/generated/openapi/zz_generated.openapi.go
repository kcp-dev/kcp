...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/kcp-dev/kcp/contrib/access-vw/pkg/apis/access/v1alpha1.AccessEndpointSlice":           schema_pkg_apis_access_v1alpha1_AccessEndpointSlice(ref),
		"github.com/kcp-dev/kcp/contrib/access-vw/pkg/apis/access/v1alpha1.SelfClusterAccessReview":       schema_pkg_apis_access_v1alpha1_SelfClusterAccessReview(ref),
		"github.com/kcp-dev/kcp/contrib/access-vw/pkg/apis/access/v1alpha1.SelfClusterAccessReviewList":   schema_pkg_apis_access_v1alpha1_SelfClusterAccessReviewList(ref),
		"github.com/kcp-dev/kcp/contrib/access-vw/pkg/apis/access/v1alpha1.SelfClusterAccessReviewStatus": schema_pkg_apis_access_v1alpha1_SelfClusterAccessReviewStatus(ref),
...
func schema_pkg_apis_access_v1alpha1_SelfClusterAccessReview(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"status": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/kcp-dev/kcp/contrib/access-vw/pkg/apis/access/v1alpha1.SelfClusterAccessReviewStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/kcp-dev/kcp/contrib/access-vw/pkg/apis/access/v1alpha1.SelfClusterAccessReviewStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_access_v1alpha1_SelfClusterAccessReviewList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kcp-dev/kcp/contrib/access-vw/pkg/apis/access/v1alpha1.SelfClusterAccessReview"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kcp-dev/kcp/contrib/access-vw/pkg/apis/access/v1alpha1.SelfClusterAccessReview", v1.ListMeta{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_access_v1alpha1_SelfClusterAccessReviewStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kcp-dev/kcp/contrib/access-vw/pkg/apis/access/v1alpha1.AccessEndpointSlice"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kcp-dev/kcp/contrib/access-vw/pkg/apis/access/v1alpha1.AccessEndpointSlice"},
	}
}
