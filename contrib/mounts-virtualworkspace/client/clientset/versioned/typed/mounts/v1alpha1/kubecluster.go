...
type KubeClusterInterface interface {
	...
	Apply(ctx context.Context, kubeCluster *mountsv1alpha1.KubeClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.KubeCluster, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, kubeCluster *mountsv1alpha1.KubeClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.KubeCluster, err error)
	KubeClusterExpansion
}

// kubeClusters implements KubeClusterInterface
type kubeClusters struct {
	*gentype.ClientWithListAndApply[*v1alpha1.KubeCluster, *v1alpha1.KubeClusterList, *mountsv1alpha1.KubeClusterApplyConfiguration]
}

// newKubeClusters returns a KubeClusters
func newKubeClusters(c *MountsV1alpha1Client) *kubeClusters {
	return &kubeClusters{
		gentype.NewClientWithListAndApply[*v1alpha1.KubeCluster, *v1alpha1.KubeClusterList, *mountsv1alpha1.KubeClusterApplyConfiguration](
			"kubeclusters",
			c.RESTClient(),
