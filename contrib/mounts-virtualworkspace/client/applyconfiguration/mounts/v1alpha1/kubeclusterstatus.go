...
// KubeClusterStatusApplyConfiguration represents a declarative configuration of the KubeClusterStatus type for use
// with apply.
type KubeClusterStatusApplyConfiguration struct {
...
// KubeClusterStatusApplyConfiguration constructs a declarative configuration of the KubeClusterStatus type for use with
// apply.
func KubeClusterStatus() *KubeClusterStatusApplyConfiguration {
	return &KubeClusterStatusApplyConfiguration{}
}

// WithURL sets the URL field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the URL field is set to the value of the last call.
func (b *KubeClusterStatusApplyConfiguration) WithURL(value string) *KubeClusterStatusApplyConfiguration {
	b.URL = &value
	return b
}
...
func (b *KubeClusterStatusApplyConfiguration) WithPhase(value v1alpha1.MountPhaseType) *KubeClusterStatusApplyConfiguration {
	b.Phase = &value
	return b
}
...
func (b *KubeClusterStatusApplyConfiguration) WithConditions(value conditionsv1alpha1.Conditions) *KubeClusterStatusApplyConfiguration {
	b.Conditions = &value
	return b
}
