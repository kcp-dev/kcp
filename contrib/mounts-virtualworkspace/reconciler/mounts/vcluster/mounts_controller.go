...
import (
	...
	mountsclientset "github.com/kcp-dev/kcp/contrib/mounts-virtualworkspace/client/clientset/versioned/cluster"
	mountsv1alpha1client "github.com/kcp-dev/kcp/contrib/mounts-virtualworkspace/client/clientset/versioned/typed/mounts/v1alpha1"
	mountsv1alpha1informers "github.com/kcp-dev/kcp/contrib/mounts-virtualworkspace/client/informers/externalversions/mounts/v1alpha1"
	mountsv1alpha1listers "github.com/kcp-dev/kcp/contrib/mounts-virtualworkspace/client/listers/mounts/v1alpha1"
	"github.com/kcp-dev/kcp/contrib/mounts-virtualworkspace/state"
)

const (
	// ControllerName is the name of this controller.
	ControllerName = "kcp-mounts-vclusters"
)
...
func NewController(
	...
	mountsInformers mountsv1alpha1informers.VClusterClusterInformer,
	...
	c := &Controller{
		...
		commit: committer.NewCommitter[*mountsv1alpha1.VCluster, mountsv1alpha1client.VClusterInterface, *mountsv1alpha1.VClusterSpec, *mountsv1alpha1.VClusterStatus](mountsClusterClient.MountsV1alpha1().VClusters()),
	}
...
type mountResources = committer.Resource[*mountsv1alpha1.VClusterSpec, *mountsv1alpha1.VClusterStatus]
...
type Controller struct {
	...
	mountsLister  mountsv1alpha1listers.VClusterClusterLister
...
func (c *Controller) enqueue(obj interface{}) {
	...
	logger.V(4).Info("queueing VCluster mount")
	c.queue.Add(key)
}
