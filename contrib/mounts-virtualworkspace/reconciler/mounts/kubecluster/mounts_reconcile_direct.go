...
import (
	...
	"github.com/kcp-dev/kcp/contrib/mounts-virtualworkspace/utils/clientgo"
...
func (r *directReconciler) reconcile(ctx context.Context, mount *mountsv1alpha1.KubeCluster) (reconcileStatus, error) {
