...
import (
	...
	mountsclusterclientset "github.com/kcp-dev/kcp/contrib/mounts-virtualworkspace/client/clientset/versioned/cluster"
...
func restConfigForAPIExport(ctx context.Context, kcpAdminRestConfig *rest.Config, apiExportName string, cluster logicalcluster.Path) ([]rest.Config, error) {
	...
	spew.Dump(cluster)
	spew.Dump(bootstrapClient.Cluster(cluster).ApisV1alpha1().APIConversions().List(ctx, metav1.ListOptions{}))
