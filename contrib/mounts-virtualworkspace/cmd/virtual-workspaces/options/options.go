...
import (
	...
	proxyvwoptions "github.com/kcp-dev/kcp/contrib/mounts-virtualworkspace/virtual/options"
)
...
type Options struct {
	...
	Authorization  virtualoptions.Authorization
...
func NewOptions() *Options {
	opts := &Options{
		...
		Authorization:  *virtualoptions.NewAuthorization(),
...
func (o *Options) AddFlags(flags *pflag.FlagSet) {
	...
	flags.StringVar(&o.KubeconfigFile, "kubeconfig", o.KubeconfigFile, "The kubeconfig file of the KCP instance that hosts workspaces.")
