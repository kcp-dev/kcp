...
type GeographicalCoordinates struct {
	// Latitude specifies the latitude coordinate as a string to avoid float64 CRD issues
	Latitude string `json:"latitude"`

	// Longitude specifies the longitude coordinate as a string to avoid float64 CRD issues
