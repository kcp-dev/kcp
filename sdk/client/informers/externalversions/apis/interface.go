...
import (
	kcpv1alpha1 "github.com/kcp-dev/kcp/sdk/client/informers/externalversions/apis/v1alpha1"
	kcpv1alpha2 "github.com/kcp-dev/kcp/sdk/client/informers/externalversions/apis/v1alpha2"
...
type Interface interface {
	...
	// V1alpha2 provides access to shared informers for resources in V1alpha2.
	V1alpha2() kcpv1alpha2.Interface
}
...
// V1alpha2 returns a new kcpv1alpha2.Interface.
func (g *scopedGroup) V1alpha2() kcpv1alpha2.Interface {
	return kcpv1alpha2.NewScoped(g.factory, g.namespace, g.tweakListOptions)
}
