...
func (l *aPIExportClusterLister) Cluster(clusterName logicalcluster.Name) APIExportLister {
	return &aPIExportLister{
		kcplisters.New[*kcpv1alpha1.APIExport](l.indexer, clusterName, kcpv1alpha1.Resource("apiexport")),
		l.indexer,
		clusterName,
	}
}
...
func NewAPIExportLister(indexer cache.Indexer) APIExportLister {
	return &aPIExportScopedLister{
		listers.New[*kcpv1alpha1.APIExport](indexer, kcpv1alpha1.Resource("apiexport")),
		indexer,
	}
}
...
type aPIExportScopedLister struct {
	listers.ResourceIndexer[*kcpv1alpha1.APIExport]
	indexer cache.Indexer
}
