...
func (l *aPIBindingClusterLister) Cluster(clusterName logicalcluster.Name) APIBindingLister {
	return &aPIBindingLister{
		kcplisters.New[*kcpv1alpha2.APIBinding](l.indexer, clusterName, kcpv1alpha2.Resource("apibinding")),
		l.indexer,
		clusterName,
	}
}
...
func NewAPIBindingLister(indexer cache.Indexer) APIBindingLister {
	return &aPIBindingScopedLister{
		listers.New[*kcpv1alpha2.APIBinding](indexer, kcpv1alpha2.Resource("apibinding")),
		indexer,
	}
}
...
type aPIBindingScopedLister struct {
	listers.ResourceIndexer[*kcpv1alpha2.APIBinding]
	indexer cache.Indexer
}
