...
func (c *WorkloadV1alpha1Client) Locations() LocationInterface {
	return newLocations(c)
}

func (c *WorkloadV1alpha1Client) Placements() PlacementInterface {
	return newPlacements(c)
}

func (c *WorkloadV1alpha1Client) ResourceExports() ResourceExportInterface {
	return newResourceExports(c)
}

func (c *WorkloadV1alpha1Client) ResourceImports() ResourceImportInterface {
	return newResourceImports(c)
}
...
func (c *WorkloadV1alpha1Client) SyncTargetHeartbeats() SyncTargetHeartbeatInterface {
	return newSyncTargetHeartbeats(c)
}
