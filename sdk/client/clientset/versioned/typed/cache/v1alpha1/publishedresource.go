...
type PublishedResourceInterface interface {
	...
	Apply(ctx context.Context, publishedResource *cachev1alpha1.PublishedResourceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.PublishedResource, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, publishedResource *cachev1alpha1.PublishedResourceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.PublishedResource, err error)
	PublishedResourceExpansion
}

// publishedResources implements PublishedResourceInterface
type publishedResources struct {
	*gentype.ClientWithListAndApply[*v1alpha1.PublishedResource, *v1alpha1.PublishedResourceList, *cachev1alpha1.PublishedResourceApplyConfiguration]
}
...
func newPublishedResources(c *CacheV1alpha1Client) *publishedResources {
	return &publishedResources{
		gentype.NewClientWithListAndApply[*v1alpha1.PublishedResource, *v1alpha1.PublishedResourceList, *cachev1alpha1.PublishedResourceApplyConfiguration](
			"publishedresources",
			c.RESTClient(),
