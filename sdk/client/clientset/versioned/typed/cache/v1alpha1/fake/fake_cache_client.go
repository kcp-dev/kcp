...
func (c *FakeCacheV1alpha1) PublishedObjects() v1alpha1.PublishedObjectInterface {
	return newFakePublishedObjects(c)
}

func (c *FakeCacheV1alpha1) PublishedResources() v1alpha1.PublishedResourceInterface {
