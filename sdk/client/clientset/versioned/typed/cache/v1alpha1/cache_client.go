...
func (c *CacheV1alpha1Client) PublishedObjects() PublishedObjectInterface {
	return newPublishedObjects(c)
}

func (c *CacheV1alpha1Client) PublishedResources() PublishedResourceInterface {
