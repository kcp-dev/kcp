...
type WorkloadV1alpha1ClusterInterface interface {
	...
	ResourceExportsClusterGetter
	ResourceImportsClusterGetter
	SyncTargetsClusterGetter
	SyncTargetHeartbeatsClusterGetter
}
...
func (c *WorkloadV1alpha1ClusterClient) Locations() LocationClusterInterface {
	return &locationsClusterInterface{clientCache: c.clientCache}
}

func (c *WorkloadV1alpha1ClusterClient) Placements() PlacementClusterInterface {
	return &placementsClusterInterface{clientCache: c.clientCache}
}

func (c *WorkloadV1alpha1ClusterClient) ResourceExports() ResourceExportClusterInterface {
	return &resourceExportsClusterInterface{clientCache: c.clientCache}
}

func (c *WorkloadV1alpha1ClusterClient) ResourceImports() ResourceImportClusterInterface {
	return &resourceImportsClusterInterface{clientCache: c.clientCache}
}
...
func (c *WorkloadV1alpha1ClusterClient) SyncTargetHeartbeats() SyncTargetHeartbeatClusterInterface {
	return &syncTargetHeartbeatsClusterInterface{clientCache: c.clientCache}
}
