...
// or scope down to one cluster and return a kcpv1alpha1.LocationInterface.
type LocationClusterInterface interface {
	Cluster(logicalcluster.Path) kcpv1alpha1.LocationInterface
	List(ctx context.Context, opts v1.ListOptions) (*kcpworkloadv1alpha1.LocationList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	LocationClusterExpansion
}
...
func (c *locationsClusterInterface) Cluster(clusterPath logicalcluster.Path) kcpv1alpha1.LocationInterface {
...
func (c *locationsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*kcpworkloadv1alpha1.LocationList, error) {
...
func (c *locationsClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
