...
// or scope down to one cluster and return a kcpv1alpha1.PartitionSetInterface.
type PartitionSetClusterInterface interface {
	Cluster(logicalcluster.Path) kcpv1alpha1.PartitionSetInterface
	List(ctx context.Context, opts v1.ListOptions) (*kcptopologyv1alpha1.PartitionSetList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	PartitionSetClusterExpansion
}
...
func (c *partitionSetsClusterInterface) Cluster(clusterPath logicalcluster.Path) kcpv1alpha1.PartitionSetInterface {
...
func (c *partitionSetsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*kcptopologyv1alpha1.PartitionSetList, error) {
...
func (c *partitionSetsClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
