...
// or scope down to one cluster and return a apisv1alpha1client.APIConversionInterface.
...
func (c *aPIConversionsClusterInterface) Cluster(clusterPath logicalcluster.Path) apisv1alpha1client.APIConversionInterface {
...
func (c *aPIConversionsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apisv1alpha1.APIConversionList, error) {
