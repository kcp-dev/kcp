...
func (c *CacheV1alpha1ClusterClient) PublishedObjects() PublishedObjectClusterInterface {
	return &publishedObjectsClusterInterface{clientCache: c.clientCache}
}
