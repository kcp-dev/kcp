...
// or scope down to one cluster and return a kcpv1alpha1.PublishedResourceInterface.
type PublishedResourceClusterInterface interface {
	Cluster(logicalcluster.Path) kcpv1alpha1.PublishedResourceInterface
	List(ctx context.Context, opts v1.ListOptions) (*kcpcachev1alpha1.PublishedResourceList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	PublishedResourceClusterExpansion
}
...
func (c *publishedResourcesClusterInterface) Cluster(clusterPath logicalcluster.Path) kcpv1alpha1.PublishedResourceInterface {
...
func (c *publishedResourcesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*kcpcachev1alpha1.PublishedResourceList, error) {
...
func (c *publishedResourcesClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
