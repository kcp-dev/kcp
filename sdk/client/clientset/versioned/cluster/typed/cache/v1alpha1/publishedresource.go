...
// or scope down to one cluster and return a cachev1alpha1client.PublishedResourceInterface.
type PublishedResourceClusterInterface interface {
	Cluster(logicalcluster.Path) cachev1alpha1client.PublishedResourceInterface
	List(ctx context.Context, opts metav1.ListOptions) (*cachev1alpha1.PublishedResourceList, error)
...
func (c *publishedResourcesClusterInterface) Cluster(clusterPath logicalcluster.Path) cachev1alpha1client.PublishedResourceInterface {
...
func (c *publishedResourcesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*cachev1alpha1.PublishedResourceList, error) {
