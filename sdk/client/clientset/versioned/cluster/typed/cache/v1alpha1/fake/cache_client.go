...
func (c *CacheV1alpha1ClusterClient) PublishedObjects() kcpcachev1alpha1.PublishedObjectClusterInterface {
	return newFakePublishedObjectClusterClient(c)
}

func (c *CacheV1alpha1ClusterClient) PublishedResources() kcpcachev1alpha1.PublishedResourceClusterInterface {
	return newFakePublishedResourceClusterClient(c)
}
...
func (c *CacheV1alpha1Client) PublishedObjects() cachev1alpha1.PublishedObjectInterface {
	return newFakePublishedObjectClient(c.Fake, c.ClusterPath)
}

func (c *CacheV1alpha1Client) PublishedResources() cachev1alpha1.PublishedResourceInterface {
	return newFakePublishedResourceClient(c.Fake, c.ClusterPath)
}
