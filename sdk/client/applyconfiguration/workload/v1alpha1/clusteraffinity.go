...
func (b *ClusterAffinityApplyConfiguration) WithRequiredDuringSchedulingIgnoredDuringExecution(value *ClusterAffinityTermApplyConfiguration) *ClusterAffinityApplyConfiguration {
...
func (b *ClusterAffinityApplyConfiguration) WithPreferredDuringSchedulingIgnoredDuringExecution(values ...*WeightedClusterAffinityTermApplyConfiguration) *ClusterAffinityApplyConfiguration {
	for i := range values {
		if values[i] == nil {
