...
type TopologySpreadConstraintApplyConfiguration struct {
	...
	WhenUnsatisfiable *workloadv1alpha1.UnsatisfiableConstraintAction `json:"whenUnsatisfiable,omitempty"`
...
func (b *TopologySpreadConstraintApplyConfiguration) WithWhenUnsatisfiable(value workloadv1alpha1.UnsatisfiableConstraintAction) *TopologySpreadConstraintApplyConfiguration {
