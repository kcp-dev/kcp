...
type PublishedResourceStatusApplyConfiguration struct {
	...
	Phase          *cachev1alpha1.PublishedResourcePhaseType `json:"phase,omitempty"`
...
func (b *PublishedResourceStatusApplyConfiguration) WithResourceCounts(value *ResourceCountApplyConfiguration) *PublishedResourceStatusApplyConfiguration {
...
func (b *PublishedResourceStatusApplyConfiguration) WithPhase(value cachev1alpha1.PublishedResourcePhaseType) *PublishedResourceStatusApplyConfiguration {
	b.Phase = &value
	return b
}
