...
func CachedResourceEndpointSliceSpec() *CachedResourceEndpointSliceSpecApplyConfiguration {
	return &CachedResourceEndpointSliceSpecApplyConfiguration{}
}

// WithCachedResource sets the CachedResource field in the declarative configuration to the given value
