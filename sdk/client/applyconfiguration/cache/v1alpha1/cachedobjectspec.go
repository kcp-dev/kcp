...
// CachedObjectSpecApplyConfiguration constructs a declarative configuration of the CachedObjectSpec type for use with
// apply.
func CachedObjectSpec() *CachedObjectSpecApplyConfiguration {
	return &CachedObjectSpecApplyConfiguration{}
}
