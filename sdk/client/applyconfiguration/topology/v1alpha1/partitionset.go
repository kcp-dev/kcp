...
// PartitionSetApplyConfiguration represents an declarative configuration of the PartitionSet type for use
// with apply.
...
// PartitionSet constructs an declarative configuration of the PartitionSet type for use with
// apply.
