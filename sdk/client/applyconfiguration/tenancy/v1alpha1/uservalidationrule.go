...
// UserValidationRuleApplyConfiguration constructs a declarative configuration of the UserValidationRule type for use with
// apply.
func UserValidationRule() *UserValidationRuleApplyConfiguration {
	return &UserValidationRuleApplyConfiguration{}
}
