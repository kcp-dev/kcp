...
func TestSyncTargetExport(t *testing.T) {
	...
	err = helpers.CreateResourceFromFS(ctx, dynamicClients.Cluster(schemaClusterName), mapper, "apiresourceschema_service.yaml", testFiles)
	require.NoError(t, err)
	err = helpers.CreateResourceFromFS(ctx, dynamicClients.Cluster(schemaClusterName), mapper, "apiresourceschema_cowboys.yaml", testFiles)
	require.NoError(t, err)
	...
	_ = framework.SyncerFixture{
		...
		WorkspaceClusterName: computeClusterName,
