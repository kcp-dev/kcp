...
func NewInProcessServer(t kcptestingserver.TestingT, opts ...kcptestingserver.Option) *InProcessServer {
	...
	opts = append(
		[]kcptestingserver.Option{
			...
			kcptestingserver.WithCustomArguments("--feature-gates=WorkspaceMounts=true,CacheAPIs=true,WorkspaceAuthentication=true,LogicalClusterMigration=true,APIConversion=true"),
		},
		opts...,
	)
