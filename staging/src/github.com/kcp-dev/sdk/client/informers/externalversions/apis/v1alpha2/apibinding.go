	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApisV1alpha2().APIBindings().List(context.Background(), options)
			},
...
func (i *aPIBindingClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&kcpapisv1alpha2.APIBinding{}, i.defaultInformer)
}

func (i *aPIBindingClusterInformer) Lister() kcpv1alpha2.APIBindingClusterLister {
	return kcpv1alpha2.NewAPIBindingClusterLister(i.Informer().GetIndexer())
}
...
func (i *aPIBindingInformer) Lister() kcpv1alpha2.APIBindingLister {
	return i.lister
}
...
func (i *aPIBindingScopedInformer) Lister() kcpv1alpha2.APIBindingLister {
	return kcpv1alpha2.NewAPIBindingLister(i.Informer().GetIndexer())
}
