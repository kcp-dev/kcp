...
// or scope down to one cluster and return a kcpv1alpha2.APIBindingInterface.
type APIBindingClusterInterface interface {
	Cluster(logicalcluster.Path) kcpv1alpha2.APIBindingInterface
	List(ctx context.Context, opts v1.ListOptions) (*kcpapisv1alpha2.APIBindingList, error)
...
func (c *aPIBindingsClusterInterface) Cluster(clusterPath logicalcluster.Path) kcpv1alpha2.APIBindingInterface {
...
func (c *aPIBindingsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*kcpapisv1alpha2.APIBindingList, error) {
