...
// or scope down to one cluster and return a kcpv1alpha1.APIExportEndpointSliceInterface.
type APIExportEndpointSliceClusterInterface interface {
	Cluster(logicalcluster.Path) kcpv1alpha1.APIExportEndpointSliceInterface
	List(ctx context.Context, opts v1.ListOptions) (*kcpapisv1alpha1.APIExportEndpointSliceList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	APIExportEndpointSliceClusterExpansion
}
...
func (c *aPIExportEndpointSlicesClusterInterface) Cluster(clusterPath logicalcluster.Path) kcpv1alpha1.APIExportEndpointSliceInterface {
...
func (c *aPIExportEndpointSlicesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*kcpapisv1alpha1.APIExportEndpointSliceList, error) {
...
func (c *aPIExportEndpointSlicesClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
