...
func (c *MigrationV1alpha1Client) LogicalClusterDumps() LogicalClusterDumpInterface {
	return newLogicalClusterDumps(c)
}

func (c *MigrationV1alpha1Client) LogicalClusterMigrations() LogicalClusterMigrationInterface {
	return newLogicalClusterMigrations(c)
}
