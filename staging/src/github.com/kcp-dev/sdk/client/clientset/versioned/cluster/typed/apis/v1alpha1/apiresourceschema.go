...
// or scope down to one cluster and return a kcpv1alpha1.APIResourceSchemaInterface.
type APIResourceSchemaClusterInterface interface {
	Cluster(logicalcluster.Path) kcpv1alpha1.APIResourceSchemaInterface
	List(ctx context.Context, opts v1.ListOptions) (*kcpapisv1alpha1.APIResourceSchemaList, error)
...
func (c *aPIResourceSchemasClusterInterface) Cluster(clusterPath logicalcluster.Path) kcpv1alpha1.APIResourceSchemaInterface {
...
func (c *aPIResourceSchemasClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*kcpapisv1alpha1.APIResourceSchemaList, error) {
