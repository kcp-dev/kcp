...
// or scope down to one cluster and return a kcpv1alpha1.APIExportInterface.
type APIExportClusterInterface interface {
	Cluster(logicalcluster.Path) kcpv1alpha1.APIExportInterface
	List(ctx context.Context, opts v1.ListOptions) (*kcpapisv1alpha1.APIExportList, error)
...
func (c *aPIExportsClusterInterface) Cluster(clusterPath logicalcluster.Path) kcpv1alpha1.APIExportInterface {
...
func (c *aPIExportsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*kcpapisv1alpha1.APIExportList, error) {
