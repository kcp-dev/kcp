...
func ExtractAPIBindingFrom(aPIBinding *apisv1alpha2.APIBinding, fieldManager string, subresource string) (*APIBindingApplyConfiguration, error) {
	b := &APIBindingApplyConfiguration{}
	err := managedfields.ExtractInto(aPIBinding, internal.Parser().Type("com.github.kcp-dev.sdk.apis.apis.v1alpha2.APIBinding"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractAPIBinding(aPIBinding *apisv1alpha2.APIBinding, fieldManager string) (*APIBindingApplyConfiguration, error) {
...
func ExtractAPIBindingStatus(aPIBinding *apisv1alpha2.APIBinding, fieldManager string) (*APIBindingApplyConfiguration, error) {
