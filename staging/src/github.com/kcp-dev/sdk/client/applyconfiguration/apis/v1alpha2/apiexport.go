...
func ExtractAPIExportFrom(aPIExport *apisv1alpha2.APIExport, fieldManager string, subresource string) (*APIExportApplyConfiguration, error) {
	b := &APIExportApplyConfiguration{}
	err := managedfields.ExtractInto(aPIExport, internal.Parser().Type("com.github.kcp-dev.sdk.apis.apis.v1alpha2.APIExport"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractAPIExport(aPIExport *apisv1alpha2.APIExport, fieldManager string) (*APIExportApplyConfiguration, error) {
...
func ExtractAPIExportStatus(aPIExport *apisv1alpha2.APIExport, fieldManager string) (*APIExportApplyConfiguration, error) {
