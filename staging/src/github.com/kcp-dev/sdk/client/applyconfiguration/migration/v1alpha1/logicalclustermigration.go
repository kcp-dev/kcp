...
// LogicalClusterMigrationApplyConfiguration represents a declarative configuration of the LogicalClusterMigration type for use
// with apply.
//
...
// LogicalClusterMigration constructs a declarative configuration of the LogicalClusterMigration type for use with
// apply.
func LogicalClusterMigration(name string) *LogicalClusterMigrationApplyConfiguration {
	b := &LogicalClusterMigrationApplyConfiguration{}
	b.WithName(name)
	b.WithKind("LogicalClusterMigration")
...
func (b *LogicalClusterMigrationApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
