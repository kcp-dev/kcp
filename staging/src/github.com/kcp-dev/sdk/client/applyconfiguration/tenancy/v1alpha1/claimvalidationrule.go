...
// ClaimValidationRuleApplyConfiguration constructs a declarative configuration of the ClaimValidationRule type for use with
// apply.
func ClaimValidationRule() *ClaimValidationRuleApplyConfiguration {
	return &ClaimValidationRuleApplyConfiguration{}
}
