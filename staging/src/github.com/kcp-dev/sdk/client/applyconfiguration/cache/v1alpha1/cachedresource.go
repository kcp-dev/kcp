...
// CachedResource constructs a declarative configuration of the CachedResource type for use with
// apply.
...
func (b *CachedResourceApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
