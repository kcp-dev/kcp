...
// CachedObject constructs a declarative configuration of the CachedObject type for use with
// apply.
...
func (b *CachedObjectApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
