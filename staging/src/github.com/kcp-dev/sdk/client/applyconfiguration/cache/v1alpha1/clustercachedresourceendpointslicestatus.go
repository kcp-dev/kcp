...
type ClusterCachedResourceEndpointSliceStatusApplyConfiguration struct {
	...
	ClusterCachedResourceEndpoints []corev1alpha1.EndpointApplyConfiguration `json:"endpoints,omitempty"`
...
func (b *ClusterCachedResourceEndpointSliceStatusApplyConfiguration) WithClusterCachedResourceEndpoints(values ...*corev1alpha1.EndpointApplyConfiguration) *ClusterCachedResourceEndpointSliceStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
