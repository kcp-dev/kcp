...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LogicalClusterOwnerUser) DeepCopyInto(out *LogicalClusterOwnerUser) {
	*out = *in
	if in.Groups != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LogicalClusterOwnerUser.
func (in *LogicalClusterOwnerUser) DeepCopy() *LogicalClusterOwnerUser {
	if in == nil {
		return nil
	}
	out := new(LogicalClusterOwnerUser)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LogicalClusterSpec) DeepCopyInto(out *LogicalClusterSpec) {
	*out = *in
	...
	if in.OwnerUser != nil {
		in, out := &in.OwnerUser, &out.OwnerUser
		*out = new(LogicalClusterOwnerUser)
		(*in).DeepCopyInto(*out)
	}
	return
