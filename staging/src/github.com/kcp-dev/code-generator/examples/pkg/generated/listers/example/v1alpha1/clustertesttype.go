...
type clusterTestTypeLister struct {
	listers.ResourceIndexer[*examplev1alpha1.ClusterTestType]
}
...
func NewClusterTestTypeLister(indexer cache.Indexer) ClusterTestTypeLister {
	return &clusterTestTypeLister{listers.New[*examplev1alpha1.ClusterTestType](indexer, examplev1alpha1.Resource("clustertesttype"))}
}
