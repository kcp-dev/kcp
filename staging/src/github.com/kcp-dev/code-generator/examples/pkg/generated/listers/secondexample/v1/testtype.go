...
func NewTestTypeLister(indexer cache.Indexer) TestTypeLister {
	return &testTypeLister{listers.New[*secondexamplev1.TestType](indexer, secondexamplev1.Resource("testtype"))}
}

// TestTypes returns an object that can list and get TestTypes.
func (s *testTypeLister) TestTypes(namespace string) TestTypeNamespaceLister {
	return testTypeNamespaceLister{listers.NewNamespaced[*secondexamplev1.TestType](s.ResourceIndexer, namespace)}
}
