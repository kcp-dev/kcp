...
type testTypeLister struct {
	listers.ResourceIndexer[*existinginterfacesv1.TestType]
}

// NewTestTypeLister returns a new TestTypeLister.
func NewTestTypeLister(indexer cache.Indexer) TestTypeLister {
	return &testTypeLister{listers.New[*existinginterfacesv1.TestType](indexer, existinginterfacesv1.Resource("testtype"))}
}

// TestTypes returns an object that can list and get TestTypes.
func (s *testTypeLister) TestTypes(namespace string) TestTypeNamespaceLister {
	return testTypeNamespaceLister{listers.NewNamespaced[*existinginterfacesv1.TestType](s.ResourceIndexer, namespace)}
}
