...
type fakeTestTypes struct {
	*gentype.FakeClientWithListAndApply[*v1.TestType, *v1.TestTypeList, *secondexamplev1.TestTypeApplyConfiguration]
	Fake *FakeSecondexampleV1
}

func newFakeTestTypes(fake *FakeSecondexampleV1, namespace string) typedsecondexamplev1.TestTypeInterface {
	return &fakeTestTypes{
		gentype.NewFakeClientWithListAndApply[*v1.TestType, *v1.TestTypeList, *secondexamplev1.TestTypeApplyConfiguration](
			fake.Fake,
			namespace,
