...
import (
	...
	existinginterfacesv1 "acme.corp/pkg/generated/listers/existinginterfaces/v1"
...
func NewTestTypeInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) cache.SharedIndexInformer {
	gvr := schema.GroupVersionResource{Group: "existinginterfaces.acme.corp", Version: "v1", Resource: "testtypes"}
	...
	return cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ExistinginterfacesV1().TestTypes(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ExistinginterfacesV1().TestTypes(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ExistinginterfacesV1().TestTypes(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ExistinginterfacesV1().TestTypes(namespace).Watch(ctx, opts)
			},
		}, client),
...
func (f *testTypeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisexistinginterfacesv1.TestType{}, f.defaultInformer)
}

func (f *testTypeInformer) Lister() existinginterfacesv1.TestTypeLister {
	return existinginterfacesv1.NewTestTypeLister(f.Informer().GetIndexer())
}
