...
type ClusterTestTypeInterface interface {
	...
	Apply(ctx context.Context, clusterTestType *applyconfigurationsexamplev1beta1.ClusterTestTypeApplyConfiguration, opts v1.ApplyOptions) (result *examplev1beta1.ClusterTestType, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, clusterTestType *applyconfigurationsexamplev1beta1.ClusterTestTypeApplyConfiguration, opts v1.ApplyOptions) (result *examplev1beta1.ClusterTestType, err error)
	ClusterTestTypeExpansion
}

// clusterTestTypes implements ClusterTestTypeInterface
type clusterTestTypes struct {
	*gentype.ClientWithListAndApply[*examplev1beta1.ClusterTestType, *examplev1beta1.ClusterTestTypeList, *applyconfigurationsexamplev1beta1.ClusterTestTypeApplyConfiguration]
}
...
func newClusterTestTypes(c *ExampleV1beta1Client) *clusterTestTypes {
	return &clusterTestTypes{
		gentype.NewClientWithListAndApply[*examplev1beta1.ClusterTestType, *examplev1beta1.ClusterTestTypeList, *applyconfigurationsexamplev1beta1.ClusterTestTypeApplyConfiguration](
			"clustertesttypes",
			c.RESTClient(),
