...
type clusterTestTypeLister struct {
	listers.ResourceIndexer[*example3v1.ClusterTestType]
}
...
func NewClusterTestTypeLister(indexer cache.Indexer) ClusterTestTypeLister {
	return &clusterTestTypeLister{listers.New[*example3v1.ClusterTestType](indexer, example3v1.Resource("clustertesttype"))}
}
