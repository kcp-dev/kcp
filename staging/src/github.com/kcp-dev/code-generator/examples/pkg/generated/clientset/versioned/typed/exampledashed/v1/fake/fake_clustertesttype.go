...
type fakeClusterTestTypes struct {
	*gentype.FakeClientWithListAndApply[*v1.ClusterTestType, *v1.ClusterTestTypeList, *exampledashedv1.ClusterTestTypeApplyConfiguration]
	Fake *FakeExampleDashedV1
}

func newFakeClusterTestTypes(fake *FakeExampleDashedV1) typedexampledashedv1.ClusterTestTypeInterface {
	return &fakeClusterTestTypes{
		gentype.NewFakeClientWithListAndApply[*v1.ClusterTestType, *v1.ClusterTestTypeList, *exampledashedv1.ClusterTestTypeApplyConfiguration](
			fake.Fake,
			"",
