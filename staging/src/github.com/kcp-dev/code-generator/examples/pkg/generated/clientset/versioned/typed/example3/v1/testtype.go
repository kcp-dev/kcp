...
type TestTypeInterface interface {
	...
	Update(ctx context.Context, testType *example3v1.TestType, opts metav1.UpdateOptions) (*example3v1.TestType, error)
	Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error
	Get(ctx context.Context, name string, opts metav1.GetOptions) (*example3v1.TestType, error)
	List(ctx context.Context, opts metav1.ListOptions) (*example3v1.TestTypeList, error)
	Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *example3v1.TestType, err error)
	Apply(ctx context.Context, testType *applyconfigurationsexample3v1.TestTypeApplyConfiguration, opts metav1.ApplyOptions) (result *example3v1.TestType, err error)
...
type testTypes struct {
	*gentype.ClientWithListAndApply[*example3v1.TestType, *example3v1.TestTypeList, *applyconfigurationsexample3v1.TestTypeApplyConfiguration]
}

// newTestTypes returns a TestTypes
func newTestTypes(c *Example3V1Client, namespace string) *testTypes {
	return &testTypes{
		gentype.NewClientWithListAndApply[*example3v1.TestType, *example3v1.TestTypeList, *applyconfigurationsexample3v1.TestTypeApplyConfiguration](
			"testtypes",
			c.RESTClient(),
