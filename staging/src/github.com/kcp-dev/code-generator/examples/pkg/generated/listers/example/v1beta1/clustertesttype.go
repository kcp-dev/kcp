...
type clusterTestTypeLister struct {
	listers.ResourceIndexer[*examplev1beta1.ClusterTestType]
}
...
func NewClusterTestTypeLister(indexer cache.Indexer) ClusterTestTypeLister {
	return &clusterTestTypeLister{listers.New[*examplev1beta1.ClusterTestType](indexer, examplev1beta1.Resource("clustertesttype"))}
}
