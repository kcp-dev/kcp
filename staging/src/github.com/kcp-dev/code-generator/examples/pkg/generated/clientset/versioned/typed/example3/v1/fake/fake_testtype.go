...
type fakeTestTypes struct {
	*gentype.FakeClientWithListAndApply[*v1.TestType, *v1.TestTypeList, *example3v1.TestTypeApplyConfiguration]
	Fake *FakeExample3V1
}

func newFakeTestTypes(fake *FakeExample3V1, namespace string) typedexample3v1.TestTypeInterface {
	return &fakeTestTypes{
		gentype.NewFakeClientWithListAndApply[*v1.TestType, *v1.TestTypeList, *example3v1.TestTypeApplyConfiguration](
			fake.Fake,
			namespace,
