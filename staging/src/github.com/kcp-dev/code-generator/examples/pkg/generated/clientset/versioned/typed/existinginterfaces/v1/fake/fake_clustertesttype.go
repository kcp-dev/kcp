...
type fakeClusterTestTypes struct {
	*gentype.FakeClientWithListAndApply[*v1.ClusterTestType, *v1.ClusterTestTypeList, *existinginterfacesv1.ClusterTestTypeApplyConfiguration]
	Fake *FakeExistinginterfacesV1
}

func newFakeClusterTestTypes(fake *FakeExistinginterfacesV1) typedexistinginterfacesv1.ClusterTestTypeInterface {
	return &fakeClusterTestTypes{
		gentype.NewFakeClientWithListAndApply[*v1.ClusterTestType, *v1.ClusterTestTypeList, *existinginterfacesv1.ClusterTestTypeApplyConfiguration](
			fake.Fake,
			"",
