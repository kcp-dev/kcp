...
type TestTypeInterface interface {
	...
	Get(ctx context.Context, name string, opts metav1.GetOptions) (*exampledashedv1.TestType, error)
	List(ctx context.Context, opts metav1.ListOptions) (*exampledashedv1.TestTypeList, error)
	Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *exampledashedv1.TestType, err error)
	Apply(ctx context.Context, testType *applyconfigurationsexampledashedv1.TestTypeApplyConfiguration, opts metav1.ApplyOptions) (result *exampledashedv1.TestType, err error)
...
type testTypes struct {
	*gentype.ClientWithListAndApply[*exampledashedv1.TestType, *exampledashedv1.TestTypeList, *applyconfigurationsexampledashedv1.TestTypeApplyConfiguration]
}

// newTestTypes returns a TestTypes
func newTestTypes(c *ExampleDashedV1Client, namespace string) *testTypes {
	return &testTypes{
		gentype.NewClientWithListAndApply[*exampledashedv1.TestType, *exampledashedv1.TestTypeList, *applyconfigurationsexampledashedv1.TestTypeApplyConfiguration](
			"testtypes",
			c.RESTClient(),
