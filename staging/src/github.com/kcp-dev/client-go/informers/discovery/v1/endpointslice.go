...
import (
	...
	kcpv1 "github.com/kcp-dev/client-go/listers/discovery/v1"
)
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.DiscoveryV1().EndpointSlices().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DiscoveryV1().EndpointSlices().Watch(context.Background(), options)
			},
		},
...
func (i *endpointSliceClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apidiscoveryv1.EndpointSlice{}, i.defaultInformer)
}

func (i *endpointSliceClusterInformer) Lister() kcpv1.EndpointSliceClusterLister {
	return kcpv1.NewEndpointSliceClusterLister(i.Informer().GetIndexer())
}

func (i *endpointSliceClusterInformer) Cluster(clusterName logicalcluster.Name) discoveryv1.EndpointSliceInformer {
...
func (i *endpointSliceClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) discoveryv1.EndpointSliceInformer {
	return &endpointSliceInformer{
...
func (i *endpointSliceInformer) Lister() listersdiscoveryv1.EndpointSliceLister {
	return i.lister
}
