...
import (
	...
	policyv1beta1 "k8s.io/client-go/informers/policy/v1beta1"
	...
	kcpv1beta1 "github.com/kcp-dev/client-go/listers/policy/v1beta1"
)
...
type PodDisruptionBudgetClusterInformer interface {
	Cluster(logicalcluster.Name) policyv1beta1.PodDisruptionBudgetInformer
	ClusterWithContext(context.Context, logicalcluster.Name) policyv1beta1.PodDisruptionBudgetInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1beta1.PodDisruptionBudgetClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PolicyV1beta1().PodDisruptionBudgets().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolicyV1beta1().PodDisruptionBudgets().Watch(context.Background(), options)
			},
		},
...
func (i *podDisruptionBudgetClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apipolicyv1beta1.PodDisruptionBudget{}, i.defaultInformer)
}

func (i *podDisruptionBudgetClusterInformer) Lister() kcpv1beta1.PodDisruptionBudgetClusterLister {
	return kcpv1beta1.NewPodDisruptionBudgetClusterLister(i.Informer().GetIndexer())
}

func (i *podDisruptionBudgetClusterInformer) Cluster(clusterName logicalcluster.Name) policyv1beta1.PodDisruptionBudgetInformer {
...
func (i *podDisruptionBudgetClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) policyv1beta1.PodDisruptionBudgetInformer {
	return &podDisruptionBudgetInformer{
...
func (i *podDisruptionBudgetInformer) Lister() listerspolicyv1beta1.PodDisruptionBudgetLister {
	return i.lister
}
