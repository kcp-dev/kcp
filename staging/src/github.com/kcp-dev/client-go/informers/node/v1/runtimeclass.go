...
import (
	...
	nodev1 "k8s.io/client-go/informers/node/v1"
	...
	kcpv1 "github.com/kcp-dev/client-go/listers/node/v1"
)
...
func (i *runtimeClassClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apinodev1.RuntimeClass{}, i.defaultInformer)
}

func (i *runtimeClassClusterInformer) Lister() kcpv1.RuntimeClassClusterLister {
	return kcpv1.NewRuntimeClassClusterLister(i.Informer().GetIndexer())
}

func (i *runtimeClassClusterInformer) Cluster(clusterName logicalcluster.Name) nodev1.RuntimeClassInformer {
...
func (i *runtimeClassClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) nodev1.RuntimeClassInformer {
	return &runtimeClassInformer{
...
func (i *runtimeClassInformer) Lister() listersnodev1.RuntimeClassLister {
	return i.lister
}
