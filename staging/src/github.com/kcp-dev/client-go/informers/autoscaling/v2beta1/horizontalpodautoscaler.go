...
import (
	...
	kcpv2beta1 "github.com/kcp-dev/client-go/listers/autoscaling/v2beta1"
)
...
type HorizontalPodAutoscalerClusterInformer interface {
	Cluster(logicalcluster.Name) autoscalingv2beta1.HorizontalPodAutoscalerInformer
	ClusterWithContext(context.Context, logicalcluster.Name) autoscalingv2beta1.HorizontalPodAutoscalerInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv2beta1.HorizontalPodAutoscalerClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AutoscalingV2beta1().HorizontalPodAutoscalers().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AutoscalingV2beta1().HorizontalPodAutoscalers().Watch(context.Background(), options)
			},
		},
...
func (i *horizontalPodAutoscalerClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiautoscalingv2beta1.HorizontalPodAutoscaler{}, i.defaultInformer)
}

func (i *horizontalPodAutoscalerClusterInformer) Lister() kcpv2beta1.HorizontalPodAutoscalerClusterLister {
	return kcpv2beta1.NewHorizontalPodAutoscalerClusterLister(i.Informer().GetIndexer())
}

func (i *horizontalPodAutoscalerClusterInformer) Cluster(clusterName logicalcluster.Name) autoscalingv2beta1.HorizontalPodAutoscalerInformer {
...
func (i *horizontalPodAutoscalerClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) autoscalingv2beta1.HorizontalPodAutoscalerInformer {
	return &horizontalPodAutoscalerInformer{
...
func (i *horizontalPodAutoscalerInformer) Lister() listersautoscalingv2beta1.HorizontalPodAutoscalerLister {
	return i.lister
}
