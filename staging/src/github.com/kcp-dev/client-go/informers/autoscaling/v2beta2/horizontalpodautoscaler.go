...
import (
	...
	kcpv2beta2 "github.com/kcp-dev/client-go/listers/autoscaling/v2beta2"
)
...
type HorizontalPodAutoscalerClusterInformer interface {
	Cluster(logicalcluster.Name) autoscalingv2beta2.HorizontalPodAutoscalerInformer
	ClusterWithContext(context.Context, logicalcluster.Name) autoscalingv2beta2.HorizontalPodAutoscalerInformer
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AutoscalingV2beta2().HorizontalPodAutoscalers().List(context.Background(), options)
			},
...
func (i *horizontalPodAutoscalerClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiautoscalingv2beta2.HorizontalPodAutoscaler{}, i.defaultInformer)
}

func (i *horizontalPodAutoscalerClusterInformer) Lister() kcpv2beta2.HorizontalPodAutoscalerClusterLister {
	return kcpv2beta2.NewHorizontalPodAutoscalerClusterLister(i.Informer().GetIndexer())
}

func (i *horizontalPodAutoscalerClusterInformer) Cluster(clusterName logicalcluster.Name) autoscalingv2beta2.HorizontalPodAutoscalerInformer {
...
func (i *horizontalPodAutoscalerClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) autoscalingv2beta2.HorizontalPodAutoscalerInformer {
	return &horizontalPodAutoscalerInformer{
...
func (i *horizontalPodAutoscalerInformer) Lister() listersautoscalingv2beta2.HorizontalPodAutoscalerLister {
	return i.lister
}
