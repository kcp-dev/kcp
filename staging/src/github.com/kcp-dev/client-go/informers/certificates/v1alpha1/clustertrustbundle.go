...
type ClusterTrustBundleClusterInformer interface {
	Cluster(logicalcluster.Name) certificatesv1alpha1.ClusterTrustBundleInformer
	ClusterWithContext(context.Context, logicalcluster.Name) certificatesv1alpha1.ClusterTrustBundleInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1alpha1.ClusterTrustBundleClusterLister
}
...
func (i *clusterTrustBundleClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apicertificatesv1alpha1.ClusterTrustBundle{}, i.defaultInformer)
}

func (i *clusterTrustBundleClusterInformer) Lister() kcpv1alpha1.ClusterTrustBundleClusterLister {
	return kcpv1alpha1.NewClusterTrustBundleClusterLister(i.Informer().GetIndexer())
}

func (i *clusterTrustBundleClusterInformer) Cluster(clusterName logicalcluster.Name) certificatesv1alpha1.ClusterTrustBundleInformer {
...
func (i *clusterTrustBundleClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) certificatesv1alpha1.ClusterTrustBundleInformer {
	return &clusterTrustBundleInformer{
...
type clusterTrustBundleInformer struct {
	...
	lister   listerscertificatesv1alpha1.ClusterTrustBundleLister
}
...
func (i *clusterTrustBundleInformer) Lister() listerscertificatesv1alpha1.ClusterTrustBundleLister {
	return i.lister
}
