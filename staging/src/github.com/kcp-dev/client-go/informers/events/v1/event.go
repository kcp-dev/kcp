...
import (
	...
	kcpv1 "github.com/kcp-dev/client-go/listers/events/v1"
)

// EventClusterInformer provides access to a shared informer and lister for
// Events.
type EventClusterInformer interface {
	Cluster(logicalcluster.Name) eventsv1.EventInformer
	ClusterWithContext(context.Context, logicalcluster.Name) eventsv1.EventInformer
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.EventsV1().Events().List(context.Background(), options)
			},
...
func (i *eventClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apieventsv1.Event{}, i.defaultInformer)
}
...
func (i *eventClusterInformer) Cluster(clusterName logicalcluster.Name) eventsv1.EventInformer {
...
func (i *eventClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) eventsv1.EventInformer {
	return &eventInformer{
...
func (i *eventInformer) Lister() listerseventsv1.EventLister {
	return i.lister
}
