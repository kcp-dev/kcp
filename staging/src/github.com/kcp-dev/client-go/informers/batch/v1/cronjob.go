	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.BatchV1().CronJobs().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BatchV1().CronJobs().Watch(context.Background(), options)
			},
		},
		&apibatchv1.CronJob{},
		resyncPeriod,
...
func (i *cronJobClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apibatchv1.CronJob{}, i.defaultInformer)
}

func (i *cronJobClusterInformer) Lister() kcpv1.CronJobClusterLister {
	return kcpv1.NewCronJobClusterLister(i.Informer().GetIndexer())
}

func (i *cronJobClusterInformer) Cluster(clusterName logicalcluster.Name) batchv1.CronJobInformer {
...
func (i *cronJobClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) batchv1.CronJobInformer {
	return &cronJobInformer{
...
func (i *cronJobInformer) Lister() listersbatchv1.CronJobLister {
	return i.lister
}
