...
func (i *configMapClusterInformer) defaultInformer(client kcpkubernetes.ClusterInterface, resyncPeriod time.Duration) kcpcache.ScopeableSharedIndexInformer {
...
func (i *configMapClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apicorev1.ConfigMap{}, i.defaultInformer)
}

func (i *configMapClusterInformer) Lister() kcpv1.ConfigMapClusterLister {
	return kcpv1.NewConfigMapClusterLister(i.Informer().GetIndexer())
}

func (i *configMapClusterInformer) Cluster(clusterName logicalcluster.Name) corev1.ConfigMapInformer {
...
func (i *configMapClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) corev1.ConfigMapInformer {
	return &configMapInformer{
...
func (i *configMapInformer) Lister() listerscorev1.ConfigMapLister {
	return i.lister
}
