	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1().Secrets().List(context.Background(), options)
			},
...
func (i *secretClusterInformer) defaultInformer(client kcpkubernetes.ClusterInterface, resyncPeriod time.Duration) kcpcache.ScopeableSharedIndexInformer {
...
func (i *secretClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apicorev1.Secret{}, i.defaultInformer)
}

func (i *secretClusterInformer) Lister() kcpv1.SecretClusterLister {
	return kcpv1.NewSecretClusterLister(i.Informer().GetIndexer())
}

func (i *secretClusterInformer) Cluster(clusterName logicalcluster.Name) corev1.SecretInformer {
...
func (i *secretClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) corev1.SecretInformer {
	return &secretInformer{
...
func (i *secretInformer) Lister() listerscorev1.SecretLister {
	return i.lister
}
