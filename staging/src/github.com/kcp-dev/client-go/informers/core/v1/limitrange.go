	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1().LimitRanges().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1().LimitRanges().Watch(context.Background(), options)
			},
		},
...
func (i *limitRangeClusterInformer) defaultInformer(client kcpkubernetes.ClusterInterface, resyncPeriod time.Duration) kcpcache.ScopeableSharedIndexInformer {
...
func (i *limitRangeClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apicorev1.LimitRange{}, i.defaultInformer)
}

func (i *limitRangeClusterInformer) Lister() kcpv1.LimitRangeClusterLister {
	return kcpv1.NewLimitRangeClusterLister(i.Informer().GetIndexer())
}

func (i *limitRangeClusterInformer) Cluster(clusterName logicalcluster.Name) corev1.LimitRangeInformer {
...
func (i *limitRangeClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) corev1.LimitRangeInformer {
	return &limitRangeInformer{
...
func (i *limitRangeInformer) Lister() listerscorev1.LimitRangeLister {
	return i.lister
}
