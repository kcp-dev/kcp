...
type CSIStorageCapacityClusterInformer interface {
	Cluster(logicalcluster.Name) storagev1beta1.CSIStorageCapacityInformer
	ClusterWithContext(context.Context, logicalcluster.Name) storagev1beta1.CSIStorageCapacityInformer
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.StorageV1beta1().CSIStorageCapacities().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StorageV1beta1().CSIStorageCapacities().Watch(context.Background(), options)
			},
		},
...
func (i *cSIStorageCapacityClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apistoragev1beta1.CSIStorageCapacity{}, i.defaultInformer)
}

func (i *cSIStorageCapacityClusterInformer) Lister() kcpv1beta1.CSIStorageCapacityClusterLister {
	return kcpv1beta1.NewCSIStorageCapacityClusterLister(i.Informer().GetIndexer())
}

func (i *cSIStorageCapacityClusterInformer) Cluster(clusterName logicalcluster.Name) storagev1beta1.CSIStorageCapacityInformer {
...
func (i *cSIStorageCapacityClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) storagev1beta1.CSIStorageCapacityInformer {
	return &cSIStorageCapacityInformer{
...
func (i *cSIStorageCapacityInformer) Lister() listersstoragev1beta1.CSIStorageCapacityLister {
	return i.lister
}
