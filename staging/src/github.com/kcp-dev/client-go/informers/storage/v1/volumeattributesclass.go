...
type VolumeAttributesClassClusterInformer interface {
	Cluster(logicalcluster.Name) storagev1.VolumeAttributesClassInformer
	ClusterWithContext(context.Context, logicalcluster.Name) storagev1.VolumeAttributesClassInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1.VolumeAttributesClassClusterLister
}
...
func (i *volumeAttributesClassClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apistoragev1.VolumeAttributesClass{}, i.defaultInformer)
}

func (i *volumeAttributesClassClusterInformer) Lister() kcpv1.VolumeAttributesClassClusterLister {
	return kcpv1.NewVolumeAttributesClassClusterLister(i.Informer().GetIndexer())
}

func (i *volumeAttributesClassClusterInformer) Cluster(clusterName logicalcluster.Name) storagev1.VolumeAttributesClassInformer {
...
func (i *volumeAttributesClassClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) storagev1.VolumeAttributesClassInformer {
	return &volumeAttributesClassInformer{
...
type volumeAttributesClassInformer struct {
	...
	lister   listersstoragev1.VolumeAttributesClassLister
}
...
func (i *volumeAttributesClassInformer) Lister() listersstoragev1.VolumeAttributesClassLister {
	return i.lister
}
