...
type StorageClassClusterInformer interface {
	Cluster(logicalcluster.Name) storagev1.StorageClassInformer
	ClusterWithContext(context.Context, logicalcluster.Name) storagev1.StorageClassInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1.StorageClassClusterLister
}
...
func (i *storageClassClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apistoragev1.StorageClass{}, i.defaultInformer)
}

func (i *storageClassClusterInformer) Lister() kcpv1.StorageClassClusterLister {
	return kcpv1.NewStorageClassClusterLister(i.Informer().GetIndexer())
}

func (i *storageClassClusterInformer) Cluster(clusterName logicalcluster.Name) storagev1.StorageClassInformer {
...
func (i *storageClassClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) storagev1.StorageClassInformer {
	return &storageClassInformer{
...
func (i *storageClassInformer) Lister() listersstoragev1.StorageClassLister {
	return i.lister
}
