...
type CSIDriverClusterInformer interface {
	Cluster(logicalcluster.Name) storagev1.CSIDriverInformer
	ClusterWithContext(context.Context, logicalcluster.Name) storagev1.CSIDriverInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1.CSIDriverClusterLister
}
...
func (i *cSIDriverClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apistoragev1.CSIDriver{}, i.defaultInformer)
}

func (i *cSIDriverClusterInformer) Lister() kcpv1.CSIDriverClusterLister {
	return kcpv1.NewCSIDriverClusterLister(i.Informer().GetIndexer())
}

func (i *cSIDriverClusterInformer) Cluster(clusterName logicalcluster.Name) storagev1.CSIDriverInformer {
...
func (i *cSIDriverClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) storagev1.CSIDriverInformer {
	return &cSIDriverInformer{
...
func (i *cSIDriverInformer) Lister() listersstoragev1.CSIDriverLister {
	return i.lister
}
