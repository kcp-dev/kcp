...
func (i *volumeAttachmentClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apistoragev1alpha1.VolumeAttachment{}, i.defaultInformer)
}

func (i *volumeAttachmentClusterInformer) Lister() kcpv1alpha1.VolumeAttachmentClusterLister {
	return kcpv1alpha1.NewVolumeAttachmentClusterLister(i.Informer().GetIndexer())
}

func (i *volumeAttachmentClusterInformer) Cluster(clusterName logicalcluster.Name) storagev1alpha1.VolumeAttachmentInformer {
...
func (i *volumeAttachmentClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) storagev1alpha1.VolumeAttachmentInformer {
	return &volumeAttachmentInformer{
...
func (i *volumeAttachmentInformer) Lister() listersstoragev1alpha1.VolumeAttachmentLister {
	return i.lister
}
