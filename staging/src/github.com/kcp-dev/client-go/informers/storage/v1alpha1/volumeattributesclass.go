...
func (f *volumeAttributesClassClusterInformer) Lister() storagev1alpha1listers.VolumeAttributesClassClusterLister {
	return storagev1alpha1listers.NewVolumeAttributesClassClusterLister(f.Informer().GetIndexer())
}

func (f *volumeAttributesClassClusterInformer) Cluster(clusterName logicalcluster.Name) upstreamstoragev1alpha1informers.VolumeAttributesClassInformer {
...
type volumeAttributesClassInformer struct {
	...
	lister   upstreamstoragev1alpha1listers.VolumeAttributesClassLister
}
...
func (f *volumeAttributesClassInformer) Lister() upstreamstoragev1alpha1listers.VolumeAttributesClassLister {
	return f.lister
}
