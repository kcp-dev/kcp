...
type PriorityLevelConfigurationClusterInformer interface {
	Cluster(logicalcluster.Name) flowcontrolv1beta2.PriorityLevelConfigurationInformer
	ClusterWithContext(context.Context, logicalcluster.Name) flowcontrolv1beta2.PriorityLevelConfigurationInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1beta2.PriorityLevelConfigurationClusterLister
}
...
func (i *priorityLevelConfigurationClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiflowcontrolv1beta2.PriorityLevelConfiguration{}, i.defaultInformer)
}

func (i *priorityLevelConfigurationClusterInformer) Lister() kcpv1beta2.PriorityLevelConfigurationClusterLister {
	return kcpv1beta2.NewPriorityLevelConfigurationClusterLister(i.Informer().GetIndexer())
}

func (i *priorityLevelConfigurationClusterInformer) Cluster(clusterName logicalcluster.Name) flowcontrolv1beta2.PriorityLevelConfigurationInformer {
...
func (i *priorityLevelConfigurationClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) flowcontrolv1beta2.PriorityLevelConfigurationInformer {
	return &priorityLevelConfigurationInformer{
...
func (i *priorityLevelConfigurationInformer) Lister() listersflowcontrolv1beta2.PriorityLevelConfigurationLister {
	return i.lister
}
