...
func (i *flowSchemaClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiflowcontrolv1beta1.FlowSchema{}, i.defaultInformer)
}

func (i *flowSchemaClusterInformer) Lister() kcpv1beta1.FlowSchemaClusterLister {
	return kcpv1beta1.NewFlowSchemaClusterLister(i.Informer().GetIndexer())
}

func (i *flowSchemaClusterInformer) Cluster(clusterName logicalcluster.Name) flowcontrolv1beta1.FlowSchemaInformer {
...
func (i *flowSchemaClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) flowcontrolv1beta1.FlowSchemaInformer {
	return &flowSchemaInformer{
...
func (i *flowSchemaInformer) Lister() listersflowcontrolv1beta1.FlowSchemaLister {
	return i.lister
}
