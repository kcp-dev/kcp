...
type FlowSchemaClusterInformer interface {
	Cluster(logicalcluster.Name) flowcontrolv1beta3.FlowSchemaInformer
	ClusterWithContext(context.Context, logicalcluster.Name) flowcontrolv1beta3.FlowSchemaInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1beta3.FlowSchemaClusterLister
}
...
func (i *flowSchemaClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiflowcontrolv1beta3.FlowSchema{}, i.defaultInformer)
}

func (i *flowSchemaClusterInformer) Lister() kcpv1beta3.FlowSchemaClusterLister {
	return kcpv1beta3.NewFlowSchemaClusterLister(i.Informer().GetIndexer())
}

func (i *flowSchemaClusterInformer) Cluster(clusterName logicalcluster.Name) flowcontrolv1beta3.FlowSchemaInformer {
...
func (i *flowSchemaClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) flowcontrolv1beta3.FlowSchemaInformer {
	return &flowSchemaInformer{
...
type flowSchemaInformer struct {
	...
	lister   listersflowcontrolv1beta3.FlowSchemaLister
}
...
func (i *flowSchemaInformer) Lister() listersflowcontrolv1beta3.FlowSchemaLister {
	return i.lister
}
