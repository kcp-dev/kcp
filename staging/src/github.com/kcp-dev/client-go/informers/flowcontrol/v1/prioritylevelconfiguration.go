...
func (f *priorityLevelConfigurationClusterInformer) Lister() flowcontrolv1listers.PriorityLevelConfigurationClusterLister {
	return flowcontrolv1listers.NewPriorityLevelConfigurationClusterLister(f.Informer().GetIndexer())
}

func (f *priorityLevelConfigurationClusterInformer) Cluster(clusterName logicalcluster.Name) upstreamflowcontrolv1informers.PriorityLevelConfigurationInformer {
...
type priorityLevelConfigurationInformer struct {
	...
	lister   upstreamflowcontrolv1listers.PriorityLevelConfigurationLister
}
...
func (f *priorityLevelConfigurationInformer) Lister() upstreamflowcontrolv1listers.PriorityLevelConfigurationLister {
	return f.lister
}
