...
type IngressClusterInformer interface {
	Cluster(logicalcluster.Name) extensionsv1beta1.IngressInformer
	ClusterWithContext(context.Context, logicalcluster.Name) extensionsv1beta1.IngressInformer
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ExtensionsV1beta1().Ingresses().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExtensionsV1beta1().Ingresses().Watch(context.Background(), options)
			},
		},
...
func (i *ingressClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiextensionsv1beta1.Ingress{}, i.defaultInformer)
}
...
func (i *ingressClusterInformer) Cluster(clusterName logicalcluster.Name) extensionsv1beta1.IngressInformer {
...
func (i *ingressClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) extensionsv1beta1.IngressInformer {
	return &ingressInformer{
...
func (i *ingressInformer) Lister() listersextensionsv1beta1.IngressLister {
	return i.lister
}
