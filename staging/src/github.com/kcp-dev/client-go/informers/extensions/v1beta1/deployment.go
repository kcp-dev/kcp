...
type DeploymentClusterInformer interface {
	Cluster(logicalcluster.Name) extensionsv1beta1.DeploymentInformer
	ClusterWithContext(context.Context, logicalcluster.Name) extensionsv1beta1.DeploymentInformer
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ExtensionsV1beta1().Deployments().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExtensionsV1beta1().Deployments().Watch(context.Background(), options)
			},
		},
...
func (i *deploymentClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiextensionsv1beta1.Deployment{}, i.defaultInformer)
}

func (i *deploymentClusterInformer) Lister() kcpv1beta1.DeploymentClusterLister {
	return kcpv1beta1.NewDeploymentClusterLister(i.Informer().GetIndexer())
}

func (i *deploymentClusterInformer) Cluster(clusterName logicalcluster.Name) extensionsv1beta1.DeploymentInformer {
...
func (i *deploymentClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) extensionsv1beta1.DeploymentInformer {
	return &deploymentInformer{
...
func (i *deploymentInformer) Lister() listersextensionsv1beta1.DeploymentLister {
	return i.lister
}
