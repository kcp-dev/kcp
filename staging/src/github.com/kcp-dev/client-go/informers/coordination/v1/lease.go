...
import (
	...
	kcpv1 "github.com/kcp-dev/client-go/listers/coordination/v1"
)
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CoordinationV1().Leases().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoordinationV1().Leases().Watch(context.Background(), options)
			},
		},
...
func (i *leaseClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apicoordinationv1.Lease{}, i.defaultInformer)
}

func (i *leaseClusterInformer) Lister() kcpv1.LeaseClusterLister {
	return kcpv1.NewLeaseClusterLister(i.Informer().GetIndexer())
}

func (i *leaseClusterInformer) Cluster(clusterName logicalcluster.Name) coordinationv1.LeaseInformer {
...
func (i *leaseClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) coordinationv1.LeaseInformer {
	return &leaseInformer{
...
func (i *leaseInformer) Lister() listerscoordinationv1.LeaseLister {
	return i.lister
}
