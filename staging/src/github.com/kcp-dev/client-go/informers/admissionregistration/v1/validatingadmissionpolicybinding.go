...
type ValidatingAdmissionPolicyBindingClusterInformer interface {
	...
	Lister() admissionregistrationv1listers.ValidatingAdmissionPolicyBindingClusterLister
}
...
func (f *validatingAdmissionPolicyBindingClusterInformer) Lister() admissionregistrationv1listers.ValidatingAdmissionPolicyBindingClusterLister {
	return admissionregistrationv1listers.NewValidatingAdmissionPolicyBindingClusterLister(f.Informer().GetIndexer())
}

func (f *validatingAdmissionPolicyBindingClusterInformer) Cluster(clusterName logicalcluster.Name) upstreamadmissionregistrationv1informers.ValidatingAdmissionPolicyBindingInformer {
...
func (f *validatingAdmissionPolicyBindingInformer) Lister() upstreamadmissionregistrationv1listers.ValidatingAdmissionPolicyBindingLister {
	return f.lister
}
