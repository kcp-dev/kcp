...
type ValidatingAdmissionPolicyClusterInformer interface {
	Cluster(logicalcluster.Name) admissionregistrationv1alpha1.ValidatingAdmissionPolicyInformer
...
func (i *validatingAdmissionPolicyClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiadmissionregistrationv1alpha1.ValidatingAdmissionPolicy{}, i.defaultInformer)
}

func (i *validatingAdmissionPolicyClusterInformer) Lister() kcpv1alpha1.ValidatingAdmissionPolicyClusterLister {
	return kcpv1alpha1.NewValidatingAdmissionPolicyClusterLister(i.Informer().GetIndexer())
}

func (i *validatingAdmissionPolicyClusterInformer) Cluster(clusterName logicalcluster.Name) admissionregistrationv1alpha1.ValidatingAdmissionPolicyInformer {
...
func (i *validatingAdmissionPolicyClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) admissionregistrationv1alpha1.ValidatingAdmissionPolicyInformer {
	return &validatingAdmissionPolicyInformer{
...
type validatingAdmissionPolicyInformer struct {
	...
	lister   listersadmissionregistrationv1alpha1.ValidatingAdmissionPolicyLister
}
...
func (i *validatingAdmissionPolicyInformer) Lister() listersadmissionregistrationv1alpha1.ValidatingAdmissionPolicyLister {
	return i.lister
}
