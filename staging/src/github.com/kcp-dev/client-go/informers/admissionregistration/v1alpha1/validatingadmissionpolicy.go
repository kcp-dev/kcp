...
type ValidatingAdmissionPolicyClusterInformer interface {
	...
	Lister() admissionregistrationv1alpha1listers.ValidatingAdmissionPolicyClusterLister
}
...
func (f *validatingAdmissionPolicyClusterInformer) Lister() admissionregistrationv1alpha1listers.ValidatingAdmissionPolicyClusterLister {
	return admissionregistrationv1alpha1listers.NewValidatingAdmissionPolicyClusterLister(f.Informer().GetIndexer())
}

func (f *validatingAdmissionPolicyClusterInformer) Cluster(clusterName logicalcluster.Name) upstreamadmissionregistrationv1alpha1informers.ValidatingAdmissionPolicyInformer {
...
type validatingAdmissionPolicyInformer struct {
	...
	lister   upstreamadmissionregistrationv1alpha1listers.ValidatingAdmissionPolicyLister
}
...
func (f *validatingAdmissionPolicyInformer) Lister() upstreamadmissionregistrationv1alpha1listers.ValidatingAdmissionPolicyLister {
	return f.lister
}
