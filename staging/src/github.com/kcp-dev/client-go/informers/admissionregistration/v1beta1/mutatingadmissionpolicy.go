...
type MutatingAdmissionPolicyClusterInformer interface {
	Cluster(logicalcluster.Name) admissionregistrationv1beta1.MutatingAdmissionPolicyInformer
	...
	Lister() kcpv1beta1.MutatingAdmissionPolicyClusterLister
}
...
func (i *mutatingAdmissionPolicyClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiadmissionregistrationv1beta1.MutatingAdmissionPolicy{}, i.defaultInformer)
}

func (i *mutatingAdmissionPolicyClusterInformer) Lister() kcpv1beta1.MutatingAdmissionPolicyClusterLister {
	return kcpv1beta1.NewMutatingAdmissionPolicyClusterLister(i.Informer().GetIndexer())
}

func (i *mutatingAdmissionPolicyClusterInformer) Cluster(clusterName logicalcluster.Name) admissionregistrationv1beta1.MutatingAdmissionPolicyInformer {
...
func (i *mutatingAdmissionPolicyClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) admissionregistrationv1beta1.MutatingAdmissionPolicyInformer {
	return &mutatingAdmissionPolicyInformer{
...
type mutatingAdmissionPolicyInformer struct {
	...
	lister   listersadmissionregistrationv1beta1.MutatingAdmissionPolicyLister
}
...
func (i *mutatingAdmissionPolicyInformer) Lister() listersadmissionregistrationv1beta1.MutatingAdmissionPolicyLister {
	return i.lister
}
