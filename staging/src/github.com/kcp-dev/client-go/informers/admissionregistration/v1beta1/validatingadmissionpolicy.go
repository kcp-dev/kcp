...
type ValidatingAdmissionPolicyClusterInformer interface {
	...
	Lister() admissionregistrationv1beta1listers.ValidatingAdmissionPolicyClusterLister
}
...
func (f *validatingAdmissionPolicyClusterInformer) Lister() admissionregistrationv1beta1listers.ValidatingAdmissionPolicyClusterLister {
	return admissionregistrationv1beta1listers.NewValidatingAdmissionPolicyClusterLister(f.Informer().GetIndexer())
}

func (f *validatingAdmissionPolicyClusterInformer) Cluster(clusterName logicalcluster.Name) upstreamadmissionregistrationv1beta1informers.ValidatingAdmissionPolicyInformer {
...
type validatingAdmissionPolicyInformer struct {
	...
	lister   upstreamadmissionregistrationv1beta1listers.ValidatingAdmissionPolicyLister
}
...
func (f *validatingAdmissionPolicyInformer) Lister() upstreamadmissionregistrationv1beta1listers.ValidatingAdmissionPolicyLister {
	return f.lister
}
