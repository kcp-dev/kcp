...
type ValidatingAdmissionPolicyClusterInformer interface {
	Cluster(logicalcluster.Name) admissionregistrationv1beta1.ValidatingAdmissionPolicyInformer
	ClusterWithContext(context.Context, logicalcluster.Name) admissionregistrationv1beta1.ValidatingAdmissionPolicyInformer
...
func (i *validatingAdmissionPolicyClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiadmissionregistrationv1beta1.ValidatingAdmissionPolicy{}, i.defaultInformer)
}

func (i *validatingAdmissionPolicyClusterInformer) Lister() kcpv1beta1.ValidatingAdmissionPolicyClusterLister {
	return kcpv1beta1.NewValidatingAdmissionPolicyClusterLister(i.Informer().GetIndexer())
}

func (i *validatingAdmissionPolicyClusterInformer) Cluster(clusterName logicalcluster.Name) admissionregistrationv1beta1.ValidatingAdmissionPolicyInformer {
...
func (i *validatingAdmissionPolicyClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) admissionregistrationv1beta1.ValidatingAdmissionPolicyInformer {
	return &validatingAdmissionPolicyInformer{
...
type validatingAdmissionPolicyInformer struct {
	...
	lister   listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyLister
}
...
func (i *validatingAdmissionPolicyInformer) Lister() listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyLister {
	return i.lister
}
