...
type DeploymentClusterInformer interface {
	Cluster(logicalcluster.Name) appsv1beta2.DeploymentInformer
	ClusterWithContext(context.Context, logicalcluster.Name) appsv1beta2.DeploymentInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1beta2.DeploymentClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1beta2().Deployments().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta2().Deployments().Watch(context.Background(), options)
			},
		},
...
func (i *deploymentClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiappsv1beta2.Deployment{}, i.defaultInformer)
}

func (i *deploymentClusterInformer) Lister() kcpv1beta2.DeploymentClusterLister {
	return kcpv1beta2.NewDeploymentClusterLister(i.Informer().GetIndexer())
}

func (i *deploymentClusterInformer) Cluster(clusterName logicalcluster.Name) appsv1beta2.DeploymentInformer {
...
func (i *deploymentClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) appsv1beta2.DeploymentInformer {
	return &deploymentInformer{
...
func (i *deploymentInformer) Lister() listersappsv1beta2.DeploymentLister {
	return i.lister
}
