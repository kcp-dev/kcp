...
type DaemonSetClusterInformer interface {
	Cluster(logicalcluster.Name) appsv1beta2.DaemonSetInformer
	ClusterWithContext(context.Context, logicalcluster.Name) appsv1beta2.DaemonSetInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1beta2.DaemonSetClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1beta2().DaemonSets().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta2().DaemonSets().Watch(context.Background(), options)
			},
		},
...
func (i *daemonSetClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiappsv1beta2.DaemonSet{}, i.defaultInformer)
}

func (i *daemonSetClusterInformer) Lister() kcpv1beta2.DaemonSetClusterLister {
	return kcpv1beta2.NewDaemonSetClusterLister(i.Informer().GetIndexer())
}

func (i *daemonSetClusterInformer) Cluster(clusterName logicalcluster.Name) appsv1beta2.DaemonSetInformer {
...
func (i *daemonSetClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) appsv1beta2.DaemonSetInformer {
	return &daemonSetInformer{
...
func (i *daemonSetInformer) Lister() listersappsv1beta2.DaemonSetLister {
	return i.lister
}
