...
import (
	...
	kcpv1beta1 "github.com/kcp-dev/client-go/listers/apps/v1beta1"
)
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1beta1().ControllerRevisions().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().ControllerRevisions().Watch(context.Background(), options)
			},
		},
...
func (i *controllerRevisionClusterInformer) defaultInformer(client kcpkubernetes.ClusterInterface, resyncPeriod time.Duration) kcpcache.ScopeableSharedIndexInformer {
...
func (i *controllerRevisionClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiappsv1beta1.ControllerRevision{}, i.defaultInformer)
}

func (i *controllerRevisionClusterInformer) Lister() kcpv1beta1.ControllerRevisionClusterLister {
	return kcpv1beta1.NewControllerRevisionClusterLister(i.Informer().GetIndexer())
}

func (i *controllerRevisionClusterInformer) Cluster(clusterName logicalcluster.Name) appsv1beta1.ControllerRevisionInformer {
...
func (i *controllerRevisionClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) appsv1beta1.ControllerRevisionInformer {
	return &controllerRevisionInformer{
...
func (i *controllerRevisionInformer) Lister() listersappsv1beta1.ControllerRevisionLister {
	return i.lister
}
