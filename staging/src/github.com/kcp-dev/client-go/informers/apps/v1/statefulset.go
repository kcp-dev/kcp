	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1().StatefulSets().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1().StatefulSets().Watch(context.Background(), options)
			},
		},
...
func (i *statefulSetClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiappsv1.StatefulSet{}, i.defaultInformer)
}

func (i *statefulSetClusterInformer) Lister() kcpv1.StatefulSetClusterLister {
	return kcpv1.NewStatefulSetClusterLister(i.Informer().GetIndexer())
}

func (i *statefulSetClusterInformer) Cluster(clusterName logicalcluster.Name) appsv1.StatefulSetInformer {
...
func (i *statefulSetClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) appsv1.StatefulSetInformer {
	return &statefulSetInformer{
...
func (i *statefulSetInformer) Lister() listersappsv1.StatefulSetLister {
	return i.lister
}
