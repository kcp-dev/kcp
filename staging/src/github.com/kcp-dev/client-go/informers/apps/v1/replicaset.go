	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1().ReplicaSets().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1().ReplicaSets().Watch(context.Background(), options)
			},
		},
...
func (i *replicaSetClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiappsv1.ReplicaSet{}, i.defaultInformer)
}

func (i *replicaSetClusterInformer) Lister() kcpv1.ReplicaSetClusterLister {
	return kcpv1.NewReplicaSetClusterLister(i.Informer().GetIndexer())
}

func (i *replicaSetClusterInformer) Cluster(clusterName logicalcluster.Name) appsv1.ReplicaSetInformer {
...
func (i *replicaSetClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) appsv1.ReplicaSetInformer {
	return &replicaSetInformer{
...
func (i *replicaSetInformer) Lister() listersappsv1.ReplicaSetLister {
	return i.lister
}
