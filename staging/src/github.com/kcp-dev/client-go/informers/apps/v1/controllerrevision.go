	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1().ControllerRevisions().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1().ControllerRevisions().Watch(context.Background(), options)
			},
		},
...
func (i *controllerRevisionClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiappsv1.ControllerRevision{}, i.defaultInformer)
}

func (i *controllerRevisionClusterInformer) Lister() kcpv1.ControllerRevisionClusterLister {
	return kcpv1.NewControllerRevisionClusterLister(i.Informer().GetIndexer())
}

func (i *controllerRevisionClusterInformer) Cluster(clusterName logicalcluster.Name) appsv1.ControllerRevisionInformer {
...
func (i *controllerRevisionClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) appsv1.ControllerRevisionInformer {
	return &controllerRevisionInformer{
...
func (i *controllerRevisionInformer) Lister() listersappsv1.ControllerRevisionLister {
	return i.lister
}
