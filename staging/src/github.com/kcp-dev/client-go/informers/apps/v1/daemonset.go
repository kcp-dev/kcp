	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1().DaemonSets().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1().DaemonSets().Watch(context.Background(), options)
			},
		},
		&apiappsv1.DaemonSet{},
		resyncPeriod,
...
func (i *daemonSetClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiappsv1.DaemonSet{}, i.defaultInformer)
}

func (i *daemonSetClusterInformer) Lister() kcpv1.DaemonSetClusterLister {
	return kcpv1.NewDaemonSetClusterLister(i.Informer().GetIndexer())
}

func (i *daemonSetClusterInformer) Cluster(clusterName logicalcluster.Name) appsv1.DaemonSetInformer {
...
func (i *daemonSetClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) appsv1.DaemonSetInformer {
	return &daemonSetInformer{
...
func (i *daemonSetInformer) Lister() listersappsv1.DaemonSetLister {
	return i.lister
}
