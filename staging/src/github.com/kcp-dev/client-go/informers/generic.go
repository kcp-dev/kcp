...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericClusterInformer, error) {
	...
	case v1.SchemeGroupVersion.WithResource("mutatingadmissionpolicies"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Admissionregistration().V1().MutatingAdmissionPolicies().Informer()}, nil
	case v1.SchemeGroupVersion.WithResource("mutatingadmissionpolicybindings"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Admissionregistration().V1().MutatingAdmissionPolicyBindings().Informer()}, nil
	...
	case v1beta1.SchemeGroupVersion.WithResource("mutatingadmissionpolicies"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Admissionregistration().V1beta1().MutatingAdmissionPolicies().Informer()}, nil
	case v1beta1.SchemeGroupVersion.WithResource("mutatingadmissionpolicybindings"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Admissionregistration().V1beta1().MutatingAdmissionPolicyBindings().Informer()}, nil
	...
	case certificatesv1beta1.SchemeGroupVersion.WithResource("podcertificaterequests"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Certificates().V1beta1().PodCertificateRequests().Informer()}, nil
	...
	case resourcev1.SchemeGroupVersion.WithResource("deviceclasses"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Resource().V1().DeviceClasses().Informer()}, nil
	case resourcev1.SchemeGroupVersion.WithResource("resourceclaims"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Resource().V1().ResourceClaims().Informer()}, nil
	case resourcev1.SchemeGroupVersion.WithResource("resourceclaimtemplates"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Resource().V1().ResourceClaimTemplates().Informer()}, nil
	case resourcev1.SchemeGroupVersion.WithResource("resourceslices"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Resource().V1().ResourceSlices().Informer()}, nil
	...
	case v1alpha3.SchemeGroupVersion.WithResource("resourcepoolstatusrequests"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Resource().V1alpha3().ResourcePoolStatusRequests().Informer()}, nil
	...
	case resourcev1beta2.SchemeGroupVersion.WithResource("devicetaintrules"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Resource().V1beta2().DeviceTaintRules().Informer()}, nil
	...
	case schedulingv1alpha2.SchemeGroupVersion.WithResource("podgroups"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Scheduling().V1alpha2().PodGroups().Informer()}, nil
	case schedulingv1alpha2.SchemeGroupVersion.WithResource("workloads"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Scheduling().V1alpha2().Workloads().Informer()}, nil
	...
	case storagev1.SchemeGroupVersion.WithResource("volumeattributesclasses"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Storage().V1().VolumeAttributesClasses().Informer()}, nil
	...
	case storagemigrationv1beta1.SchemeGroupVersion.WithResource("storageversionmigrations"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Storagemigration().V1beta1().StorageVersionMigrations().Informer()}, nil
