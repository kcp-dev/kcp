...
import (
	...
	schedulingv1 "k8s.io/client-go/informers/scheduling/v1"
	...
	kcpv1 "github.com/kcp-dev/client-go/listers/scheduling/v1"
)
...
type PriorityClassClusterInformer interface {
	Cluster(logicalcluster.Name) schedulingv1.PriorityClassInformer
	ClusterWithContext(context.Context, logicalcluster.Name) schedulingv1.PriorityClassInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1.PriorityClassClusterLister
}
...
func (i *priorityClassClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apischedulingv1.PriorityClass{}, i.defaultInformer)
}

func (i *priorityClassClusterInformer) Lister() kcpv1.PriorityClassClusterLister {
	return kcpv1.NewPriorityClassClusterLister(i.Informer().GetIndexer())
}

func (i *priorityClassClusterInformer) Cluster(clusterName logicalcluster.Name) schedulingv1.PriorityClassInformer {
...
func (i *priorityClassClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) schedulingv1.PriorityClassInformer {
	return &priorityClassInformer{
...
func (i *priorityClassInformer) Lister() listersschedulingv1.PriorityClassLister {
	return i.lister
}
