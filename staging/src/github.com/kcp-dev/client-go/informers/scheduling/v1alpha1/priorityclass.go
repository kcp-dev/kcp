...
func (i *priorityClassClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apischedulingv1alpha1.PriorityClass{}, i.defaultInformer)
}

func (i *priorityClassClusterInformer) Lister() kcpv1alpha1.PriorityClassClusterLister {
	return kcpv1alpha1.NewPriorityClassClusterLister(i.Informer().GetIndexer())
}

func (i *priorityClassClusterInformer) Cluster(clusterName logicalcluster.Name) schedulingv1alpha1.PriorityClassInformer {
...
func (i *priorityClassClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) schedulingv1alpha1.PriorityClassInformer {
	return &priorityClassInformer{
...
func (i *priorityClassInformer) Lister() listersschedulingv1alpha1.PriorityClassLister {
	return i.lister
}
