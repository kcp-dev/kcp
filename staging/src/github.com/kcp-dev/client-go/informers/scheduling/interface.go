...
import (
	...
	"github.com/kcp-dev/client-go/informers/scheduling/v1"
	"github.com/kcp-dev/client-go/informers/scheduling/v1alpha1"
	"github.com/kcp-dev/client-go/informers/scheduling/v1beta1"
)
