...
type ClusterRoleClusterInformer interface {
	Cluster(logicalcluster.Name) rbacv1beta1.ClusterRoleInformer
	ClusterWithContext(context.Context, logicalcluster.Name) rbacv1beta1.ClusterRoleInformer
...
func (i *clusterRoleClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apirbacv1beta1.ClusterRole{}, i.defaultInformer)
}

func (i *clusterRoleClusterInformer) Lister() kcpv1beta1.ClusterRoleClusterLister {
	return kcpv1beta1.NewClusterRoleClusterLister(i.Informer().GetIndexer())
}

func (i *clusterRoleClusterInformer) Cluster(clusterName logicalcluster.Name) rbacv1beta1.ClusterRoleInformer {
...
func (i *clusterRoleClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) rbacv1beta1.ClusterRoleInformer {
	return &clusterRoleInformer{
...
func (i *clusterRoleInformer) Lister() listersrbacv1beta1.ClusterRoleLister {
	return i.lister
}
