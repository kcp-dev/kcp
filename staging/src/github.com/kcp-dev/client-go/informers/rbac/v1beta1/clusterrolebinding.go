...
type ClusterRoleBindingClusterInformer interface {
	Cluster(logicalcluster.Name) rbacv1beta1.ClusterRoleBindingInformer
	ClusterWithContext(context.Context, logicalcluster.Name) rbacv1beta1.ClusterRoleBindingInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1beta1.ClusterRoleBindingClusterLister
}
...
func (i *clusterRoleBindingClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apirbacv1beta1.ClusterRoleBinding{}, i.defaultInformer)
}

func (i *clusterRoleBindingClusterInformer) Lister() kcpv1beta1.ClusterRoleBindingClusterLister {
	return kcpv1beta1.NewClusterRoleBindingClusterLister(i.Informer().GetIndexer())
}

func (i *clusterRoleBindingClusterInformer) Cluster(clusterName logicalcluster.Name) rbacv1beta1.ClusterRoleBindingInformer {
...
func (i *clusterRoleBindingClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) rbacv1beta1.ClusterRoleBindingInformer {
	return &clusterRoleBindingInformer{
...
func (i *clusterRoleBindingInformer) Lister() listersrbacv1beta1.ClusterRoleBindingLister {
	return i.lister
}
