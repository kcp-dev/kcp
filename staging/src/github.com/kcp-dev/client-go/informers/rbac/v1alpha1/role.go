...
type RoleClusterInformer interface {
	Cluster(logicalcluster.Name) rbacv1alpha1.RoleInformer
	ClusterWithContext(context.Context, logicalcluster.Name) rbacv1alpha1.RoleInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1alpha1.RoleClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RbacV1alpha1().Roles().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RbacV1alpha1().Roles().Watch(context.Background(), options)
			},
		},
...
func (i *roleClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apirbacv1alpha1.Role{}, i.defaultInformer)
}

func (i *roleClusterInformer) Lister() kcpv1alpha1.RoleClusterLister {
	return kcpv1alpha1.NewRoleClusterLister(i.Informer().GetIndexer())
}

func (i *roleClusterInformer) Cluster(clusterName logicalcluster.Name) rbacv1alpha1.RoleInformer {
	return &roleInformer{
...
func (i *roleClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) rbacv1alpha1.RoleInformer {
	return &roleInformer{
...
func (i *roleInformer) Lister() listersrbacv1alpha1.RoleLister {
	return i.lister
}
