	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.RbacV1().RoleBindings().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RbacV1().RoleBindings().Watch(context.Background(), options)
			},
		},
...
func (i *roleBindingClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apirbacv1.RoleBinding{}, i.defaultInformer)
}

func (i *roleBindingClusterInformer) Lister() kcpv1.RoleBindingClusterLister {
	return kcpv1.NewRoleBindingClusterLister(i.Informer().GetIndexer())
}

func (i *roleBindingClusterInformer) Cluster(clusterName logicalcluster.Name) rbacv1.RoleBindingInformer {
...
func (i *roleBindingClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) rbacv1.RoleBindingInformer {
	return &roleBindingInformer{
...
func (i *roleBindingInformer) Lister() listersrbacv1.RoleBindingLister {
	return i.lister
}
