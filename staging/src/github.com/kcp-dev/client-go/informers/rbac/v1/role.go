	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.RbacV1().Roles().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RbacV1().Roles().Watch(context.Background(), options)
			},
		},
		&apirbacv1.Role{},
		resyncPeriod,
...
func (i *roleClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apirbacv1.Role{}, i.defaultInformer)
}

func (i *roleClusterInformer) Lister() kcpv1.RoleClusterLister {
	return kcpv1.NewRoleClusterLister(i.Informer().GetIndexer())
}

func (i *roleClusterInformer) Cluster(clusterName logicalcluster.Name) rbacv1.RoleInformer {
	return &roleInformer{
...
func (i *roleClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) rbacv1.RoleInformer {
	return &roleInformer{
...
func (i *roleInformer) Lister() listersrbacv1.RoleLister {
	return i.lister
}
