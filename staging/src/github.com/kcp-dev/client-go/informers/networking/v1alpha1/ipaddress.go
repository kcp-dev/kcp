...
type IPAddressClusterInformer interface {
	Cluster(logicalcluster.Name) networkingv1alpha1.IPAddressInformer
	ClusterWithContext(context.Context, logicalcluster.Name) networkingv1alpha1.IPAddressInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1alpha1.IPAddressClusterLister
}
...
func (i *iPAddressClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apinetworkingv1alpha1.IPAddress{}, i.defaultInformer)
}

func (i *iPAddressClusterInformer) Lister() kcpv1alpha1.IPAddressClusterLister {
	return kcpv1alpha1.NewIPAddressClusterLister(i.Informer().GetIndexer())
}

func (i *iPAddressClusterInformer) Cluster(clusterName logicalcluster.Name) networkingv1alpha1.IPAddressInformer {
...
func (i *iPAddressClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) networkingv1alpha1.IPAddressInformer {
	return &iPAddressInformer{
...
type iPAddressInformer struct {
	...
	lister   listersnetworkingv1alpha1.IPAddressLister
}
...
func (i *iPAddressInformer) Lister() listersnetworkingv1alpha1.IPAddressLister {
	return i.lister
}
