...
type ResourceClaimTemplateClusterInformer interface {
	Cluster(logicalcluster.Name) resourcev1alpha3.ResourceClaimTemplateInformer
	ClusterWithContext(context.Context, logicalcluster.Name) resourcev1alpha3.ResourceClaimTemplateInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1alpha3.ResourceClaimTemplateClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ResourceV1alpha3().ResourceClaimTemplates().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ResourceV1alpha3().ResourceClaimTemplates().Watch(context.Background(), options)
			},
		},
...
func (i *resourceClaimTemplateClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiresourcev1alpha3.ResourceClaimTemplate{}, i.defaultInformer)
}

func (i *resourceClaimTemplateClusterInformer) Lister() kcpv1alpha3.ResourceClaimTemplateClusterLister {
	return kcpv1alpha3.NewResourceClaimTemplateClusterLister(i.Informer().GetIndexer())
}

func (i *resourceClaimTemplateClusterInformer) Cluster(clusterName logicalcluster.Name) resourcev1alpha3.ResourceClaimTemplateInformer {
...
func (i *resourceClaimTemplateClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) resourcev1alpha3.ResourceClaimTemplateInformer {
	return &resourceClaimTemplateInformer{
...
func (i *resourceClaimTemplateInformer) Lister() listersresourcev1alpha3.ResourceClaimTemplateLister {
	return i.lister
}
