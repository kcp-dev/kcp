...
type DeviceClassClusterInformer interface {
	Cluster(logicalcluster.Name) upstreamresourcev1beta1informers.DeviceClassInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() resourcev1beta1listers.DeviceClassClusterLister
}
...
func (f *deviceClassClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return f.factory.InformerFor(&resourcev1beta1.DeviceClass{}, f.defaultInformer)
}

func (f *deviceClassClusterInformer) Lister() resourcev1beta1listers.DeviceClassClusterLister {
	return resourcev1beta1listers.NewDeviceClassClusterLister(f.Informer().GetIndexer())
}

func (f *deviceClassClusterInformer) Cluster(clusterName logicalcluster.Name) upstreamresourcev1beta1informers.DeviceClassInformer {
...
type deviceClassInformer struct {
	...
	lister   upstreamresourcev1beta1listers.DeviceClassLister
}
...
func (f *deviceClassInformer) Lister() upstreamresourcev1beta1listers.DeviceClassLister {
	return f.lister
}
