...
type DeviceClassClusterInformer interface {
	Cluster(logicalcluster.Name) resourcev1beta1.DeviceClassInformer
	ClusterWithContext(context.Context, logicalcluster.Name) resourcev1beta1.DeviceClassInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1beta1.DeviceClassClusterLister
}
...
func (i *deviceClassClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiresourcev1beta1.DeviceClass{}, i.defaultInformer)
}

func (i *deviceClassClusterInformer) Lister() kcpv1beta1.DeviceClassClusterLister {
	return kcpv1beta1.NewDeviceClassClusterLister(i.Informer().GetIndexer())
}

func (i *deviceClassClusterInformer) Cluster(clusterName logicalcluster.Name) resourcev1beta1.DeviceClassInformer {
...
func (i *deviceClassClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) resourcev1beta1.DeviceClassInformer {
	return &deviceClassInformer{
...
type deviceClassInformer struct {
	...
	lister   listersresourcev1beta1.DeviceClassLister
}
...
func (i *deviceClassInformer) Lister() listersresourcev1beta1.DeviceClassLister {
	return i.lister
}
