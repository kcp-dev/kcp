...
type ResourceClaimTemplateClusterInformer interface {
	Cluster(logicalcluster.Name) upstreamresourcev1beta1informers.ResourceClaimTemplateInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() resourcev1beta1listers.ResourceClaimTemplateClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ResourceV1beta1().ResourceClaimTemplates().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ResourceV1beta1().ResourceClaimTemplates().Watch(context.TODO(), options)
			},
		},
...
func (f *resourceClaimTemplateClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return f.factory.InformerFor(&resourcev1beta1.ResourceClaimTemplate{}, f.defaultInformer)
}

func (f *resourceClaimTemplateClusterInformer) Lister() resourcev1beta1listers.ResourceClaimTemplateClusterLister {
	return resourcev1beta1listers.NewResourceClaimTemplateClusterLister(f.Informer().GetIndexer())
}

func (f *resourceClaimTemplateClusterInformer) Cluster(clusterName logicalcluster.Name) upstreamresourcev1beta1informers.ResourceClaimTemplateInformer {
...
type resourceClaimTemplateInformer struct {
	...
	lister   upstreamresourcev1beta1listers.ResourceClaimTemplateLister
}
...
func (f *resourceClaimTemplateInformer) Lister() upstreamresourcev1beta1listers.ResourceClaimTemplateLister {
	return f.lister
}
