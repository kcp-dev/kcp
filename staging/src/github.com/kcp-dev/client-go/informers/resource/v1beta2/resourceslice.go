...
type ResourceSliceClusterInformer interface {
	Cluster(logicalcluster.Name) resourcev1beta2.ResourceSliceInformer
	ClusterWithContext(context.Context, logicalcluster.Name) resourcev1beta2.ResourceSliceInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1beta2.ResourceSliceClusterLister
}
...
func (i *resourceSliceClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiresourcev1beta2.ResourceSlice{}, i.defaultInformer)
}

func (i *resourceSliceClusterInformer) Lister() kcpv1beta2.ResourceSliceClusterLister {
	return kcpv1beta2.NewResourceSliceClusterLister(i.Informer().GetIndexer())
}

func (i *resourceSliceClusterInformer) Cluster(clusterName logicalcluster.Name) resourcev1beta2.ResourceSliceInformer {
...
func (i *resourceSliceClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) resourcev1beta2.ResourceSliceInformer {
	return &resourceSliceInformer{
...
type resourceSliceInformer struct {
	...
	lister   listersresourcev1beta2.ResourceSliceLister
}
...
func (i *resourceSliceInformer) Lister() listersresourcev1beta2.ResourceSliceLister {
	return i.lister
}
