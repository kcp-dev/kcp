...
type ResourceClaimClusterInformer interface {
	Cluster(logicalcluster.Name) resourcev1beta2.ResourceClaimInformer
	ClusterWithContext(context.Context, logicalcluster.Name) resourcev1beta2.ResourceClaimInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1beta2.ResourceClaimClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ResourceV1beta2().ResourceClaims().List(context.Background(), options)
			},
...
func (i *resourceClaimClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiresourcev1beta2.ResourceClaim{}, i.defaultInformer)
}

func (i *resourceClaimClusterInformer) Lister() kcpv1beta2.ResourceClaimClusterLister {
	return kcpv1beta2.NewResourceClaimClusterLister(i.Informer().GetIndexer())
}

func (i *resourceClaimClusterInformer) Cluster(clusterName logicalcluster.Name) resourcev1beta2.ResourceClaimInformer {
...
func (i *resourceClaimClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) resourcev1beta2.ResourceClaimInformer {
	return &resourceClaimInformer{
...
type resourceClaimInformer struct {
	...
	lister   listersresourcev1beta2.ResourceClaimLister
}
...
func (i *resourceClaimInformer) Lister() listersresourcev1beta2.ResourceClaimLister {
	return i.lister
}
