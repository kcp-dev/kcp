...
type DeviceClassClusterInformer interface {
	Cluster(logicalcluster.Name) resourcev1beta2.DeviceClassInformer
	ClusterWithContext(context.Context, logicalcluster.Name) resourcev1beta2.DeviceClassInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1beta2.DeviceClassClusterLister
}
...
func (i *deviceClassClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiresourcev1beta2.DeviceClass{}, i.defaultInformer)
}

func (i *deviceClassClusterInformer) Lister() kcpv1beta2.DeviceClassClusterLister {
	return kcpv1beta2.NewDeviceClassClusterLister(i.Informer().GetIndexer())
}

func (i *deviceClassClusterInformer) Cluster(clusterName logicalcluster.Name) resourcev1beta2.DeviceClassInformer {
...
func (i *deviceClassClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) resourcev1beta2.DeviceClassInformer {
	return &deviceClassInformer{
...
type deviceClassInformer struct {
	...
	lister   listersresourcev1beta2.DeviceClassLister
}
...
func (i *deviceClassInformer) Lister() listersresourcev1beta2.DeviceClassLister {
	return i.lister
}
