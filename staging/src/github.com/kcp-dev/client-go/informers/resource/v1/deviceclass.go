...
type DeviceClassClusterInformer interface {
	Cluster(logicalcluster.Name) resourcev1.DeviceClassInformer
	ClusterWithContext(context.Context, logicalcluster.Name) resourcev1.DeviceClassInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() kcpv1.DeviceClassClusterLister
}
...
func (i *deviceClassClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return i.factory.InformerFor(&apiresourcev1.DeviceClass{}, i.defaultInformer)
}

func (i *deviceClassClusterInformer) Lister() kcpv1.DeviceClassClusterLister {
	return kcpv1.NewDeviceClassClusterLister(i.Informer().GetIndexer())
}

func (i *deviceClassClusterInformer) Cluster(clusterName logicalcluster.Name) resourcev1.DeviceClassInformer {
...
func (i *deviceClassClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) resourcev1.DeviceClassInformer {
	return &deviceClassInformer{
...
type deviceClassInformer struct {
	...
	lister   listersresourcev1.DeviceClassLister
}
...
func (i *deviceClassInformer) Lister() listersresourcev1.DeviceClassLister {
	return i.lister
}
