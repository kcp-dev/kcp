...
type RuntimeClassClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersnodev1alpha1.RuntimeClassLister
...
type runtimeClassClusterLister struct {
	kcplisters.ResourceClusterIndexer[*nodev1alpha1.RuntimeClass]
}
...
func NewRuntimeClassClusterLister(indexer cache.Indexer) RuntimeClassClusterLister {
	return &runtimeClassClusterLister{
		kcplisters.NewCluster[*nodev1alpha1.RuntimeClass](indexer, nodev1alpha1.Resource("runtimeclass")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get RuntimeClasses.
func (l *runtimeClassClusterLister) Cluster(clusterName logicalcluster.Name) listersnodev1alpha1.RuntimeClassLister {
...
// or scope down to a listersnodev1alpha1.RuntimeClassNamespaceLister for one namespace.
type runtimeClassLister struct {
	kcplisters.ResourceIndexer[*nodev1alpha1.RuntimeClass]
}

var _ listersnodev1alpha1.RuntimeClassLister = new(runtimeClassLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewRuntimeClassLister(indexer cache.Indexer) listersnodev1alpha1.RuntimeClassLister {
	return &runtimeClassLister{
		kcplisters.New[*nodev1alpha1.RuntimeClass](indexer, nodev1alpha1.Resource("runtimeclass")),
	}
}

// runtimeClassScopedLister can list all RuntimeClasses inside a workspace
// or scope down to a listersnodev1alpha1.RuntimeClassNamespaceLister.
