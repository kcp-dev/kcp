...
type CSIStorageCapacityClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersstoragev1alpha1.CSIStorageCapacityLister
...
type cSIStorageCapacityClusterLister struct {
	kcplisters.ResourceClusterIndexer[*storagev1alpha1.CSIStorageCapacity]
}
...
func NewCSIStorageCapacityClusterLister(indexer cache.Indexer) CSIStorageCapacityClusterLister {
	return &cSIStorageCapacityClusterLister{
		kcplisters.NewCluster[*storagev1alpha1.CSIStorageCapacity](indexer, storagev1alpha1.Resource("csistoragecapacity")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get CSIStorageCapacities.
func (l *cSIStorageCapacityClusterLister) Cluster(clusterName logicalcluster.Name) listersstoragev1alpha1.CSIStorageCapacityLister {
...
// or scope down to a listersstoragev1alpha1.CSIStorageCapacityNamespaceLister for one namespace.
type cSIStorageCapacityLister struct {
	kcplisters.ResourceIndexer[*storagev1alpha1.CSIStorageCapacity]
}

var _ listersstoragev1alpha1.CSIStorageCapacityLister = new(cSIStorageCapacityLister)

// CSIStorageCapacities returns an object that can list and get CSIStorageCapacities in one namespace.
func (l *cSIStorageCapacityLister) CSIStorageCapacities(namespace string) listersstoragev1alpha1.CSIStorageCapacityNamespaceLister {
	return &cSIStorageCapacityNamespaceLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}

// cSIStorageCapacityNamespaceLister implements the listersstoragev1alpha1.CSIStorageCapacityNamespaceLister
// interface.
type cSIStorageCapacityNamespaceLister struct {
	kcplisters.ResourceIndexer[*storagev1alpha1.CSIStorageCapacity]
}

var _ listersstoragev1alpha1.CSIStorageCapacityNamespaceLister = new(cSIStorageCapacityNamespaceLister)
...
// - has the kcpcache.ClusterIndex as an index
// - has the kcpcache.ClusterAndNamespaceIndex as an index
func NewCSIStorageCapacityLister(indexer cache.Indexer) listersstoragev1alpha1.CSIStorageCapacityLister {
	return &cSIStorageCapacityLister{
		kcplisters.New[*storagev1alpha1.CSIStorageCapacity](indexer, storagev1alpha1.Resource("csistoragecapacity")),
	}
}
...
// CSIStorageCapacities returns an object that can list and get CSIStorageCapacities in one namespace.
func (l *cSIStorageCapacityScopedLister) CSIStorageCapacities(namespace string) listersstoragev1alpha1.CSIStorageCapacityLister {
	return &cSIStorageCapacityLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}
