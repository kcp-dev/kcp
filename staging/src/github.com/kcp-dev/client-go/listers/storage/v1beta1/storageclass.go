...
type StorageClassClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersstoragev1beta1.StorageClassLister
...
type storageClassClusterLister struct {
	kcplisters.ResourceClusterIndexer[*storagev1beta1.StorageClass]
}
...
func NewStorageClassClusterLister(indexer cache.Indexer) StorageClassClusterLister {
	return &storageClassClusterLister{
		kcplisters.NewCluster[*storagev1beta1.StorageClass](indexer, storagev1beta1.Resource("storageclass")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get StorageClasses.
func (l *storageClassClusterLister) Cluster(clusterName logicalcluster.Name) listersstoragev1beta1.StorageClassLister {
...
// or scope down to a listersstoragev1beta1.StorageClassNamespaceLister for one namespace.
type storageClassLister struct {
	kcplisters.ResourceIndexer[*storagev1beta1.StorageClass]
}

var _ listersstoragev1beta1.StorageClassLister = new(storageClassLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewStorageClassLister(indexer cache.Indexer) listersstoragev1beta1.StorageClassLister {
	return &storageClassLister{
		kcplisters.New[*storagev1beta1.StorageClass](indexer, storagev1beta1.Resource("storageclass")),
	}
}

// storageClassScopedLister can list all StorageClasses inside a workspace
// or scope down to a listersstoragev1beta1.StorageClassNamespaceLister.
