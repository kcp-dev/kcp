...
type VolumeAttributesClassClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersstoragev1.VolumeAttributesClassLister
...
type volumeAttributesClassClusterLister struct {
	kcplisters.ResourceClusterIndexer[*storagev1.VolumeAttributesClass]
}
...
func NewVolumeAttributesClassClusterLister(indexer cache.Indexer) VolumeAttributesClassClusterLister {
	return &volumeAttributesClassClusterLister{
		kcplisters.NewCluster[*storagev1.VolumeAttributesClass](indexer, storagev1.Resource("volumeattributesclass")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get VolumeAttributesClasses.
func (l *volumeAttributesClassClusterLister) Cluster(clusterName logicalcluster.Name) listersstoragev1.VolumeAttributesClassLister {
...
// or scope down to a listersstoragev1.VolumeAttributesClassNamespaceLister for one namespace.
type volumeAttributesClassLister struct {
	kcplisters.ResourceIndexer[*storagev1.VolumeAttributesClass]
}

var _ listersstoragev1.VolumeAttributesClassLister = new(volumeAttributesClassLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewVolumeAttributesClassLister(indexer cache.Indexer) listersstoragev1.VolumeAttributesClassLister {
	return &volumeAttributesClassLister{
		kcplisters.New[*storagev1.VolumeAttributesClass](indexer, storagev1.Resource("volumeattributesclass")),
	}
}

// volumeAttributesClassScopedLister can list all VolumeAttributesClasses inside a workspace
// or scope down to a listersstoragev1.VolumeAttributesClassNamespaceLister.
