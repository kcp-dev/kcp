...
type VolumeAttachmentClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersstoragev1.VolumeAttachmentLister
...
type volumeAttachmentClusterLister struct {
	kcplisters.ResourceClusterIndexer[*storagev1.VolumeAttachment]
}
...
func NewVolumeAttachmentClusterLister(indexer cache.Indexer) VolumeAttachmentClusterLister {
	return &volumeAttachmentClusterLister{
		kcplisters.NewCluster[*storagev1.VolumeAttachment](indexer, storagev1.Resource("volumeattachment")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get VolumeAttachments.
func (l *volumeAttachmentClusterLister) Cluster(clusterName logicalcluster.Name) listersstoragev1.VolumeAttachmentLister {
...
// or scope down to a listersstoragev1.VolumeAttachmentNamespaceLister for one namespace.
type volumeAttachmentLister struct {
	kcplisters.ResourceIndexer[*storagev1.VolumeAttachment]
}

var _ listersstoragev1.VolumeAttachmentLister = new(volumeAttachmentLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewVolumeAttachmentLister(indexer cache.Indexer) listersstoragev1.VolumeAttachmentLister {
	return &volumeAttachmentLister{
		kcplisters.New[*storagev1.VolumeAttachment](indexer, storagev1.Resource("volumeattachment")),
	}
}

// volumeAttachmentScopedLister can list all VolumeAttachments inside a workspace
// or scope down to a listersstoragev1.VolumeAttachmentNamespaceLister.
