...
func NewCSIStorageCapacityLister(indexer cache.Indexer) listersstoragev1.CSIStorageCapacityLister {
	return &cSIStorageCapacityLister{
		kcplisters.New[*storagev1.CSIStorageCapacity](indexer, storagev1.Resource("csistoragecapacity")),
	}
}
...
// CSIStorageCapacities returns an object that can list and get CSIStorageCapacities in one namespace.
func (l *cSIStorageCapacityScopedLister) CSIStorageCapacities(namespace string) listersstoragev1.CSIStorageCapacityLister {
	return &cSIStorageCapacityLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}
