...
type DeploymentClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersappsv1beta2.DeploymentLister
...
type deploymentClusterLister struct {
	kcplisters.ResourceClusterIndexer[*appsv1beta2.Deployment]
}
...
func NewDeploymentClusterLister(indexer cache.Indexer) DeploymentClusterLister {
	return &deploymentClusterLister{
		kcplisters.NewCluster[*appsv1beta2.Deployment](indexer, appsv1beta2.Resource("deployment")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get Deployments.
func (l *deploymentClusterLister) Cluster(clusterName logicalcluster.Name) listersappsv1beta2.DeploymentLister {
...
// or scope down to a listersappsv1beta2.DeploymentNamespaceLister for one namespace.
type deploymentLister struct {
	kcplisters.ResourceIndexer[*appsv1beta2.Deployment]
}

var _ listersappsv1beta2.DeploymentLister = new(deploymentLister)

// Deployments returns an object that can list and get Deployments in one namespace.
func (l *deploymentLister) Deployments(namespace string) listersappsv1beta2.DeploymentNamespaceLister {
	return &deploymentNamespaceLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}

// deploymentNamespaceLister implements the listersappsv1beta2.DeploymentNamespaceLister
// interface.
type deploymentNamespaceLister struct {
	kcplisters.ResourceIndexer[*appsv1beta2.Deployment]
}

var _ listersappsv1beta2.DeploymentNamespaceLister = new(deploymentNamespaceLister)
...
// - has the kcpcache.ClusterIndex as an index
// - has the kcpcache.ClusterAndNamespaceIndex as an index
func NewDeploymentLister(indexer cache.Indexer) listersappsv1beta2.DeploymentLister {
	return &deploymentLister{
		kcplisters.New[*appsv1beta2.Deployment](indexer, appsv1beta2.Resource("deployment")),
	}
}
...
// Deployments returns an object that can list and get Deployments in one namespace.
func (l *deploymentScopedLister) Deployments(namespace string) listersappsv1beta2.DeploymentLister {
	return &deploymentLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}
