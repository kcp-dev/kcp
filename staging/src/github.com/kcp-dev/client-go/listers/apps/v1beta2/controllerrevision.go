...
type ControllerRevisionClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersappsv1beta2.ControllerRevisionLister
...
type controllerRevisionClusterLister struct {
	kcplisters.ResourceClusterIndexer[*appsv1beta2.ControllerRevision]
}
...
func (l *controllerRevisionClusterLister) Cluster(clusterName logicalcluster.Name) listersappsv1beta2.ControllerRevisionLister {
...
// or scope down to a listersappsv1beta2.ControllerRevisionNamespaceLister for one namespace.
type controllerRevisionLister struct {
	kcplisters.ResourceIndexer[*appsv1beta2.ControllerRevision]
}

var _ listersappsv1beta2.ControllerRevisionLister = new(controllerRevisionLister)

// ControllerRevisions returns an object that can list and get ControllerRevisions in one namespace.
func (l *controllerRevisionLister) ControllerRevisions(namespace string) listersappsv1beta2.ControllerRevisionNamespaceLister {
	return &controllerRevisionNamespaceLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}

// controllerRevisionNamespaceLister implements the listersappsv1beta2.ControllerRevisionNamespaceLister
// interface.
type controllerRevisionNamespaceLister struct {
	kcplisters.ResourceIndexer[*appsv1beta2.ControllerRevision]
}

var _ listersappsv1beta2.ControllerRevisionNamespaceLister = new(controllerRevisionNamespaceLister)
...
// - has the kcpcache.ClusterIndex as an index
// - has the kcpcache.ClusterAndNamespaceIndex as an index
func NewControllerRevisionLister(indexer cache.Indexer) listersappsv1beta2.ControllerRevisionLister {
	return &controllerRevisionLister{
		kcplisters.New[*appsv1beta2.ControllerRevision](indexer, appsv1beta2.Resource("controllerrevision")),
	}
}
...
// ControllerRevisions returns an object that can list and get ControllerRevisions in one namespace.
func (l *controllerRevisionScopedLister) ControllerRevisions(namespace string) listersappsv1beta2.ControllerRevisionLister {
	return &controllerRevisionLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}
