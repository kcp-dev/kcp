...
type DeploymentClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersappsv1beta1.DeploymentLister
...
type deploymentClusterLister struct {
	kcplisters.ResourceClusterIndexer[*appsv1beta1.Deployment]
}
...
func NewDeploymentClusterLister(indexer cache.Indexer) DeploymentClusterLister {
	return &deploymentClusterLister{
		kcplisters.NewCluster[*appsv1beta1.Deployment](indexer, appsv1beta1.Resource("deployment")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get Deployments.
func (l *deploymentClusterLister) Cluster(clusterName logicalcluster.Name) listersappsv1beta1.DeploymentLister {
...
// or scope down to a listersappsv1beta1.DeploymentNamespaceLister for one namespace.
type deploymentLister struct {
	kcplisters.ResourceIndexer[*appsv1beta1.Deployment]
}

var _ listersappsv1beta1.DeploymentLister = new(deploymentLister)

// Deployments returns an object that can list and get Deployments in one namespace.
func (l *deploymentLister) Deployments(namespace string) listersappsv1beta1.DeploymentNamespaceLister {
	return &deploymentNamespaceLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}

// deploymentNamespaceLister implements the listersappsv1beta1.DeploymentNamespaceLister
// interface.
type deploymentNamespaceLister struct {
	kcplisters.ResourceIndexer[*appsv1beta1.Deployment]
}

var _ listersappsv1beta1.DeploymentNamespaceLister = new(deploymentNamespaceLister)
...
// - has the kcpcache.ClusterIndex as an index
// - has the kcpcache.ClusterAndNamespaceIndex as an index
func NewDeploymentLister(indexer cache.Indexer) listersappsv1beta1.DeploymentLister {
	return &deploymentLister{
		kcplisters.New[*appsv1beta1.Deployment](indexer, appsv1beta1.Resource("deployment")),
	}
}
...
// Deployments returns an object that can list and get Deployments in one namespace.
func (l *deploymentScopedLister) Deployments(namespace string) listersappsv1beta1.DeploymentLister {
	return &deploymentLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}
