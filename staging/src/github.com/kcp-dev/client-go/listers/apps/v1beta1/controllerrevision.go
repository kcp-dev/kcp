...
func NewControllerRevisionLister(indexer cache.Indexer) listersappsv1beta1.ControllerRevisionLister {
	return &controllerRevisionLister{
		kcplisters.New[*appsv1beta1.ControllerRevision](indexer, appsv1beta1.Resource("controllerrevision")),
	}
}
...
// ControllerRevisions returns an object that can list and get ControllerRevisions in one namespace.
func (l *controllerRevisionScopedLister) ControllerRevisions(namespace string) listersappsv1beta1.ControllerRevisionLister {
	return &controllerRevisionLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}
