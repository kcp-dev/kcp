...
type DeviceClassClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersresourcev1beta1.DeviceClassLister
...
type deviceClassClusterLister struct {
	kcplisters.ResourceClusterIndexer[*resourcev1beta1.DeviceClass]
}
...
func NewDeviceClassClusterLister(indexer cache.Indexer) DeviceClassClusterLister {
	return &deviceClassClusterLister{
		kcplisters.NewCluster[*resourcev1beta1.DeviceClass](indexer, resourcev1beta1.Resource("deviceclass")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get DeviceClasses.
func (l *deviceClassClusterLister) Cluster(clusterName logicalcluster.Name) listersresourcev1beta1.DeviceClassLister {
...
// or scope down to a listersresourcev1beta1.DeviceClassNamespaceLister for one namespace.
type deviceClassLister struct {
	kcplisters.ResourceIndexer[*resourcev1beta1.DeviceClass]
}

var _ listersresourcev1beta1.DeviceClassLister = new(deviceClassLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewDeviceClassLister(indexer cache.Indexer) listersresourcev1beta1.DeviceClassLister {
	return &deviceClassLister{
		kcplisters.New[*resourcev1beta1.DeviceClass](indexer, resourcev1beta1.Resource("deviceclass")),
	}
}

// deviceClassScopedLister can list all DeviceClasses inside a workspace
// or scope down to a listersresourcev1beta1.DeviceClassNamespaceLister.
