...
type ResourceSliceClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersresourcev1beta1.ResourceSliceLister
...
type resourceSliceClusterLister struct {
	kcplisters.ResourceClusterIndexer[*resourcev1beta1.ResourceSlice]
}
...
func NewResourceSliceClusterLister(indexer cache.Indexer) ResourceSliceClusterLister {
	return &resourceSliceClusterLister{
		kcplisters.NewCluster[*resourcev1beta1.ResourceSlice](indexer, resourcev1beta1.Resource("resourceslice")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get ResourceSlices.
func (l *resourceSliceClusterLister) Cluster(clusterName logicalcluster.Name) listersresourcev1beta1.ResourceSliceLister {
...
// or scope down to a listersresourcev1beta1.ResourceSliceNamespaceLister for one namespace.
type resourceSliceLister struct {
	kcplisters.ResourceIndexer[*resourcev1beta1.ResourceSlice]
}

var _ listersresourcev1beta1.ResourceSliceLister = new(resourceSliceLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewResourceSliceLister(indexer cache.Indexer) listersresourcev1beta1.ResourceSliceLister {
	return &resourceSliceLister{
		kcplisters.New[*resourcev1beta1.ResourceSlice](indexer, resourcev1beta1.Resource("resourceslice")),
	}
}

// resourceSliceScopedLister can list all ResourceSlices inside a workspace
// or scope down to a listersresourcev1beta1.ResourceSliceNamespaceLister.
