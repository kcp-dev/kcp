...
type resourceClaimClusterLister struct {
	kcplisters.ResourceClusterIndexer[*resourcev1.ResourceClaim]
}
...
func NewResourceClaimClusterLister(indexer cache.Indexer) ResourceClaimClusterLister {
	return &resourceClaimClusterLister{
		kcplisters.NewCluster[*resourcev1.ResourceClaim](indexer, resourcev1.Resource("resourceclaim")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get ResourceClaims.
func (l *resourceClaimClusterLister) Cluster(clusterName logicalcluster.Name) listersresourcev1.ResourceClaimLister {
...
// or scope down to a listersresourcev1.ResourceClaimNamespaceLister for one namespace.
type resourceClaimLister struct {
	kcplisters.ResourceIndexer[*resourcev1.ResourceClaim]
}

var _ listersresourcev1.ResourceClaimLister = new(resourceClaimLister)

// ResourceClaims returns an object that can list and get ResourceClaims in one namespace.
func (l *resourceClaimLister) ResourceClaims(namespace string) listersresourcev1.ResourceClaimNamespaceLister {
	return &resourceClaimNamespaceLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}

// resourceClaimNamespaceLister implements the listersresourcev1.ResourceClaimNamespaceLister
// interface.
type resourceClaimNamespaceLister struct {
	kcplisters.ResourceIndexer[*resourcev1.ResourceClaim]
}

var _ listersresourcev1.ResourceClaimNamespaceLister = new(resourceClaimNamespaceLister)
...
func NewResourceClaimLister(indexer cache.Indexer) listersresourcev1.ResourceClaimLister {
	return &resourceClaimLister{
		kcplisters.New[*resourcev1.ResourceClaim](indexer, resourcev1.Resource("resourceclaim")),
	}
}
...
// ResourceClaims returns an object that can list and get ResourceClaims in one namespace.
func (l *resourceClaimScopedLister) ResourceClaims(namespace string) listersresourcev1.ResourceClaimLister {
	return &resourceClaimLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}
