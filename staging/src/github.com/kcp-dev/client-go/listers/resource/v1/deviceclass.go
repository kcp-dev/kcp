...
type deviceClassClusterLister struct {
	kcplisters.ResourceClusterIndexer[*resourcev1.DeviceClass]
}
...
func NewDeviceClassClusterLister(indexer cache.Indexer) DeviceClassClusterLister {
	return &deviceClassClusterLister{
		kcplisters.NewCluster[*resourcev1.DeviceClass](indexer, resourcev1.Resource("deviceclass")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get DeviceClasses.
func (l *deviceClassClusterLister) Cluster(clusterName logicalcluster.Name) listersresourcev1.DeviceClassLister {
...
// or scope down to a listersresourcev1.DeviceClassNamespaceLister for one namespace.
type deviceClassLister struct {
	kcplisters.ResourceIndexer[*resourcev1.DeviceClass]
}

var _ listersresourcev1.DeviceClassLister = new(deviceClassLister)
...
func NewDeviceClassLister(indexer cache.Indexer) listersresourcev1.DeviceClassLister {
	return &deviceClassLister{
		kcplisters.New[*resourcev1.DeviceClass](indexer, resourcev1.Resource("deviceclass")),
	}
}

// deviceClassScopedLister can list all DeviceClasses inside a workspace
// or scope down to a listersresourcev1.DeviceClassNamespaceLister.
