...
type resourceClaimTemplateClusterLister struct {
	kcplisters.ResourceClusterIndexer[*resourcev1beta2.ResourceClaimTemplate]
}
...
func NewResourceClaimTemplateClusterLister(indexer cache.Indexer) ResourceClaimTemplateClusterLister {
	return &resourceClaimTemplateClusterLister{
		kcplisters.NewCluster[*resourcev1beta2.ResourceClaimTemplate](indexer, resourcev1beta2.Resource("resourceclaimtemplate")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get ResourceClaimTemplates.
func (l *resourceClaimTemplateClusterLister) Cluster(clusterName logicalcluster.Name) listersresourcev1beta2.ResourceClaimTemplateLister {
...
// or scope down to a listersresourcev1beta2.ResourceClaimTemplateNamespaceLister for one namespace.
type resourceClaimTemplateLister struct {
	kcplisters.ResourceIndexer[*resourcev1beta2.ResourceClaimTemplate]
}

var _ listersresourcev1beta2.ResourceClaimTemplateLister = new(resourceClaimTemplateLister)

// ResourceClaimTemplates returns an object that can list and get ResourceClaimTemplates in one namespace.
func (l *resourceClaimTemplateLister) ResourceClaimTemplates(namespace string) listersresourcev1beta2.ResourceClaimTemplateNamespaceLister {
	return &resourceClaimTemplateNamespaceLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}

// resourceClaimTemplateNamespaceLister implements the listersresourcev1beta2.ResourceClaimTemplateNamespaceLister
// interface.
type resourceClaimTemplateNamespaceLister struct {
	kcplisters.ResourceIndexer[*resourcev1beta2.ResourceClaimTemplate]
}

var _ listersresourcev1beta2.ResourceClaimTemplateNamespaceLister = new(resourceClaimTemplateNamespaceLister)
...
func NewResourceClaimTemplateLister(indexer cache.Indexer) listersresourcev1beta2.ResourceClaimTemplateLister {
	return &resourceClaimTemplateLister{
		kcplisters.New[*resourcev1beta2.ResourceClaimTemplate](indexer, resourcev1beta2.Resource("resourceclaimtemplate")),
	}
}
...
// ResourceClaimTemplates returns an object that can list and get ResourceClaimTemplates in one namespace.
func (l *resourceClaimTemplateScopedLister) ResourceClaimTemplates(namespace string) listersresourcev1beta2.ResourceClaimTemplateLister {
	return &resourceClaimTemplateLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}
