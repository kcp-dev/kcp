...
type resourceSliceClusterLister struct {
	kcplisters.ResourceClusterIndexer[*resourcev1beta2.ResourceSlice]
}
...
func NewResourceSliceClusterLister(indexer cache.Indexer) ResourceSliceClusterLister {
	return &resourceSliceClusterLister{
		kcplisters.NewCluster[*resourcev1beta2.ResourceSlice](indexer, resourcev1beta2.Resource("resourceslice")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get ResourceSlices.
func (l *resourceSliceClusterLister) Cluster(clusterName logicalcluster.Name) listersresourcev1beta2.ResourceSliceLister {
...
// or scope down to a listersresourcev1beta2.ResourceSliceNamespaceLister for one namespace.
type resourceSliceLister struct {
	kcplisters.ResourceIndexer[*resourcev1beta2.ResourceSlice]
}

var _ listersresourcev1beta2.ResourceSliceLister = new(resourceSliceLister)
...
func NewResourceSliceLister(indexer cache.Indexer) listersresourcev1beta2.ResourceSliceLister {
	return &resourceSliceLister{
		kcplisters.New[*resourcev1beta2.ResourceSlice](indexer, resourcev1beta2.Resource("resourceslice")),
	}
}

// resourceSliceScopedLister can list all ResourceSlices inside a workspace
// or scope down to a listersresourcev1beta2.ResourceSliceNamespaceLister.
