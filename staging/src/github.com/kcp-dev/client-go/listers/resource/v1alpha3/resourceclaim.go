...
type ResourceClaimClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersresourcev1alpha3.ResourceClaimLister
...
type resourceClaimClusterLister struct {
	kcplisters.ResourceClusterIndexer[*resourcev1alpha3.ResourceClaim]
}
...
func NewResourceClaimClusterLister(indexer cache.Indexer) ResourceClaimClusterLister {
	return &resourceClaimClusterLister{
		kcplisters.NewCluster[*resourcev1alpha3.ResourceClaim](indexer, resourcev1alpha3.Resource("resourceclaim")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get ResourceClaims.
func (l *resourceClaimClusterLister) Cluster(clusterName logicalcluster.Name) listersresourcev1alpha3.ResourceClaimLister {
...
// or scope down to a listersresourcev1alpha3.ResourceClaimNamespaceLister for one namespace.
type resourceClaimLister struct {
	kcplisters.ResourceIndexer[*resourcev1alpha3.ResourceClaim]
}

var _ listersresourcev1alpha3.ResourceClaimLister = new(resourceClaimLister)

// ResourceClaims returns an object that can list and get ResourceClaims in one namespace.
func (l *resourceClaimLister) ResourceClaims(namespace string) listersresourcev1alpha3.ResourceClaimNamespaceLister {
	return &resourceClaimNamespaceLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}

// resourceClaimNamespaceLister implements the listersresourcev1alpha3.ResourceClaimNamespaceLister
// interface.
type resourceClaimNamespaceLister struct {
	kcplisters.ResourceIndexer[*resourcev1alpha3.ResourceClaim]
}

var _ listersresourcev1alpha3.ResourceClaimNamespaceLister = new(resourceClaimNamespaceLister)
...
// - has the kcpcache.ClusterIndex as an index
// - has the kcpcache.ClusterAndNamespaceIndex as an index
func NewResourceClaimLister(indexer cache.Indexer) listersresourcev1alpha3.ResourceClaimLister {
	return &resourceClaimLister{
		kcplisters.New[*resourcev1alpha3.ResourceClaim](indexer, resourcev1alpha3.Resource("resourceclaim")),
	}
}
...
// ResourceClaims returns an object that can list and get ResourceClaims in one namespace.
func (l *resourceClaimScopedLister) ResourceClaims(namespace string) listersresourcev1alpha3.ResourceClaimLister {
	return &resourceClaimLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}
