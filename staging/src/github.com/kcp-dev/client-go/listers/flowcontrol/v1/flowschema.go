...
type FlowSchemaClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersflowcontrolv1.FlowSchemaLister
...
type flowSchemaClusterLister struct {
	kcplisters.ResourceClusterIndexer[*flowcontrolv1.FlowSchema]
}
...
func NewFlowSchemaClusterLister(indexer cache.Indexer) FlowSchemaClusterLister {
	return &flowSchemaClusterLister{
		kcplisters.NewCluster[*flowcontrolv1.FlowSchema](indexer, flowcontrolv1.Resource("flowschema")),
	}
}
...
// or scope down to a listersflowcontrolv1.FlowSchemaNamespaceLister for one namespace.
type flowSchemaLister struct {
	kcplisters.ResourceIndexer[*flowcontrolv1.FlowSchema]
}

var _ listersflowcontrolv1.FlowSchemaLister = new(flowSchemaLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewFlowSchemaLister(indexer cache.Indexer) listersflowcontrolv1.FlowSchemaLister {
	return &flowSchemaLister{
		kcplisters.New[*flowcontrolv1.FlowSchema](indexer, flowcontrolv1.Resource("flowschema")),
	}
}

// flowSchemaScopedLister can list all FlowSchemas inside a workspace
// or scope down to a listersflowcontrolv1.FlowSchemaNamespaceLister.
