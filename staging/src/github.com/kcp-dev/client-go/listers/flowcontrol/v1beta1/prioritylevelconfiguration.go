...
type priorityLevelConfigurationClusterLister struct {
	kcplisters.ResourceClusterIndexer[*flowcontrolv1beta1.PriorityLevelConfiguration]
}
...
func NewPriorityLevelConfigurationClusterLister(indexer cache.Indexer) PriorityLevelConfigurationClusterLister {
	return &priorityLevelConfigurationClusterLister{
		kcplisters.NewCluster[*flowcontrolv1beta1.PriorityLevelConfiguration](indexer, flowcontrolv1beta1.Resource("prioritylevelconfiguration")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get PriorityLevelConfigurations.
func (l *priorityLevelConfigurationClusterLister) Cluster(clusterName logicalcluster.Name) listersflowcontrolv1beta1.PriorityLevelConfigurationLister {
...
// or scope down to a listersflowcontrolv1beta1.PriorityLevelConfigurationNamespaceLister for one namespace.
type priorityLevelConfigurationLister struct {
	kcplisters.ResourceIndexer[*flowcontrolv1beta1.PriorityLevelConfiguration]
}

var _ listersflowcontrolv1beta1.PriorityLevelConfigurationLister = new(priorityLevelConfigurationLister)
...
func NewPriorityLevelConfigurationLister(indexer cache.Indexer) listersflowcontrolv1beta1.PriorityLevelConfigurationLister {
	return &priorityLevelConfigurationLister{
		kcplisters.New[*flowcontrolv1beta1.PriorityLevelConfiguration](indexer, flowcontrolv1beta1.Resource("prioritylevelconfiguration")),
	}
}

// priorityLevelConfigurationScopedLister can list all PriorityLevelConfigurations inside a workspace
// or scope down to a listersflowcontrolv1beta1.PriorityLevelConfigurationNamespaceLister.
