...
type flowSchemaClusterLister struct {
	kcplisters.ResourceClusterIndexer[*flowcontrolv1beta1.FlowSchema]
}
...
func NewFlowSchemaClusterLister(indexer cache.Indexer) FlowSchemaClusterLister {
	return &flowSchemaClusterLister{
		kcplisters.NewCluster[*flowcontrolv1beta1.FlowSchema](indexer, flowcontrolv1beta1.Resource("flowschema")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get FlowSchemas.
func (l *flowSchemaClusterLister) Cluster(clusterName logicalcluster.Name) listersflowcontrolv1beta1.FlowSchemaLister {
...
// or scope down to a listersflowcontrolv1beta1.FlowSchemaNamespaceLister for one namespace.
type flowSchemaLister struct {
	kcplisters.ResourceIndexer[*flowcontrolv1beta1.FlowSchema]
}

var _ listersflowcontrolv1beta1.FlowSchemaLister = new(flowSchemaLister)
...
func NewFlowSchemaLister(indexer cache.Indexer) listersflowcontrolv1beta1.FlowSchemaLister {
	return &flowSchemaLister{
		kcplisters.New[*flowcontrolv1beta1.FlowSchema](indexer, flowcontrolv1beta1.Resource("flowschema")),
	}
}

// flowSchemaScopedLister can list all FlowSchemas inside a workspace
// or scope down to a listersflowcontrolv1beta1.FlowSchemaNamespaceLister.
