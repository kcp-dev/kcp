...
type PriorityLevelConfigurationClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersflowcontrolv1beta3.PriorityLevelConfigurationLister
...
type priorityLevelConfigurationClusterLister struct {
	kcplisters.ResourceClusterIndexer[*flowcontrolv1beta3.PriorityLevelConfiguration]
}
...
func NewPriorityLevelConfigurationClusterLister(indexer cache.Indexer) PriorityLevelConfigurationClusterLister {
	return &priorityLevelConfigurationClusterLister{
		kcplisters.NewCluster[*flowcontrolv1beta3.PriorityLevelConfiguration](indexer, flowcontrolv1beta3.Resource("prioritylevelconfiguration")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get PriorityLevelConfigurations.
func (l *priorityLevelConfigurationClusterLister) Cluster(clusterName logicalcluster.Name) listersflowcontrolv1beta3.PriorityLevelConfigurationLister {
...
// or scope down to a listersflowcontrolv1beta3.PriorityLevelConfigurationNamespaceLister for one namespace.
type priorityLevelConfigurationLister struct {
	kcplisters.ResourceIndexer[*flowcontrolv1beta3.PriorityLevelConfiguration]
}

var _ listersflowcontrolv1beta3.PriorityLevelConfigurationLister = new(priorityLevelConfigurationLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewPriorityLevelConfigurationLister(indexer cache.Indexer) listersflowcontrolv1beta3.PriorityLevelConfigurationLister {
	return &priorityLevelConfigurationLister{
		kcplisters.New[*flowcontrolv1beta3.PriorityLevelConfiguration](indexer, flowcontrolv1beta3.Resource("prioritylevelconfiguration")),
	}
}

// priorityLevelConfigurationScopedLister can list all PriorityLevelConfigurations inside a workspace
// or scope down to a listersflowcontrolv1beta3.PriorityLevelConfigurationNamespaceLister.
