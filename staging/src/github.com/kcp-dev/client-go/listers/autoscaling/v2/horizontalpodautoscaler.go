...
type HorizontalPodAutoscalerClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersautoscalingv2.HorizontalPodAutoscalerLister
...
type horizontalPodAutoscalerClusterLister struct {
	kcplisters.ResourceClusterIndexer[*autoscalingv2.HorizontalPodAutoscaler]
}
...
func NewHorizontalPodAutoscalerClusterLister(indexer cache.Indexer) HorizontalPodAutoscalerClusterLister {
	return &horizontalPodAutoscalerClusterLister{
		kcplisters.NewCluster[*autoscalingv2.HorizontalPodAutoscaler](indexer, autoscalingv2.Resource("horizontalpodautoscaler")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get HorizontalPodAutoscalers.
func (l *horizontalPodAutoscalerClusterLister) Cluster(clusterName logicalcluster.Name) listersautoscalingv2.HorizontalPodAutoscalerLister {
...
// or scope down to a listersautoscalingv2.HorizontalPodAutoscalerNamespaceLister for one namespace.
type horizontalPodAutoscalerLister struct {
	kcplisters.ResourceIndexer[*autoscalingv2.HorizontalPodAutoscaler]
}

var _ listersautoscalingv2.HorizontalPodAutoscalerLister = new(horizontalPodAutoscalerLister)

// HorizontalPodAutoscalers returns an object that can list and get HorizontalPodAutoscalers in one namespace.
func (l *horizontalPodAutoscalerLister) HorizontalPodAutoscalers(namespace string) listersautoscalingv2.HorizontalPodAutoscalerNamespaceLister {
	return &horizontalPodAutoscalerNamespaceLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}

// horizontalPodAutoscalerNamespaceLister implements the listersautoscalingv2.HorizontalPodAutoscalerNamespaceLister
// interface.
type horizontalPodAutoscalerNamespaceLister struct {
	kcplisters.ResourceIndexer[*autoscalingv2.HorizontalPodAutoscaler]
}

var _ listersautoscalingv2.HorizontalPodAutoscalerNamespaceLister = new(horizontalPodAutoscalerNamespaceLister)
...
// - has the kcpcache.ClusterIndex as an index
// - has the kcpcache.ClusterAndNamespaceIndex as an index
func NewHorizontalPodAutoscalerLister(indexer cache.Indexer) listersautoscalingv2.HorizontalPodAutoscalerLister {
	return &horizontalPodAutoscalerLister{
		kcplisters.New[*autoscalingv2.HorizontalPodAutoscaler](indexer, autoscalingv2.Resource("horizontalpodautoscaler")),
	}
}
...
// HorizontalPodAutoscalers returns an object that can list and get HorizontalPodAutoscalers in one namespace.
func (l *horizontalPodAutoscalerScopedLister) HorizontalPodAutoscalers(namespace string) listersautoscalingv2.HorizontalPodAutoscalerLister {
	return &horizontalPodAutoscalerLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}
