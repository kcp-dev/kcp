...
type podDisruptionBudgetClusterLister struct {
	kcplisters.ResourceClusterIndexer[*policyv1.PodDisruptionBudget]
}
...
func (l *podDisruptionBudgetClusterLister) Cluster(clusterName logicalcluster.Name) listerspolicyv1.PodDisruptionBudgetLister {
...
// or scope down to a listerspolicyv1.PodDisruptionBudgetNamespaceLister for one namespace.
type podDisruptionBudgetLister struct {
	kcplisters.ResourceIndexer[*policyv1.PodDisruptionBudget]
}

var _ listerspolicyv1.PodDisruptionBudgetLister = new(podDisruptionBudgetLister)

// PodDisruptionBudgets returns an object that can list and get PodDisruptionBudgets in one namespace.
func (l *podDisruptionBudgetLister) PodDisruptionBudgets(namespace string) listerspolicyv1.PodDisruptionBudgetNamespaceLister {
	return &podDisruptionBudgetNamespaceLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}

// podDisruptionBudgetNamespaceLister implements the listerspolicyv1.PodDisruptionBudgetNamespaceLister
// interface.
type podDisruptionBudgetNamespaceLister struct {
	kcplisters.ResourceIndexer[*policyv1.PodDisruptionBudget]
}

var _ listerspolicyv1.PodDisruptionBudgetNamespaceLister = new(podDisruptionBudgetNamespaceLister)
...
// PodDisruptionBudgets returns an object that can list and get PodDisruptionBudgets in one namespace.
func (l *podDisruptionBudgetScopedLister) PodDisruptionBudgets(namespace string) listerspolicyv1.PodDisruptionBudgetLister {
	return &podDisruptionBudgetLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}
