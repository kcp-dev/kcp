...
type priorityClassClusterLister struct {
	kcplisters.ResourceClusterIndexer[*schedulingv1alpha1.PriorityClass]
}
...
func NewPriorityClassClusterLister(indexer cache.Indexer) PriorityClassClusterLister {
	return &priorityClassClusterLister{
		kcplisters.NewCluster[*schedulingv1alpha1.PriorityClass](indexer, schedulingv1alpha1.Resource("priorityclass")),
	}
}
...
// or scope down to a listersschedulingv1alpha1.PriorityClassNamespaceLister for one namespace.
type priorityClassLister struct {
	kcplisters.ResourceIndexer[*schedulingv1alpha1.PriorityClass]
}

var _ listersschedulingv1alpha1.PriorityClassLister = new(priorityClassLister)
...
func NewPriorityClassLister(indexer cache.Indexer) listersschedulingv1alpha1.PriorityClassLister {
	return &priorityClassLister{
		kcplisters.New[*schedulingv1alpha1.PriorityClass](indexer, schedulingv1alpha1.Resource("priorityclass")),
	}
}

// priorityClassScopedLister can list all PriorityClasses inside a workspace
// or scope down to a listersschedulingv1alpha1.PriorityClassNamespaceLister.
