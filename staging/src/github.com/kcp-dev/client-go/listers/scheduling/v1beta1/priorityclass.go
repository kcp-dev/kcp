...
type PriorityClassClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersschedulingv1beta1.PriorityClassLister
...
type priorityClassClusterLister struct {
	kcplisters.ResourceClusterIndexer[*schedulingv1beta1.PriorityClass]
}
...
func NewPriorityClassClusterLister(indexer cache.Indexer) PriorityClassClusterLister {
	return &priorityClassClusterLister{
		kcplisters.NewCluster[*schedulingv1beta1.PriorityClass](indexer, schedulingv1beta1.Resource("priorityclass")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get PriorityClasses.
func (l *priorityClassClusterLister) Cluster(clusterName logicalcluster.Name) listersschedulingv1beta1.PriorityClassLister {
...
// or scope down to a listersschedulingv1beta1.PriorityClassNamespaceLister for one namespace.
type priorityClassLister struct {
	kcplisters.ResourceIndexer[*schedulingv1beta1.PriorityClass]
}

var _ listersschedulingv1beta1.PriorityClassLister = new(priorityClassLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewPriorityClassLister(indexer cache.Indexer) listersschedulingv1beta1.PriorityClassLister {
	return &priorityClassLister{
		kcplisters.New[*schedulingv1beta1.PriorityClass](indexer, schedulingv1beta1.Resource("priorityclass")),
	}
}

// priorityClassScopedLister can list all PriorityClasses inside a workspace
// or scope down to a listersschedulingv1beta1.PriorityClassNamespaceLister.
