...
type serviceCIDRClusterLister struct {
	kcplisters.ResourceClusterIndexer[*networkingv1.ServiceCIDR]
}
...
func NewServiceCIDRClusterLister(indexer cache.Indexer) ServiceCIDRClusterLister {
	return &serviceCIDRClusterLister{
		kcplisters.NewCluster[*networkingv1.ServiceCIDR](indexer, networkingv1.Resource("servicecidr")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get ServiceCIDRs.
func (l *serviceCIDRClusterLister) Cluster(clusterName logicalcluster.Name) listersnetworkingv1.ServiceCIDRLister {
...
// or scope down to a listersnetworkingv1.ServiceCIDRNamespaceLister for one namespace.
type serviceCIDRLister struct {
	kcplisters.ResourceIndexer[*networkingv1.ServiceCIDR]
}

var _ listersnetworkingv1.ServiceCIDRLister = new(serviceCIDRLister)
...
func NewServiceCIDRLister(indexer cache.Indexer) listersnetworkingv1.ServiceCIDRLister {
	return &serviceCIDRLister{
		kcplisters.New[*networkingv1.ServiceCIDR](indexer, networkingv1.Resource("servicecidr")),
	}
}

// serviceCIDRScopedLister can list all ServiceCIDRs inside a workspace
// or scope down to a listersnetworkingv1.ServiceCIDRNamespaceLister.
