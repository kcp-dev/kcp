...
type networkPolicyClusterLister struct {
	kcplisters.ResourceClusterIndexer[*networkingv1.NetworkPolicy]
}
...
func NewNetworkPolicyClusterLister(indexer cache.Indexer) NetworkPolicyClusterLister {
	return &networkPolicyClusterLister{
		kcplisters.NewCluster[*networkingv1.NetworkPolicy](indexer, networkingv1.Resource("networkpolicy")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get NetworkPolicies.
func (l *networkPolicyClusterLister) Cluster(clusterName logicalcluster.Name) listersnetworkingv1.NetworkPolicyLister {
...
// or scope down to a listersnetworkingv1.NetworkPolicyNamespaceLister for one namespace.
type networkPolicyLister struct {
	kcplisters.ResourceIndexer[*networkingv1.NetworkPolicy]
}

var _ listersnetworkingv1.NetworkPolicyLister = new(networkPolicyLister)

// NetworkPolicies returns an object that can list and get NetworkPolicies in one namespace.
func (l *networkPolicyLister) NetworkPolicies(namespace string) listersnetworkingv1.NetworkPolicyNamespaceLister {
	return &networkPolicyNamespaceLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}

// networkPolicyNamespaceLister implements the listersnetworkingv1.NetworkPolicyNamespaceLister
// interface.
type networkPolicyNamespaceLister struct {
	kcplisters.ResourceIndexer[*networkingv1.NetworkPolicy]
}

var _ listersnetworkingv1.NetworkPolicyNamespaceLister = new(networkPolicyNamespaceLister)
...
func NewNetworkPolicyLister(indexer cache.Indexer) listersnetworkingv1.NetworkPolicyLister {
	return &networkPolicyLister{
		kcplisters.New[*networkingv1.NetworkPolicy](indexer, networkingv1.Resource("networkpolicy")),
	}
}
...
// NetworkPolicies returns an object that can list and get NetworkPolicies in one namespace.
func (l *networkPolicyScopedLister) NetworkPolicies(namespace string) listersnetworkingv1.NetworkPolicyLister {
	return &networkPolicyLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}
