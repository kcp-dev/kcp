...
type IngressClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersnetworkingv1beta1.IngressLister
...
type ingressClusterLister struct {
	kcplisters.ResourceClusterIndexer[*networkingv1beta1.Ingress]
}
...
func NewIngressClusterLister(indexer cache.Indexer) IngressClusterLister {
	return &ingressClusterLister{
		kcplisters.NewCluster[*networkingv1beta1.Ingress](indexer, networkingv1beta1.Resource("ingress")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get Ingresses.
func (l *ingressClusterLister) Cluster(clusterName logicalcluster.Name) listersnetworkingv1beta1.IngressLister {
...
// or scope down to a listersnetworkingv1beta1.IngressNamespaceLister for one namespace.
type ingressLister struct {
	kcplisters.ResourceIndexer[*networkingv1beta1.Ingress]
}

var _ listersnetworkingv1beta1.IngressLister = new(ingressLister)

// Ingresses returns an object that can list and get Ingresses in one namespace.
func (l *ingressLister) Ingresses(namespace string) listersnetworkingv1beta1.IngressNamespaceLister {
	return &ingressNamespaceLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}

// ingressNamespaceLister implements the listersnetworkingv1beta1.IngressNamespaceLister
// interface.
type ingressNamespaceLister struct {
	kcplisters.ResourceIndexer[*networkingv1beta1.Ingress]
}

var _ listersnetworkingv1beta1.IngressNamespaceLister = new(ingressNamespaceLister)
...
// - has the kcpcache.ClusterIndex as an index
// - has the kcpcache.ClusterAndNamespaceIndex as an index
func NewIngressLister(indexer cache.Indexer) listersnetworkingv1beta1.IngressLister {
	return &ingressLister{
		kcplisters.New[*networkingv1beta1.Ingress](indexer, networkingv1beta1.Resource("ingress")),
	}
}
...
// Ingresses returns an object that can list and get Ingresses in one namespace.
func (l *ingressScopedLister) Ingresses(namespace string) listersnetworkingv1beta1.IngressLister {
	return &ingressLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}
