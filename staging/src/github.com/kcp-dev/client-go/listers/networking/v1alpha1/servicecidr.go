...
type ServiceCIDRClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersnetworkingv1alpha1.ServiceCIDRLister
...
type serviceCIDRClusterLister struct {
	kcplisters.ResourceClusterIndexer[*networkingv1alpha1.ServiceCIDR]
}
...
func NewServiceCIDRClusterLister(indexer cache.Indexer) ServiceCIDRClusterLister {
	return &serviceCIDRClusterLister{
		kcplisters.NewCluster[*networkingv1alpha1.ServiceCIDR](indexer, networkingv1alpha1.Resource("servicecidr")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get ServiceCIDRs.
func (l *serviceCIDRClusterLister) Cluster(clusterName logicalcluster.Name) listersnetworkingv1alpha1.ServiceCIDRLister {
...
// or scope down to a listersnetworkingv1alpha1.ServiceCIDRNamespaceLister for one namespace.
type serviceCIDRLister struct {
	kcplisters.ResourceIndexer[*networkingv1alpha1.ServiceCIDR]
}

var _ listersnetworkingv1alpha1.ServiceCIDRLister = new(serviceCIDRLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewServiceCIDRLister(indexer cache.Indexer) listersnetworkingv1alpha1.ServiceCIDRLister {
	return &serviceCIDRLister{
		kcplisters.New[*networkingv1alpha1.ServiceCIDR](indexer, networkingv1alpha1.Resource("servicecidr")),
	}
}

// serviceCIDRScopedLister can list all ServiceCIDRs inside a workspace
// or scope down to a listersnetworkingv1alpha1.ServiceCIDRNamespaceLister.
