...
type RoleClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersrbacv1alpha1.RoleLister
	RoleClusterListerExpansion
}

// roleClusterLister implements the RoleClusterLister interface.
type roleClusterLister struct {
	kcplisters.ResourceClusterIndexer[*rbacv1alpha1.Role]
}
...
func NewRoleClusterLister(indexer cache.Indexer) RoleClusterLister {
	return &roleClusterLister{
		kcplisters.NewCluster[*rbacv1alpha1.Role](indexer, rbacv1alpha1.Resource("role")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get Roles.
func (l *roleClusterLister) Cluster(clusterName logicalcluster.Name) listersrbacv1alpha1.RoleLister {
	return &roleLister{
...
// or scope down to a listersrbacv1alpha1.RoleNamespaceLister for one namespace.
type roleLister struct {
	kcplisters.ResourceIndexer[*rbacv1alpha1.Role]
}

var _ listersrbacv1alpha1.RoleLister = new(roleLister)

// Roles returns an object that can list and get Roles in one namespace.
func (l *roleLister) Roles(namespace string) listersrbacv1alpha1.RoleNamespaceLister {
	return &roleNamespaceLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}

// roleNamespaceLister implements the listersrbacv1alpha1.RoleNamespaceLister
// interface.
type roleNamespaceLister struct {
	kcplisters.ResourceIndexer[*rbacv1alpha1.Role]
}

var _ listersrbacv1alpha1.RoleNamespaceLister = new(roleNamespaceLister)
...
// - has the kcpcache.ClusterIndex as an index
// - has the kcpcache.ClusterAndNamespaceIndex as an index
func NewRoleLister(indexer cache.Indexer) listersrbacv1alpha1.RoleLister {
	return &roleLister{
		kcplisters.New[*rbacv1alpha1.Role](indexer, rbacv1alpha1.Resource("role")),
	}
}
...
// Roles returns an object that can list and get Roles in one namespace.
func (l *roleScopedLister) Roles(namespace string) listersrbacv1alpha1.RoleLister {
	return &roleLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}
