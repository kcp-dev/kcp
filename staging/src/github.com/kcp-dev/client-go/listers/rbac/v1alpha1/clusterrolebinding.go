...
type ClusterRoleBindingClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersrbacv1alpha1.ClusterRoleBindingLister
...
type clusterRoleBindingClusterLister struct {
	kcplisters.ResourceClusterIndexer[*rbacv1alpha1.ClusterRoleBinding]
}
...
func NewClusterRoleBindingClusterLister(indexer cache.Indexer) ClusterRoleBindingClusterLister {
	return &clusterRoleBindingClusterLister{
		kcplisters.NewCluster[*rbacv1alpha1.ClusterRoleBinding](indexer, rbacv1alpha1.Resource("clusterrolebinding")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get ClusterRoleBindings.
func (l *clusterRoleBindingClusterLister) Cluster(clusterName logicalcluster.Name) listersrbacv1alpha1.ClusterRoleBindingLister {
...
// or scope down to a listersrbacv1alpha1.ClusterRoleBindingNamespaceLister for one namespace.
type clusterRoleBindingLister struct {
	kcplisters.ResourceIndexer[*rbacv1alpha1.ClusterRoleBinding]
}

var _ listersrbacv1alpha1.ClusterRoleBindingLister = new(clusterRoleBindingLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewClusterRoleBindingLister(indexer cache.Indexer) listersrbacv1alpha1.ClusterRoleBindingLister {
	return &clusterRoleBindingLister{
		kcplisters.New[*rbacv1alpha1.ClusterRoleBinding](indexer, rbacv1alpha1.Resource("clusterrolebinding")),
	}
}

// clusterRoleBindingScopedLister can list all ClusterRoleBindings inside a workspace
// or scope down to a listersrbacv1alpha1.ClusterRoleBindingNamespaceLister.
