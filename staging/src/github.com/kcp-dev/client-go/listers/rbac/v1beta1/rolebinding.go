...
type RoleBindingClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersrbacv1beta1.RoleBindingLister
...
type roleBindingClusterLister struct {
	kcplisters.ResourceClusterIndexer[*rbacv1beta1.RoleBinding]
}
...
func NewRoleBindingClusterLister(indexer cache.Indexer) RoleBindingClusterLister {
	return &roleBindingClusterLister{
		kcplisters.NewCluster[*rbacv1beta1.RoleBinding](indexer, rbacv1beta1.Resource("rolebinding")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get RoleBindings.
func (l *roleBindingClusterLister) Cluster(clusterName logicalcluster.Name) listersrbacv1beta1.RoleBindingLister {
...
// or scope down to a listersrbacv1beta1.RoleBindingNamespaceLister for one namespace.
type roleBindingLister struct {
	kcplisters.ResourceIndexer[*rbacv1beta1.RoleBinding]
}

var _ listersrbacv1beta1.RoleBindingLister = new(roleBindingLister)

// RoleBindings returns an object that can list and get RoleBindings in one namespace.
func (l *roleBindingLister) RoleBindings(namespace string) listersrbacv1beta1.RoleBindingNamespaceLister {
	return &roleBindingNamespaceLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}

// roleBindingNamespaceLister implements the listersrbacv1beta1.RoleBindingNamespaceLister
// interface.
type roleBindingNamespaceLister struct {
	kcplisters.ResourceIndexer[*rbacv1beta1.RoleBinding]
}

var _ listersrbacv1beta1.RoleBindingNamespaceLister = new(roleBindingNamespaceLister)
...
// - has the kcpcache.ClusterIndex as an index
// - has the kcpcache.ClusterAndNamespaceIndex as an index
func NewRoleBindingLister(indexer cache.Indexer) listersrbacv1beta1.RoleBindingLister {
	return &roleBindingLister{
		kcplisters.New[*rbacv1beta1.RoleBinding](indexer, rbacv1beta1.Resource("rolebinding")),
	}
}
...
// RoleBindings returns an object that can list and get RoleBindings in one namespace.
func (l *roleBindingScopedLister) RoleBindings(namespace string) listersrbacv1beta1.RoleBindingLister {
	return &roleBindingLister{
		l.ResourceIndexer.WithNamespace(namespace),
	}
}
