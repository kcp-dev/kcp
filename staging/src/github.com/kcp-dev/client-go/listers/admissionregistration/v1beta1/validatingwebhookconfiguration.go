...
type ValidatingWebhookConfigurationClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1beta1.ValidatingWebhookConfigurationLister
...
type validatingWebhookConfigurationClusterLister struct {
	kcplisters.ResourceClusterIndexer[*admissionregistrationv1beta1.ValidatingWebhookConfiguration]
}
...
func NewValidatingWebhookConfigurationClusterLister(indexer cache.Indexer) ValidatingWebhookConfigurationClusterLister {
	return &validatingWebhookConfigurationClusterLister{
		kcplisters.NewCluster[*admissionregistrationv1beta1.ValidatingWebhookConfiguration](indexer, admissionregistrationv1beta1.Resource("validatingwebhookconfiguration")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get ValidatingWebhookConfigurations.
func (l *validatingWebhookConfigurationClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1beta1.ValidatingWebhookConfigurationLister {
...
// or scope down to a listersadmissionregistrationv1beta1.ValidatingWebhookConfigurationNamespaceLister for one namespace.
type validatingWebhookConfigurationLister struct {
	kcplisters.ResourceIndexer[*admissionregistrationv1beta1.ValidatingWebhookConfiguration]
}

var _ listersadmissionregistrationv1beta1.ValidatingWebhookConfigurationLister = new(validatingWebhookConfigurationLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewValidatingWebhookConfigurationLister(indexer cache.Indexer) listersadmissionregistrationv1beta1.ValidatingWebhookConfigurationLister {
	return &validatingWebhookConfigurationLister{
		kcplisters.New[*admissionregistrationv1beta1.ValidatingWebhookConfiguration](indexer, admissionregistrationv1beta1.Resource("validatingwebhookconfiguration")),
	}
}

// validatingWebhookConfigurationScopedLister can list all ValidatingWebhookConfigurations inside a workspace
// or scope down to a listersadmissionregistrationv1beta1.ValidatingWebhookConfigurationNamespaceLister.
