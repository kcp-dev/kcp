...
type ValidatingAdmissionPolicyClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyLister
...
type validatingAdmissionPolicyClusterLister struct {
	kcplisters.ResourceClusterIndexer[*admissionregistrationv1beta1.ValidatingAdmissionPolicy]
}
...
func NewValidatingAdmissionPolicyClusterLister(indexer cache.Indexer) ValidatingAdmissionPolicyClusterLister {
	return &validatingAdmissionPolicyClusterLister{
		kcplisters.NewCluster[*admissionregistrationv1beta1.ValidatingAdmissionPolicy](indexer, admissionregistrationv1beta1.Resource("validatingadmissionpolicy")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get ValidatingAdmissionPolicies.
func (l *validatingAdmissionPolicyClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyLister {
...
// or scope down to a listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyNamespaceLister for one namespace.
type validatingAdmissionPolicyLister struct {
	kcplisters.ResourceIndexer[*admissionregistrationv1beta1.ValidatingAdmissionPolicy]
}

var _ listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyLister = new(validatingAdmissionPolicyLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewValidatingAdmissionPolicyLister(indexer cache.Indexer) listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyLister {
	return &validatingAdmissionPolicyLister{
		kcplisters.New[*admissionregistrationv1beta1.ValidatingAdmissionPolicy](indexer, admissionregistrationv1beta1.Resource("validatingadmissionpolicy")),
	}
}

// validatingAdmissionPolicyScopedLister can list all ValidatingAdmissionPolicies inside a workspace
// or scope down to a listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyNamespaceLister.
