...
type ValidatingAdmissionPolicyBindingClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyBindingLister
...
type validatingAdmissionPolicyBindingClusterLister struct {
	kcplisters.ResourceClusterIndexer[*admissionregistrationv1beta1.ValidatingAdmissionPolicyBinding]
}
...
func NewValidatingAdmissionPolicyBindingClusterLister(indexer cache.Indexer) ValidatingAdmissionPolicyBindingClusterLister {
	return &validatingAdmissionPolicyBindingClusterLister{
		kcplisters.NewCluster[*admissionregistrationv1beta1.ValidatingAdmissionPolicyBinding](indexer, admissionregistrationv1beta1.Resource("validatingadmissionpolicybinding")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get ValidatingAdmissionPolicyBindings.
func (l *validatingAdmissionPolicyBindingClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyBindingLister {
...
// or scope down to a listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyBindingNamespaceLister for one namespace.
type validatingAdmissionPolicyBindingLister struct {
	kcplisters.ResourceIndexer[*admissionregistrationv1beta1.ValidatingAdmissionPolicyBinding]
}

var _ listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyBindingLister = new(validatingAdmissionPolicyBindingLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewValidatingAdmissionPolicyBindingLister(indexer cache.Indexer) listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyBindingLister {
	return &validatingAdmissionPolicyBindingLister{
		kcplisters.New[*admissionregistrationv1beta1.ValidatingAdmissionPolicyBinding](indexer, admissionregistrationv1beta1.Resource("validatingadmissionpolicybinding")),
	}
}

// validatingAdmissionPolicyBindingScopedLister can list all ValidatingAdmissionPolicyBindings inside a workspace
// or scope down to a listersadmissionregistrationv1beta1.ValidatingAdmissionPolicyBindingNamespaceLister.
