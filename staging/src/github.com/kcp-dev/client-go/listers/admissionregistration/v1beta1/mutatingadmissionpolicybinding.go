...
type MutatingAdmissionPolicyBindingClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1beta1.MutatingAdmissionPolicyBindingLister
...
type mutatingAdmissionPolicyBindingClusterLister struct {
	kcplisters.ResourceClusterIndexer[*admissionregistrationv1beta1.MutatingAdmissionPolicyBinding]
}
...
func NewMutatingAdmissionPolicyBindingClusterLister(indexer cache.Indexer) MutatingAdmissionPolicyBindingClusterLister {
	return &mutatingAdmissionPolicyBindingClusterLister{
		kcplisters.NewCluster[*admissionregistrationv1beta1.MutatingAdmissionPolicyBinding](indexer, admissionregistrationv1beta1.Resource("mutatingadmissionpolicybinding")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get MutatingAdmissionPolicyBindings.
func (l *mutatingAdmissionPolicyBindingClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1beta1.MutatingAdmissionPolicyBindingLister {
...
// or scope down to a listersadmissionregistrationv1beta1.MutatingAdmissionPolicyBindingNamespaceLister for one namespace.
type mutatingAdmissionPolicyBindingLister struct {
	kcplisters.ResourceIndexer[*admissionregistrationv1beta1.MutatingAdmissionPolicyBinding]
}

var _ listersadmissionregistrationv1beta1.MutatingAdmissionPolicyBindingLister = new(mutatingAdmissionPolicyBindingLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewMutatingAdmissionPolicyBindingLister(indexer cache.Indexer) listersadmissionregistrationv1beta1.MutatingAdmissionPolicyBindingLister {
	return &mutatingAdmissionPolicyBindingLister{
		kcplisters.New[*admissionregistrationv1beta1.MutatingAdmissionPolicyBinding](indexer, admissionregistrationv1beta1.Resource("mutatingadmissionpolicybinding")),
	}
}

// mutatingAdmissionPolicyBindingScopedLister can list all MutatingAdmissionPolicyBindings inside a workspace
// or scope down to a listersadmissionregistrationv1beta1.MutatingAdmissionPolicyBindingNamespaceLister.
