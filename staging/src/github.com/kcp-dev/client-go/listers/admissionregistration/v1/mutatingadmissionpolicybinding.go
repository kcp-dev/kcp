...
type MutatingAdmissionPolicyBindingClusterLister interface {
	...
	List(selector labels.Selector) (ret []*admissionregistrationv1.MutatingAdmissionPolicyBinding, err error)
	// Cluster returns a lister that can list and get MutatingAdmissionPolicyBindings in one workspace.
	Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1.MutatingAdmissionPolicyBindingLister
...
type mutatingAdmissionPolicyBindingClusterLister struct {
	kcplisters.ResourceClusterIndexer[*admissionregistrationv1.MutatingAdmissionPolicyBinding]
}
...
func NewMutatingAdmissionPolicyBindingClusterLister(indexer cache.Indexer) MutatingAdmissionPolicyBindingClusterLister {
	return &mutatingAdmissionPolicyBindingClusterLister{
		kcplisters.NewCluster[*admissionregistrationv1.MutatingAdmissionPolicyBinding](indexer, admissionregistrationv1.Resource("mutatingadmissionpolicybinding")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get MutatingAdmissionPolicyBindings.
func (l *mutatingAdmissionPolicyBindingClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1.MutatingAdmissionPolicyBindingLister {
...
// or scope down to a listersadmissionregistrationv1.MutatingAdmissionPolicyBindingNamespaceLister for one namespace.
type mutatingAdmissionPolicyBindingLister struct {
	kcplisters.ResourceIndexer[*admissionregistrationv1.MutatingAdmissionPolicyBinding]
}

var _ listersadmissionregistrationv1.MutatingAdmissionPolicyBindingLister = new(mutatingAdmissionPolicyBindingLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewMutatingAdmissionPolicyBindingLister(indexer cache.Indexer) listersadmissionregistrationv1.MutatingAdmissionPolicyBindingLister {
	return &mutatingAdmissionPolicyBindingLister{
		kcplisters.New[*admissionregistrationv1.MutatingAdmissionPolicyBinding](indexer, admissionregistrationv1.Resource("mutatingadmissionpolicybinding")),
	}
}

// mutatingAdmissionPolicyBindingScopedLister can list all MutatingAdmissionPolicyBindings inside a workspace
// or scope down to a listersadmissionregistrationv1.MutatingAdmissionPolicyBindingNamespaceLister.
