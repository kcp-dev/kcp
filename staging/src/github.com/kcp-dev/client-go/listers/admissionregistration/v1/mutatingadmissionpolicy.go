...
type MutatingAdmissionPolicyClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1.MutatingAdmissionPolicyLister
...
type mutatingAdmissionPolicyClusterLister struct {
	kcplisters.ResourceClusterIndexer[*admissionregistrationv1.MutatingAdmissionPolicy]
}
...
func NewMutatingAdmissionPolicyClusterLister(indexer cache.Indexer) MutatingAdmissionPolicyClusterLister {
	return &mutatingAdmissionPolicyClusterLister{
		kcplisters.NewCluster[*admissionregistrationv1.MutatingAdmissionPolicy](indexer, admissionregistrationv1.Resource("mutatingadmissionpolicy")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get MutatingAdmissionPolicies.
func (l *mutatingAdmissionPolicyClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1.MutatingAdmissionPolicyLister {
...
// or scope down to a listersadmissionregistrationv1.MutatingAdmissionPolicyNamespaceLister for one namespace.
type mutatingAdmissionPolicyLister struct {
	kcplisters.ResourceIndexer[*admissionregistrationv1.MutatingAdmissionPolicy]
}

var _ listersadmissionregistrationv1.MutatingAdmissionPolicyLister = new(mutatingAdmissionPolicyLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewMutatingAdmissionPolicyLister(indexer cache.Indexer) listersadmissionregistrationv1.MutatingAdmissionPolicyLister {
	return &mutatingAdmissionPolicyLister{
		kcplisters.New[*admissionregistrationv1.MutatingAdmissionPolicy](indexer, admissionregistrationv1.Resource("mutatingadmissionpolicy")),
	}
}

// mutatingAdmissionPolicyScopedLister can list all MutatingAdmissionPolicies inside a workspace
// or scope down to a listersadmissionregistrationv1.MutatingAdmissionPolicyNamespaceLister.
