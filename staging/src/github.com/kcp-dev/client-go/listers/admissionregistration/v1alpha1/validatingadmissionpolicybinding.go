...
type ValidatingAdmissionPolicyBindingClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1alpha1.ValidatingAdmissionPolicyBindingLister
...
type validatingAdmissionPolicyBindingClusterLister struct {
	kcplisters.ResourceClusterIndexer[*admissionregistrationv1alpha1.ValidatingAdmissionPolicyBinding]
}
...
func NewValidatingAdmissionPolicyBindingClusterLister(indexer cache.Indexer) ValidatingAdmissionPolicyBindingClusterLister {
	return &validatingAdmissionPolicyBindingClusterLister{
		kcplisters.NewCluster[*admissionregistrationv1alpha1.ValidatingAdmissionPolicyBinding](indexer, admissionregistrationv1alpha1.Resource("validatingadmissionpolicybinding")),
	}
}

// Cluster scopes the lister to one workspace, allowing users to list and get ValidatingAdmissionPolicyBindings.
func (l *validatingAdmissionPolicyBindingClusterLister) Cluster(clusterName logicalcluster.Name) listersadmissionregistrationv1alpha1.ValidatingAdmissionPolicyBindingLister {
...
// or scope down to a listersadmissionregistrationv1alpha1.ValidatingAdmissionPolicyBindingNamespaceLister for one namespace.
type validatingAdmissionPolicyBindingLister struct {
	kcplisters.ResourceIndexer[*admissionregistrationv1alpha1.ValidatingAdmissionPolicyBinding]
}

var _ listersadmissionregistrationv1alpha1.ValidatingAdmissionPolicyBindingLister = new(validatingAdmissionPolicyBindingLister)
...
// - uses kcpcache.MetaClusterNamespaceKeyFunc as the key function
// - has the kcpcache.ClusterIndex as an index
func NewValidatingAdmissionPolicyBindingLister(indexer cache.Indexer) listersadmissionregistrationv1alpha1.ValidatingAdmissionPolicyBindingLister {
	return &validatingAdmissionPolicyBindingLister{
		kcplisters.New[*admissionregistrationv1alpha1.ValidatingAdmissionPolicyBinding](indexer, admissionregistrationv1alpha1.Resource("validatingadmissionpolicybinding")),
	}
}

// validatingAdmissionPolicyBindingScopedLister can list all ValidatingAdmissionPolicyBindings inside a workspace
// or scope down to a listersadmissionregistrationv1alpha1.ValidatingAdmissionPolicyBindingNamespaceLister.
