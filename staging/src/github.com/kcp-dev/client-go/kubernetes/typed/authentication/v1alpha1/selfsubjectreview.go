...
// SelfSubjectReviewClusterInterface can operate on SelfSubjectReviews across all clusters,
// or scope down to one cluster and return a authenticationv1alpha1.SelfSubjectReviewInterface.
type SelfSubjectReviewClusterInterface interface {
	Cluster(logicalcluster.Path) authenticationv1alpha1.SelfSubjectReviewInterface
...
func (c *selfSubjectReviewsClusterInterface) Cluster(clusterPath logicalcluster.Path) authenticationv1alpha1.SelfSubjectReviewInterface {
