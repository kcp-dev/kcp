...
// or scope down to one cluster and return a authenticationv1.SelfSubjectReviewInterface.
type SelfSubjectReviewClusterInterface interface {
	Cluster(logicalcluster.Path) authenticationv1.SelfSubjectReviewInterface
...
func (c *selfSubjectReviewsClusterInterface) Cluster(clusterPath logicalcluster.Path) authenticationv1.SelfSubjectReviewInterface {
