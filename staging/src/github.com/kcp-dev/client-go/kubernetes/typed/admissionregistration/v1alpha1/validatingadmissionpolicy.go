...
// or scope down to one cluster and return a admissionregistrationv1alpha1.ValidatingAdmissionPolicyInterface.
type ValidatingAdmissionPolicyClusterInterface interface {
	Cluster(logicalcluster.Path) admissionregistrationv1alpha1.ValidatingAdmissionPolicyInterface
	List(ctx context.Context, opts v1.ListOptions) (*apiadmissionregistrationv1alpha1.ValidatingAdmissionPolicyList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	ValidatingAdmissionPolicyClusterExpansion
}
...
func (c *validatingAdmissionPoliciesClusterInterface) Cluster(clusterPath logicalcluster.Path) admissionregistrationv1alpha1.ValidatingAdmissionPolicyInterface {
...
func (c *validatingAdmissionPoliciesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apiadmissionregistrationv1alpha1.ValidatingAdmissionPolicyList, error) {
...
func (c *validatingAdmissionPoliciesClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
