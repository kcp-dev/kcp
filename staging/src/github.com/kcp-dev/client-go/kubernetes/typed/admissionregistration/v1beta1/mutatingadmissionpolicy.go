...
// or scope down to one cluster and return a admissionregistrationv1beta1.MutatingAdmissionPolicyInterface.
type MutatingAdmissionPolicyClusterInterface interface {
	Cluster(logicalcluster.Path) admissionregistrationv1beta1.MutatingAdmissionPolicyInterface
	List(ctx context.Context, opts v1.ListOptions) (*apiadmissionregistrationv1beta1.MutatingAdmissionPolicyList, error)
...
func (c *mutatingAdmissionPoliciesClusterInterface) Cluster(clusterPath logicalcluster.Path) admissionregistrationv1beta1.MutatingAdmissionPolicyInterface {
...
func (c *mutatingAdmissionPoliciesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apiadmissionregistrationv1beta1.MutatingAdmissionPolicyList, error) {
