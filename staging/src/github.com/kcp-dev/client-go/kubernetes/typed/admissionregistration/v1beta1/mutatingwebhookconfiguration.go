...
// or scope down to one cluster and return a admissionregistrationv1beta1.MutatingWebhookConfigurationInterface.
type MutatingWebhookConfigurationClusterInterface interface {
	Cluster(logicalcluster.Path) admissionregistrationv1beta1.MutatingWebhookConfigurationInterface
	List(ctx context.Context, opts v1.ListOptions) (*apiadmissionregistrationv1beta1.MutatingWebhookConfigurationList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	MutatingWebhookConfigurationClusterExpansion
}
...
func (c *mutatingWebhookConfigurationsClusterInterface) Cluster(clusterPath logicalcluster.Path) admissionregistrationv1beta1.MutatingWebhookConfigurationInterface {
...
func (c *mutatingWebhookConfigurationsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apiadmissionregistrationv1beta1.MutatingWebhookConfigurationList, error) {
...
func (c *mutatingWebhookConfigurationsClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
