...
// or scope down to one cluster and return a admissionregistrationv1alpha1.MutatingAdmissionPolicyInterface.
type MutatingAdmissionPolicyClusterInterface interface {
	Cluster(logicalcluster.Path) admissionregistrationv1alpha1.MutatingAdmissionPolicyInterface
	List(ctx context.Context, opts v1.ListOptions) (*apiadmissionregistrationv1alpha1.MutatingAdmissionPolicyList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	MutatingAdmissionPolicyClusterExpansion
}
...
func (c *mutatingAdmissionPoliciesClusterInterface) Cluster(clusterPath logicalcluster.Path) admissionregistrationv1alpha1.MutatingAdmissionPolicyInterface {
...
func (c *mutatingAdmissionPoliciesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apiadmissionregistrationv1alpha1.MutatingAdmissionPolicyList, error) {
...
func (c *mutatingAdmissionPoliciesClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
