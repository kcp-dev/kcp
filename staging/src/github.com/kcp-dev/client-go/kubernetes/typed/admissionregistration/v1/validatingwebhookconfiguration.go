...
// or scope down to one cluster and return a admissionregistrationv1.ValidatingWebhookConfigurationInterface.
type ValidatingWebhookConfigurationClusterInterface interface {
	Cluster(logicalcluster.Path) admissionregistrationv1.ValidatingWebhookConfigurationInterface
	List(ctx context.Context, opts metav1.ListOptions) (*apiadmissionregistrationv1.ValidatingWebhookConfigurationList, error)
...
func (c *validatingWebhookConfigurationsClusterInterface) Cluster(clusterPath logicalcluster.Path) admissionregistrationv1.ValidatingWebhookConfigurationInterface {
...
func (c *validatingWebhookConfigurationsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apiadmissionregistrationv1.ValidatingWebhookConfigurationList, error) {
