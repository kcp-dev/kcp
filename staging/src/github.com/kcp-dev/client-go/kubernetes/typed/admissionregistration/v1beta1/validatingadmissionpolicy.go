...
// or scope down to one cluster and return a admissionregistrationv1beta1.ValidatingAdmissionPolicyInterface.
type ValidatingAdmissionPolicyClusterInterface interface {
	Cluster(logicalcluster.Path) admissionregistrationv1beta1.ValidatingAdmissionPolicyInterface
	List(ctx context.Context, opts v1.ListOptions) (*apiadmissionregistrationv1beta1.ValidatingAdmissionPolicyList, error)
...
func (c *validatingAdmissionPoliciesClusterInterface) Cluster(clusterPath logicalcluster.Path) admissionregistrationv1beta1.ValidatingAdmissionPolicyInterface {
...
func (c *validatingAdmissionPoliciesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apiadmissionregistrationv1beta1.ValidatingAdmissionPolicyList, error) {
