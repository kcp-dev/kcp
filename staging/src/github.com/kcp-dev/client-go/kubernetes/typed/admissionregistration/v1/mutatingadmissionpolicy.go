...
// or scope down to one cluster and return a admissionregistrationv1.MutatingAdmissionPolicyInterface.
type MutatingAdmissionPolicyClusterInterface interface {
	Cluster(logicalcluster.Path) admissionregistrationv1.MutatingAdmissionPolicyInterface
	List(ctx context.Context, opts metav1.ListOptions) (*apiadmissionregistrationv1.MutatingAdmissionPolicyList, error)
...
func (c *mutatingAdmissionPoliciesClusterInterface) Cluster(clusterPath logicalcluster.Path) admissionregistrationv1.MutatingAdmissionPolicyInterface {
...
func (c *mutatingAdmissionPoliciesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apiadmissionregistrationv1.MutatingAdmissionPolicyList, error) {
