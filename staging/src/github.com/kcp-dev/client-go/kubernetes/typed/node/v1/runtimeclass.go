...
// or scope down to one cluster and return a nodev1.RuntimeClassInterface.
type RuntimeClassClusterInterface interface {
	Cluster(logicalcluster.Path) nodev1.RuntimeClassInterface
	List(ctx context.Context, opts metav1.ListOptions) (*apinodev1.RuntimeClassList, error)
...
func (c *runtimeClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) nodev1.RuntimeClassInterface {
...
func (c *runtimeClassesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apinodev1.RuntimeClassList, error) {
