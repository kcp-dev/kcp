...
// or scope down to one cluster and return a nodev1alpha1.RuntimeClassInterface.
type RuntimeClassClusterInterface interface {
	Cluster(logicalcluster.Path) nodev1alpha1.RuntimeClassInterface
	List(ctx context.Context, opts v1.ListOptions) (*apinodev1alpha1.RuntimeClassList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	RuntimeClassClusterExpansion
}
...
func (c *runtimeClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) nodev1alpha1.RuntimeClassInterface {
...
func (c *runtimeClassesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apinodev1alpha1.RuntimeClassList, error) {
...
func (c *runtimeClassesClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
