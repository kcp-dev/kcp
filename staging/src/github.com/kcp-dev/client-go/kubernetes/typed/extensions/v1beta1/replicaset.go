...
func (c *replicaSetsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*extensionsv1beta1.ReplicaSetList, error) {
...
func (n *replicaSetsNamespacer) Namespace(namespace string) typedextensionsv1beta1.ReplicaSetInterface {
