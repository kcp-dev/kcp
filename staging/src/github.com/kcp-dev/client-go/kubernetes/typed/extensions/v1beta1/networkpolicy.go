...
type networkPoliciesClusterInterface struct {
	clientCache kcpclient.Cache[*typedextensionsv1beta1.ExtensionsV1beta1Client]
}
...
func (c *networkPoliciesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*extensionsv1beta1.NetworkPolicyList, error) {
	return c.clientCache.ClusterOrDie(logicalcluster.Wildcard).NetworkPolicies(v1.NamespaceAll).List(ctx, opts)
}

// Watch begins to watch all NetworkPolicies across all clusters.
func (c *networkPoliciesClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.clientCache.ClusterOrDie(logicalcluster.Wildcard).NetworkPolicies(v1.NamespaceAll).Watch(ctx, opts)
}
...
func (n *networkPoliciesNamespacer) Namespace(namespace string) typedextensionsv1beta1.NetworkPolicyInterface {
