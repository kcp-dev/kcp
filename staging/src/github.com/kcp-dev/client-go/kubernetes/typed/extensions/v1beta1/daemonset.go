...
func (c *daemonSetsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*extensionsv1beta1.DaemonSetList, error) {
...
func (n *daemonSetsNamespacer) Namespace(namespace string) typedextensionsv1beta1.DaemonSetInterface {
