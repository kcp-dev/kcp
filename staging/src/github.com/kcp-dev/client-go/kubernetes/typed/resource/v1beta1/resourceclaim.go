...
type ResourceClaimClusterInterface interface {
	...
	List(ctx context.Context, opts metav1.ListOptions) (*resourcev1beta1.ResourceClaimList, error)
...
func (c *resourceClaimsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*resourcev1beta1.ResourceClaimList, error) {
...
type ResourceClaimsNamespacer interface {
	Namespace(string) resourcev1beta1client.ResourceClaimInterface
}
