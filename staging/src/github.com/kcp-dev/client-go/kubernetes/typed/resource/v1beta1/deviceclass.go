...
// or scope down to one cluster and return a resourcev1beta1.DeviceClassInterface.
type DeviceClassClusterInterface interface {
	Cluster(logicalcluster.Path) resourcev1beta1.DeviceClassInterface
	List(ctx context.Context, opts v1.ListOptions) (*apiresourcev1beta1.DeviceClassList, error)
...
func (c *deviceClassesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apiresourcev1beta1.DeviceClassList, error) {
