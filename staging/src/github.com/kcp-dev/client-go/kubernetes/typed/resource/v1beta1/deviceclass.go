...
// or scope down to one cluster and return a resourcev1beta1client.DeviceClassInterface.
type DeviceClassClusterInterface interface {
	Cluster(logicalcluster.Path) resourcev1beta1client.DeviceClassInterface
	List(ctx context.Context, opts metav1.ListOptions) (*resourcev1beta1.DeviceClassList, error)
...
func (c *deviceClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) resourcev1beta1client.DeviceClassInterface {
...
func (c *deviceClassesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*resourcev1beta1.DeviceClassList, error) {
