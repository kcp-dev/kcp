...
type resourceClaimTemplatesClusterInterface struct {
	clientCache kcpclient.Cache[*typedresourcev1beta2.ResourceV1beta2Client]
}
...
func (c *resourceClaimTemplatesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*resourcev1beta2.ResourceClaimTemplateList, error) {
...
func (n *resourceClaimTemplatesNamespacer) Namespace(namespace string) typedresourcev1beta2.ResourceClaimTemplateInterface {
