...
// or scope down to one cluster and return a resourcev1.ResourceSliceInterface.
type ResourceSliceClusterInterface interface {
	Cluster(logicalcluster.Path) resourcev1.ResourceSliceInterface
	List(ctx context.Context, opts metav1.ListOptions) (*apiresourcev1.ResourceSliceList, error)
...
func (c *resourceSlicesClusterInterface) Cluster(clusterPath logicalcluster.Path) resourcev1.ResourceSliceInterface {
...
func (c *resourceSlicesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apiresourcev1.ResourceSliceList, error) {
