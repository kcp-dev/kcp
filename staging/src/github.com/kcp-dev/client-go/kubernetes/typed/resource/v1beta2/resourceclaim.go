...
func (c *resourceClaimsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*resourcev1beta2.ResourceClaimList, error) {
...
func (n *resourceClaimsNamespacer) Namespace(namespace string) typedresourcev1beta2.ResourceClaimInterface {
