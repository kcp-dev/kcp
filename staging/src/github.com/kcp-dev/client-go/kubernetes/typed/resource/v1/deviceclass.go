...
// or scope down to one cluster and return a resourcev1.DeviceClassInterface.
type DeviceClassClusterInterface interface {
	Cluster(logicalcluster.Path) resourcev1.DeviceClassInterface
	List(ctx context.Context, opts metav1.ListOptions) (*apiresourcev1.DeviceClassList, error)
...
func (c *deviceClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) resourcev1.DeviceClassInterface {
...
func (c *deviceClassesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apiresourcev1.DeviceClassList, error) {
