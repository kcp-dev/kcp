...
// or scope down to one cluster and return a resourcev1beta1client.ResourceSliceInterface.
type ResourceSliceClusterInterface interface {
	Cluster(logicalcluster.Path) resourcev1beta1client.ResourceSliceInterface
	List(ctx context.Context, opts metav1.ListOptions) (*resourcev1beta1.ResourceSliceList, error)
...
func (c *resourceSlicesClusterInterface) Cluster(clusterPath logicalcluster.Path) resourcev1beta1client.ResourceSliceInterface {
...
func (c *resourceSlicesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*resourcev1beta1.ResourceSliceList, error) {
