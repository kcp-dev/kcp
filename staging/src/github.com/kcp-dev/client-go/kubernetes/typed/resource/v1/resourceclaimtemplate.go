...
type resourceClaimTemplatesClusterInterface struct {
	clientCache kcpclient.Cache[*typedresourcev1.ResourceV1Client]
}
...
func (c *resourceClaimTemplatesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*resourcev1.ResourceClaimTemplateList, error) {
...
// ResourceClaimTemplatesNamespacer can scope to objects within a namespace, returning a typedresourcev1.ResourceClaimTemplateInterface.
type ResourceClaimTemplatesNamespacer interface {
	Namespace(string) typedresourcev1.ResourceClaimTemplateInterface
}
...
func (n *resourceClaimTemplatesNamespacer) Namespace(namespace string) typedresourcev1.ResourceClaimTemplateInterface {
