...
// or scope down to one cluster and return a networkingv1.IPAddressInterface.
...
func (c *iPAddressesClusterInterface) Cluster(clusterPath logicalcluster.Path) networkingv1.IPAddressInterface {
...
func (c *iPAddressesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apinetworkingv1.IPAddressList, error) {
