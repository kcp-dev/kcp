...
// or scope down to one cluster and return a networkingv1beta1.IngressClassInterface.
...
func (c *ingressClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) networkingv1beta1.IngressClassInterface {
...
func (c *ingressClassesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apinetworkingv1beta1.IngressClassList, error) {
...
func (c *ingressClassesClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
