...
// or scope down to one cluster and return a networkingv1.IngressClassInterface.
...
func (c *ingressClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) networkingv1.IngressClassInterface {
...
func (c *ingressClassesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apinetworkingv1.IngressClassList, error) {
