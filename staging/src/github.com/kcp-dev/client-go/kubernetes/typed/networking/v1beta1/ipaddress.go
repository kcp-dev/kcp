...
// or scope down to one cluster and return a networkingv1beta1.IPAddressInterface.
...
func (c *iPAddressesClusterInterface) Cluster(clusterPath logicalcluster.Path) networkingv1beta1.IPAddressInterface {
...
func (c *iPAddressesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apinetworkingv1beta1.IPAddressList, error) {
