...
type controllerRevisionsClusterInterface struct {
	clientCache kcpclient.Cache[*typedappsv1.AppsV1Client]
}
...
func (n *controllerRevisionsNamespacer) Namespace(namespace string) typedappsv1.ControllerRevisionInterface {
