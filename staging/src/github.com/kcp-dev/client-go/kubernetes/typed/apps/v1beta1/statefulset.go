...
func (c *statefulSetsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*appsv1beta1.StatefulSetList, error) {
...
func (n *statefulSetsNamespacer) Namespace(namespace string) typedappsv1beta1.StatefulSetInterface {
