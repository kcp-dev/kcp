...
func (c *deploymentsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*appsv1beta1.DeploymentList, error) {
...
func (n *deploymentsNamespacer) Namespace(namespace string) typedappsv1beta1.DeploymentInterface {
