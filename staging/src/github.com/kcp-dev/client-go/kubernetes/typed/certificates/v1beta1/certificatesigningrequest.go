...
// or scope down to one cluster and return a certificatesv1beta1.CertificateSigningRequestInterface.
type CertificateSigningRequestClusterInterface interface {
	Cluster(logicalcluster.Path) certificatesv1beta1.CertificateSigningRequestInterface
	List(ctx context.Context, opts v1.ListOptions) (*apicertificatesv1beta1.CertificateSigningRequestList, error)
...
func (c *certificateSigningRequestsClusterInterface) Cluster(clusterPath logicalcluster.Path) certificatesv1beta1.CertificateSigningRequestInterface {
...
func (c *certificateSigningRequestsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apicertificatesv1beta1.CertificateSigningRequestList, error) {
...
func (c *certificateSigningRequestsClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
