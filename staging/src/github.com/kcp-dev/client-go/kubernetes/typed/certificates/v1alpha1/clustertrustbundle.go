...
// or scope down to one cluster and return a certificatesv1alpha1.ClusterTrustBundleInterface.
type ClusterTrustBundleClusterInterface interface {
	Cluster(logicalcluster.Path) certificatesv1alpha1.ClusterTrustBundleInterface
	List(ctx context.Context, opts v1.ListOptions) (*apicertificatesv1alpha1.ClusterTrustBundleList, error)
...
func (c *clusterTrustBundlesClusterInterface) Cluster(clusterPath logicalcluster.Path) certificatesv1alpha1.ClusterTrustBundleInterface {
...
func (c *clusterTrustBundlesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apicertificatesv1alpha1.ClusterTrustBundleList, error) {
