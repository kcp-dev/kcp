...
// or scope down to one cluster and return a schedulingv1beta1.PriorityClassInterface.
type PriorityClassClusterInterface interface {
	Cluster(logicalcluster.Path) schedulingv1beta1.PriorityClassInterface
	List(ctx context.Context, opts v1.ListOptions) (*apischedulingv1beta1.PriorityClassList, error)
...
func (c *priorityClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) schedulingv1beta1.PriorityClassInterface {
...
func (c *priorityClassesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apischedulingv1beta1.PriorityClassList, error) {
