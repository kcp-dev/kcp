...
// or scope down to one cluster and return a flowcontrolv1beta3.FlowSchemaInterface.
type FlowSchemaClusterInterface interface {
	Cluster(logicalcluster.Path) flowcontrolv1beta3.FlowSchemaInterface
	List(ctx context.Context, opts v1.ListOptions) (*apiflowcontrolv1beta3.FlowSchemaList, error)
...
func (c *flowSchemasClusterInterface) Cluster(clusterPath logicalcluster.Path) flowcontrolv1beta3.FlowSchemaInterface {
...
func (c *flowSchemasClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apiflowcontrolv1beta3.FlowSchemaList, error) {
...
func (c *flowSchemasClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
