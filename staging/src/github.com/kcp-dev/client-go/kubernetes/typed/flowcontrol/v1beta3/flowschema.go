...
// or scope down to one cluster and return a flowcontrolv1beta3client.FlowSchemaInterface.
type FlowSchemaClusterInterface interface {
	Cluster(logicalcluster.Path) flowcontrolv1beta3client.FlowSchemaInterface
	List(ctx context.Context, opts metav1.ListOptions) (*flowcontrolv1beta3.FlowSchemaList, error)
...
func (c *flowSchemasClusterInterface) Cluster(clusterPath logicalcluster.Path) flowcontrolv1beta3client.FlowSchemaInterface {
...
func (c *flowSchemasClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*flowcontrolv1beta3.FlowSchemaList, error) {
