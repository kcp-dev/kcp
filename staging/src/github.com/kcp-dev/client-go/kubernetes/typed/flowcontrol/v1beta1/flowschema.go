...
// or scope down to one cluster and return a flowcontrolv1beta1.FlowSchemaInterface.
...
func (c *flowSchemasClusterInterface) Cluster(clusterPath logicalcluster.Path) flowcontrolv1beta1.FlowSchemaInterface {
...
func (c *flowSchemasClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apiflowcontrolv1beta1.FlowSchemaList, error) {
