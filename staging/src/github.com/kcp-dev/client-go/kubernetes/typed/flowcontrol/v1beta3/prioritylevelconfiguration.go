...
// or scope down to one cluster and return a flowcontrolv1beta3.PriorityLevelConfigurationInterface.
type PriorityLevelConfigurationClusterInterface interface {
	Cluster(logicalcluster.Path) flowcontrolv1beta3.PriorityLevelConfigurationInterface
	List(ctx context.Context, opts v1.ListOptions) (*apiflowcontrolv1beta3.PriorityLevelConfigurationList, error)
...
func (c *priorityLevelConfigurationsClusterInterface) Cluster(clusterPath logicalcluster.Path) flowcontrolv1beta3.PriorityLevelConfigurationInterface {
...
func (c *priorityLevelConfigurationsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apiflowcontrolv1beta3.PriorityLevelConfigurationList, error) {
