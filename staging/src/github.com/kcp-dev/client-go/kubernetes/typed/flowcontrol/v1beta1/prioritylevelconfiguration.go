...
// or scope down to one cluster and return a flowcontrolv1beta1.PriorityLevelConfigurationInterface.
...
func (c *priorityLevelConfigurationsClusterInterface) Cluster(clusterPath logicalcluster.Path) flowcontrolv1beta1.PriorityLevelConfigurationInterface {
...
func (c *priorityLevelConfigurationsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apiflowcontrolv1beta1.PriorityLevelConfigurationList, error) {
