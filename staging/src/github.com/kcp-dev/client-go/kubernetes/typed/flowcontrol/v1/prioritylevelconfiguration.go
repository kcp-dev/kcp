...
// or scope down to one cluster and return a flowcontrolv1.PriorityLevelConfigurationInterface.
type PriorityLevelConfigurationClusterInterface interface {
	Cluster(logicalcluster.Path) flowcontrolv1.PriorityLevelConfigurationInterface
	List(ctx context.Context, opts metav1.ListOptions) (*apiflowcontrolv1.PriorityLevelConfigurationList, error)
...
func (c *priorityLevelConfigurationsClusterInterface) Cluster(clusterPath logicalcluster.Path) flowcontrolv1.PriorityLevelConfigurationInterface {
...
func (c *priorityLevelConfigurationsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apiflowcontrolv1.PriorityLevelConfigurationList, error) {
