...
// or scope down to one cluster and return a flowcontrolv1.FlowSchemaInterface.
type FlowSchemaClusterInterface interface {
	Cluster(logicalcluster.Path) flowcontrolv1.FlowSchemaInterface
	List(ctx context.Context, opts metav1.ListOptions) (*apiflowcontrolv1.FlowSchemaList, error)
...
func (c *flowSchemasClusterInterface) Cluster(clusterPath logicalcluster.Path) flowcontrolv1.FlowSchemaInterface {
...
func (c *flowSchemasClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apiflowcontrolv1.FlowSchemaList, error) {
