...
type horizontalPodAutoscalersClusterInterface struct {
	clientCache kcpclient.Cache[*typedautoscalingv2.AutoscalingV2Client]
}
...
func (c *horizontalPodAutoscalersClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*autoscalingv2.HorizontalPodAutoscalerList, error) {
...
// HorizontalPodAutoscalersNamespacer can scope to objects within a namespace, returning a typedautoscalingv2.HorizontalPodAutoscalerInterface.
type HorizontalPodAutoscalersNamespacer interface {
	Namespace(string) typedautoscalingv2.HorizontalPodAutoscalerInterface
}
...
func (n *horizontalPodAutoscalersNamespacer) Namespace(namespace string) typedautoscalingv2.HorizontalPodAutoscalerInterface {
