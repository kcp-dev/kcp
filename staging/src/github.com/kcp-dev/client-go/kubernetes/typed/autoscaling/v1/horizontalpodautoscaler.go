...
type horizontalPodAutoscalersClusterInterface struct {
	clientCache kcpclient.Cache[*typedautoscalingv1.AutoscalingV1Client]
}
...
// HorizontalPodAutoscalersNamespacer can scope to objects within a namespace, returning a typedautoscalingv1.HorizontalPodAutoscalerInterface.
type HorizontalPodAutoscalersNamespacer interface {
	Namespace(string) typedautoscalingv1.HorizontalPodAutoscalerInterface
}
...
func (n *horizontalPodAutoscalersNamespacer) Namespace(namespace string) typedautoscalingv1.HorizontalPodAutoscalerInterface {
