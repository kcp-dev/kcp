...
type horizontalPodAutoscalersClusterInterface struct {
	clientCache kcpclient.Cache[*typedautoscalingv2beta2.AutoscalingV2beta2Client]
}
...
func (c *horizontalPodAutoscalersClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*autoscalingv2beta2.HorizontalPodAutoscalerList, error) {
...
// HorizontalPodAutoscalersNamespacer can scope to objects within a namespace, returning a typedautoscalingv2beta2.HorizontalPodAutoscalerInterface.
type HorizontalPodAutoscalersNamespacer interface {
	Namespace(string) typedautoscalingv2beta2.HorizontalPodAutoscalerInterface
}
...
func (n *horizontalPodAutoscalersNamespacer) Namespace(namespace string) typedautoscalingv2beta2.HorizontalPodAutoscalerInterface {
