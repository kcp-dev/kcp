...
// EvictionsNamespacer can scope to objects within a namespace, returning a policyv1.EvictionInterface.
type EvictionsNamespacer interface {
	Namespace(string) policyv1.EvictionInterface
}
...
func (n *evictionsNamespacer) Namespace(namespace string) policyv1.EvictionInterface {
