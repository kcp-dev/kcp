...
type podDisruptionBudgetsClusterInterface struct {
	clientCache kcpclient.Cache[*typedpolicyv1.PolicyV1Client]
}
...
// PodDisruptionBudgetsNamespacer can scope to objects within a namespace, returning a typedpolicyv1.PodDisruptionBudgetInterface.
type PodDisruptionBudgetsNamespacer interface {
	Namespace(string) typedpolicyv1.PodDisruptionBudgetInterface
}
...
func (n *podDisruptionBudgetsNamespacer) Namespace(namespace string) typedpolicyv1.PodDisruptionBudgetInterface {
