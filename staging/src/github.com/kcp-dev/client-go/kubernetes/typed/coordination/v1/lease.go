...
type leasesClusterInterface struct {
	clientCache kcpclient.Cache[*typedcoordinationv1.CoordinationV1Client]
}
...
// LeasesNamespacer can scope to objects within a namespace, returning a typedcoordinationv1.LeaseInterface.
type LeasesNamespacer interface {
	Namespace(string) typedcoordinationv1.LeaseInterface
}
...
func (n *leasesNamespacer) Namespace(namespace string) typedcoordinationv1.LeaseInterface {
