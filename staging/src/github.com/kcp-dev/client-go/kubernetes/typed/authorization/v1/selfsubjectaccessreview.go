...
// SelfSubjectAccessReviewClusterInterface can operate on SelfSubjectAccessReviews across all clusters,
// or scope down to one cluster and return a authorizationv1.SelfSubjectAccessReviewInterface.
...
func (c *selfSubjectAccessReviewsClusterInterface) Cluster(clusterPath logicalcluster.Path) authorizationv1.SelfSubjectAccessReviewInterface {
