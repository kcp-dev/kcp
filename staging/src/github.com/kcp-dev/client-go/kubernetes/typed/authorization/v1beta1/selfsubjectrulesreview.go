...
// or scope down to one cluster and return a authorizationv1beta1.SelfSubjectRulesReviewInterface.
...
func (c *selfSubjectRulesReviewsClusterInterface) Cluster(clusterPath logicalcluster.Path) authorizationv1beta1.SelfSubjectRulesReviewInterface {
