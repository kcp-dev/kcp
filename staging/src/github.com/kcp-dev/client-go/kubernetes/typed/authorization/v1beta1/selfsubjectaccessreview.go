...
// or scope down to one cluster and return a authorizationv1beta1.SelfSubjectAccessReviewInterface.
...
func (c *selfSubjectAccessReviewsClusterInterface) Cluster(clusterPath logicalcluster.Path) authorizationv1beta1.SelfSubjectAccessReviewInterface {
