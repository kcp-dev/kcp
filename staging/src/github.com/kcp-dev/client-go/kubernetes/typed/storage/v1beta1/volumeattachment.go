...
// or scope down to one cluster and return a storagev1beta1.VolumeAttachmentInterface.
type VolumeAttachmentClusterInterface interface {
	Cluster(logicalcluster.Path) storagev1beta1.VolumeAttachmentInterface
	List(ctx context.Context, opts v1.ListOptions) (*apistoragev1beta1.VolumeAttachmentList, error)
...
func (c *volumeAttachmentsClusterInterface) Cluster(clusterPath logicalcluster.Path) storagev1beta1.VolumeAttachmentInterface {
...
func (c *volumeAttachmentsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apistoragev1beta1.VolumeAttachmentList, error) {
