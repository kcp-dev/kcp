...
// or scope down to one cluster and return a storagev1.VolumeAttachmentInterface.
...
func (c *volumeAttachmentsClusterInterface) Cluster(clusterPath logicalcluster.Path) storagev1.VolumeAttachmentInterface {
...
func (c *volumeAttachmentsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apistoragev1.VolumeAttachmentList, error) {
