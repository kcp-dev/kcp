...
// or scope down to one cluster and return a storagev1beta1.StorageClassInterface.
type StorageClassClusterInterface interface {
	Cluster(logicalcluster.Path) storagev1beta1.StorageClassInterface
	List(ctx context.Context, opts v1.ListOptions) (*apistoragev1beta1.StorageClassList, error)
...
func (c *storageClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) storagev1beta1.StorageClassInterface {
...
func (c *storageClassesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apistoragev1beta1.StorageClassList, error) {
...
func (c *storageClassesClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
