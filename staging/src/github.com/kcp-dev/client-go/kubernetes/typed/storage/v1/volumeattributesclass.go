...
// or scope down to one cluster and return a storagev1.VolumeAttributesClassInterface.
type VolumeAttributesClassClusterInterface interface {
	Cluster(logicalcluster.Path) storagev1.VolumeAttributesClassInterface
	List(ctx context.Context, opts metav1.ListOptions) (*apistoragev1.VolumeAttributesClassList, error)
...
func (c *volumeAttributesClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) storagev1.VolumeAttributesClassInterface {
...
func (c *volumeAttributesClassesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apistoragev1.VolumeAttributesClassList, error) {
