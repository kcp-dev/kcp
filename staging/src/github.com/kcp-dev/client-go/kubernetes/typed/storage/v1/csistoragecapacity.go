...
type cSIStorageCapacitiesClusterInterface struct {
	clientCache kcpclient.Cache[*typedstoragev1.StorageV1Client]
}
...
func (n *cSIStorageCapacitiesNamespacer) Namespace(namespace string) typedstoragev1.CSIStorageCapacityInterface {
