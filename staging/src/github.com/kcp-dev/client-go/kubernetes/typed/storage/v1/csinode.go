...
// or scope down to one cluster and return a storagev1.CSINodeInterface.
...
func (c *cSINodesClusterInterface) Cluster(clusterPath logicalcluster.Path) storagev1.CSINodeInterface {
...
func (c *cSINodesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apistoragev1.CSINodeList, error) {
