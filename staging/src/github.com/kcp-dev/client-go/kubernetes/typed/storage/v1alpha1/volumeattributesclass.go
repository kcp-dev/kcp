...
// or scope down to one cluster and return a storagev1alpha1.VolumeAttributesClassInterface.
...
func (c *volumeAttributesClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) storagev1alpha1.VolumeAttributesClassInterface {
...
func (c *volumeAttributesClassesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apistoragev1alpha1.VolumeAttributesClassList, error) {
