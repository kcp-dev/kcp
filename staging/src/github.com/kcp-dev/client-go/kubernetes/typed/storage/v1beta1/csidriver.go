...
// or scope down to one cluster and return a storagev1beta1.CSIDriverInterface.
type CSIDriverClusterInterface interface {
	Cluster(logicalcluster.Path) storagev1beta1.CSIDriverInterface
	List(ctx context.Context, opts v1.ListOptions) (*apistoragev1beta1.CSIDriverList, error)
...
func (c *cSIDriversClusterInterface) Cluster(clusterPath logicalcluster.Path) storagev1beta1.CSIDriverInterface {
...
func (c *cSIDriversClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apistoragev1beta1.CSIDriverList, error) {
...
func (c *cSIDriversClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
