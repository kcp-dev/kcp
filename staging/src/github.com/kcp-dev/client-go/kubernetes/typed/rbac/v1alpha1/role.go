...
func (c *rolesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*rbacv1alpha1.RoleList, error) {
...
func (n *rolesNamespacer) Namespace(namespace string) typedrbacv1alpha1.RoleInterface {
