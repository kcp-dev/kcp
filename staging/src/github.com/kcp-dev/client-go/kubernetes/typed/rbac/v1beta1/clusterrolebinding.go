...
// or scope down to one cluster and return a rbacv1beta1.ClusterRoleBindingInterface.
type ClusterRoleBindingClusterInterface interface {
	Cluster(logicalcluster.Path) rbacv1beta1.ClusterRoleBindingInterface
	List(ctx context.Context, opts v1.ListOptions) (*apirbacv1beta1.ClusterRoleBindingList, error)
...
func (c *clusterRoleBindingsClusterInterface) Cluster(clusterPath logicalcluster.Path) rbacv1beta1.ClusterRoleBindingInterface {
...
func (c *clusterRoleBindingsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apirbacv1beta1.ClusterRoleBindingList, error) {
...
func (c *clusterRoleBindingsClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
