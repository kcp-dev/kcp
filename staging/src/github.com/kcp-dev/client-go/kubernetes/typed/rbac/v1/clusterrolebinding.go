...
// or scope down to one cluster and return a rbacv1.ClusterRoleBindingInterface.
type ClusterRoleBindingClusterInterface interface {
	Cluster(logicalcluster.Path) rbacv1.ClusterRoleBindingInterface
	List(ctx context.Context, opts metav1.ListOptions) (*apirbacv1.ClusterRoleBindingList, error)
...
func (c *clusterRoleBindingsClusterInterface) Cluster(clusterPath logicalcluster.Path) rbacv1.ClusterRoleBindingInterface {
...
func (c *clusterRoleBindingsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apirbacv1.ClusterRoleBindingList, error) {
