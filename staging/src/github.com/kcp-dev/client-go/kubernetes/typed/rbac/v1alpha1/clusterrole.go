...
// or scope down to one cluster and return a rbacv1alpha1.ClusterRoleInterface.
...
func (c *clusterRolesClusterInterface) Cluster(clusterPath logicalcluster.Path) rbacv1alpha1.ClusterRoleInterface {
...
func (c *clusterRolesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apirbacv1alpha1.ClusterRoleList, error) {
