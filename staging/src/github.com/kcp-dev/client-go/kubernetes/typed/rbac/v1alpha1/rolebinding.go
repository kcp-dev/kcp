...
type roleBindingsClusterInterface struct {
	clientCache kcpclient.Cache[*typedrbacv1alpha1.RbacV1alpha1Client]
}
...
func (c *roleBindingsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*rbacv1alpha1.RoleBindingList, error) {
...
func (n *roleBindingsNamespacer) Namespace(namespace string) typedrbacv1alpha1.RoleBindingInterface {
