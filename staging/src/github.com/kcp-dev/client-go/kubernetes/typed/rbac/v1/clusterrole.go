...
// or scope down to one cluster and return a rbacv1.ClusterRoleInterface.
type ClusterRoleClusterInterface interface {
	Cluster(logicalcluster.Path) rbacv1.ClusterRoleInterface
	List(ctx context.Context, opts metav1.ListOptions) (*apirbacv1.ClusterRoleList, error)
...
func (c *clusterRolesClusterInterface) Cluster(clusterPath logicalcluster.Path) rbacv1.ClusterRoleInterface {
...
func (c *clusterRolesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apirbacv1.ClusterRoleList, error) {
