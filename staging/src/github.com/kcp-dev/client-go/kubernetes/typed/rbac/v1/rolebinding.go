...
// RoleBindingsNamespacer can scope to objects within a namespace, returning a typedrbacv1.RoleBindingInterface.
type RoleBindingsNamespacer interface {
	Namespace(string) typedrbacv1.RoleBindingInterface
}
...
func (n *roleBindingsNamespacer) Namespace(namespace string) typedrbacv1.RoleBindingInterface {
