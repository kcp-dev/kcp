...
type eventsClusterInterface struct {
	clientCache kcpclient.Cache[*typedeventsv1.EventsV1Client]
}
...
// EventsNamespacer can scope to objects within a namespace, returning a typedeventsv1.EventInterface.
type EventsNamespacer interface {
	Namespace(string) typedeventsv1.EventInterface
}
...
func (n *eventsNamespacer) Namespace(namespace string) typedeventsv1.EventInterface {
