...
// StoragemigrationV1alpha1ClusterClient is used to interact with features provided by the storagemigration.k8s.io group.
...
func setConfigDefaults(config *rest.Config) {
	gv := apistoragemigrationv1alpha1.SchemeGroupVersion
