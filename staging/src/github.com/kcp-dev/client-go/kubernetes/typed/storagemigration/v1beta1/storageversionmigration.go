...
// or scope down to one cluster and return a storagemigrationv1beta1.StorageVersionMigrationInterface.
type StorageVersionMigrationClusterInterface interface {
	...
	List(ctx context.Context, opts v1.ListOptions) (*apistoragemigrationv1beta1.StorageVersionMigrationList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	StorageVersionMigrationClusterExpansion
}
...
func (c *storageVersionMigrationsClusterInterface) Cluster(clusterPath logicalcluster.Path) storagemigrationv1beta1.StorageVersionMigrationInterface {
...
func (c *storageVersionMigrationsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apistoragemigrationv1beta1.StorageVersionMigrationList, error) {
...
func (c *storageVersionMigrationsClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
