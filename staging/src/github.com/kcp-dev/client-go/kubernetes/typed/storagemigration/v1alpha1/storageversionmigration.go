...
// or scope down to one cluster and return a storagemigrationv1alpha1.StorageVersionMigrationInterface.
type StorageVersionMigrationClusterInterface interface {
	Cluster(logicalcluster.Path) storagemigrationv1alpha1.StorageVersionMigrationInterface
	List(ctx context.Context, opts v1.ListOptions) (*apistoragemigrationv1alpha1.StorageVersionMigrationList, error)
...
func (c *storageVersionMigrationsClusterInterface) Cluster(clusterPath logicalcluster.Path) storagemigrationv1alpha1.StorageVersionMigrationInterface {
