...
// ResourceQuotasNamespacer can scope to objects within a namespace, returning a typedcorev1.ResourceQuotaInterface.
type ResourceQuotasNamespacer interface {
	Namespace(string) typedcorev1.ResourceQuotaInterface
}
...
func (n *resourceQuotasNamespacer) Namespace(namespace string) typedcorev1.ResourceQuotaInterface {
