...
type ServiceAccountClusterInterface interface {
	...
	ServiceAccountClusterExpansion
}
...
// ServiceAccountsNamespacer can scope to objects within a namespace, returning a typedcorev1.ServiceAccountInterface.
...
func (n *serviceAccountsNamespacer) Namespace(namespace string) typedcorev1.ServiceAccountInterface {
