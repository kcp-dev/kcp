...
// or scope down to one cluster and return a corev1.NamespaceInterface.
type NamespaceClusterInterface interface {
	Cluster(logicalcluster.Path) corev1.NamespaceInterface
	List(ctx context.Context, opts metav1.ListOptions) (*apicorev1.NamespaceList, error)
	Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error)
	NamespaceClusterExpansion
}
...
func (c *namespacesClusterInterface) Cluster(clusterPath logicalcluster.Path) corev1.NamespaceInterface {
...
func (c *namespacesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apicorev1.NamespaceList, error) {
