...
// ServicesNamespacer can scope to objects within a namespace, returning a typedcorev1.ServiceInterface.
type ServicesNamespacer interface {
	Namespace(string) typedcorev1.ServiceInterface
}
...
func (n *servicesNamespacer) Namespace(namespace string) typedcorev1.ServiceInterface {
