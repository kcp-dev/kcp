...
// ConfigMapsNamespacer can scope to objects within a namespace, returning a typedcorev1.ConfigMapInterface.
type ConfigMapsNamespacer interface {
	Namespace(string) typedcorev1.ConfigMapInterface
}
...
func (n *configMapsNamespacer) Namespace(namespace string) typedcorev1.ConfigMapInterface {
