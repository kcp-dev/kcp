...
// PodsNamespacer can scope to objects within a namespace, returning a typedcorev1.PodInterface.
type PodsNamespacer interface {
	Namespace(string) typedcorev1.PodInterface
}
...
func (n *podsNamespacer) Namespace(namespace string) typedcorev1.PodInterface {
