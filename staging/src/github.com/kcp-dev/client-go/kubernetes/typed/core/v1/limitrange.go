...
// LimitRangesNamespacer can scope to objects within a namespace, returning a typedcorev1.LimitRangeInterface.
type LimitRangesNamespacer interface {
	Namespace(string) typedcorev1.LimitRangeInterface
}
...
func (n *limitRangesNamespacer) Namespace(namespace string) typedcorev1.LimitRangeInterface {
