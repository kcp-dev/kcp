...
// EventsNamespacer can scope to objects within a namespace, returning a typedcorev1.EventInterface.
type EventsNamespacer interface {
	Namespace(string) typedcorev1.EventInterface
}
...
func (n *eventsNamespacer) Namespace(namespace string) typedcorev1.EventInterface {
