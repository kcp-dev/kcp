...
// or scope down to one cluster and return a corev1.NodeInterface.
type NodeClusterInterface interface {
	Cluster(logicalcluster.Path) corev1.NodeInterface
	List(ctx context.Context, opts metav1.ListOptions) (*apicorev1.NodeList, error)
...
func (c *nodesClusterInterface) Cluster(clusterPath logicalcluster.Path) corev1.NodeInterface {
...
func (c *nodesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apicorev1.NodeList, error) {
