...
// or scope down to one cluster and return a apiextensionsv1beta1.CustomResourceDefinitionInterface.
type CustomResourceDefinitionClusterInterface interface {
	Cluster(logicalcluster.Path) apiextensionsv1beta1.CustomResourceDefinitionInterface
	List(ctx context.Context, opts v1.ListOptions) (*apisapiextensionsv1beta1.CustomResourceDefinitionList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	CustomResourceDefinitionClusterExpansion
}
...
func (c *customResourceDefinitionsClusterInterface) Cluster(clusterPath logicalcluster.Path) apiextensionsv1beta1.CustomResourceDefinitionInterface {
...
func (c *customResourceDefinitionsClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*apisapiextensionsv1beta1.CustomResourceDefinitionList, error) {
...
func (c *customResourceDefinitionsClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
