...
// or scope down to one cluster and return a apiextensionsv1.CustomResourceDefinitionInterface.
type CustomResourceDefinitionClusterInterface interface {
	Cluster(logicalcluster.Path) apiextensionsv1.CustomResourceDefinitionInterface
	List(ctx context.Context, opts metav1.ListOptions) (*apisapiextensionsv1.CustomResourceDefinitionList, error)
...
func (c *customResourceDefinitionsClusterInterface) Cluster(clusterPath logicalcluster.Path) apiextensionsv1.CustomResourceDefinitionInterface {
...
func (c *customResourceDefinitionsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apisapiextensionsv1.CustomResourceDefinitionList, error) {
