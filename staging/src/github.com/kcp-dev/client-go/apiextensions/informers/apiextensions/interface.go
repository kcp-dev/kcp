...
import (
	kcpv1 "github.com/kcp-dev/client-go/apiextensions/informers/apiextensions/v1"
	kcpv1beta1 "github.com/kcp-dev/client-go/apiextensions/informers/apiextensions/v1beta1"
