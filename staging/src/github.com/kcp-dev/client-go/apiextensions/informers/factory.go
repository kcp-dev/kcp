...
import (
	...
	kcpapiextensions "github.com/kcp-dev/client-go/apiextensions/informers/apiextensions"
...
func NewSharedInformerFactory(client kcpclient.ClusterInterface, defaultResync time.Duration) SharedInformerFactory {
...
func NewFilteredSharedInformerFactory(client kcpclient.ClusterInterface, defaultResync time.Duration, tweakListOptions kcpinternalinterfaces.TweakListOptionsFunc) SharedInformerFactory {
...
func NewSharedInformerFactoryWithOptions(client kcpclient.ClusterInterface, defaultResync time.Duration, options ...SharedInformerOption) SharedInformerFactory {
...
type SharedInformerFactory interface {
	...
	Apiextensions() kcpapiextensions.ClusterInterface
}

func (f *sharedInformerFactory) Apiextensions() kcpapiextensions.ClusterInterface {
	return kcpapiextensions.New(f, f.tweakListOptions)
}
...
func (f *scopedDynamicSharedInformerFactory) ForResource(resource schema.GroupVersionResource) (externalversions.GenericInformer, error) {
