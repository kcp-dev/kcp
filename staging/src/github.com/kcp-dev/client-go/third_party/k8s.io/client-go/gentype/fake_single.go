...
func NewFakeClient[T objectWithMeta](
	fake *kcptesting.Fake, cluster logicalcluster.Path, namespace string, resource schema.GroupVersionResource, kind schema.GroupVersionKind, emptyObjectCreator func() T,
) *FakeClient[T] {
	return &FakeClient[T]{fake, cluster, namespace, resource, kind, emptyObjectCreator}
}
...
func NewFakeClientWithList[T objectWithMeta, L runtime.Object](
	...
	fakeClient := NewFakeClient[T](fake, cluster, namespace, resource, kind, emptyObjectCreator)
...
func (c *FakeClient[T]) Get(ctx context.Context, name string, _ metav1.GetOptions) (T, error) {
	emptyResult := c.newObject()

	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(c.resource, c.cluster, c.ns, name), emptyResult)
	if obj == nil {
...
func (l *alsoFakeLister[T, L]) List(ctx context.Context, opts metav1.ListOptions) (result L, err error) {
	...
	obj, err := l.client.Fake.
		Invokes(kcptesting.NewListAction(l.client.resource, l.client.kind, l.client.cluster, l.client.ns, opts), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
...
func (c *FakeClient[T]) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.Fake.InvokesWatch(kcptesting.NewWatchAction(c.resource, c.cluster, c.ns, opts))
}
...
func (c *FakeClient[T]) Create(ctx context.Context, resource T, _ metav1.CreateOptions) (result T, err error) {
	emptyResult := c.newObject()
	obj, err := c.Fake.Invokes(kcptesting.NewCreateAction(c.resource, c.cluster, c.ns, resource), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(T), err
...
func (c *FakeClient[T]) Update(ctx context.Context, resource T, _ metav1.UpdateOptions) (result T, err error) {
	emptyResult := c.newObject()
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateAction(c.resource, c.cluster, c.ns, resource), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(T), err
...
func (c *FakeClient[T]) UpdateStatus(ctx context.Context, resource T, _ metav1.UpdateOptions) (result T, err error) {
	emptyResult := c.newObject()
	obj, err := c.Fake.
		Invokes(kcptesting.NewUpdateSubresourceAction(c.resource, c.cluster, "status", c.ns, resource), emptyResult)
...
func (c *FakeClient[T]) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(kcptesting.NewDeleteActionWithOptions(c.resource, c.cluster, c.ns, name, opts), c.newObject())
	return err
}

// DeleteCollection deletes a collection of objects.
func (l *alsoFakeLister[T, L]) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, _ metav1.ListOptions) error {
	_, err := l.client.Fake.
		Invokes(kcptesting.NewDeleteCollectionAction(l.client.resource, l.client.cluster, l.client.ns, opts), l.newList())
	return err
}

// Patch applies the patch and returns the patched resource.
func (c *FakeClient[T]) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, _ metav1.PatchOptions, subresources ...string) (result T, err error) {
	emptyResult := c.newObject()
	obj, err := c.Fake.
		Invokes(kcptesting.NewPatchSubresourceAction(c.resource, c.cluster, c.ns, name, pt, data, subresources...), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(T), err
...
func (a *alsoFakeApplier[T, C]) Apply(ctx context.Context, configuration C, _ metav1.ApplyOptions) (result T, err error) {
	...
	obj, err := a.client.Fake.
		Invokes(kcptesting.NewPatchSubresourceAction(a.client.resource, a.client.cluster, a.client.ns, *name, types.ApplyPatchType, data), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(T), err
...
func (a *alsoFakeApplier[T, C]) ApplyStatus(ctx context.Context, configuration C, _ metav1.ApplyOptions) (result T, err error) {
	if configuration == *new(C) {
		return *new(T), fmt.Errorf("configuration provided to Apply must not be nil")
	}
	data, err := json.Marshal(configuration)
	...
	emptyResult := a.client.newObject()
	obj, err := a.client.Fake.
		Invokes(kcptesting.NewPatchSubresourceAction(a.client.resource, a.client.cluster, a.client.ns, *name, types.ApplyPatchType, data, "status"), emptyResult)
