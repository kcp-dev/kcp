...
type ClusterInterface interface {
	...
	Apply(ctx context.Context, cluster *proxyv1alpha1.ClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Cluster, err error)
	ApplyStatus(ctx context.Context, cluster *proxyv1alpha1.ClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Cluster, err error)
	ClusterExpansion
}
...
func newClusters(c *ProxyV1alpha1Client) *clusters {
	return &clusters{
		client: c.RESTClient(),
	}
}
...
func (c *clusters) Apply(ctx context.Context, cluster *proxyv1alpha1.ClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Cluster, err error) {
	if cluster == nil {
...
func (c *clusters) ApplyStatus(ctx context.Context, cluster *proxyv1alpha1.ClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Cluster, err error) {
	if cluster == nil {
		return nil, fmt.Errorf("cluster provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
