...
func ToProxyTargetKey(clusterName logicalcluster.Name, proxyTargetName string) string {
	hash := sha256.Sum224([]byte(clusterName.Path().Join(proxyTargetName).String()))
